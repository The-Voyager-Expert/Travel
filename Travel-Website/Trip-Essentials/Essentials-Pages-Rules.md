...
**One uniform card format on all 29 pages — no exceptions.** Every card on every page is exactly `.best-of-name` (plain text) / `.best-of-tag` / `.best-of-meta` / `.best-of-links` (a row of `.best-of-link` pills — Guide + Wikipedia + official/booking resources as available). No descriptions, no name-anchor wrappers, no inline `style=`. The 4 non-`Best-*.html` pages that share this sidebar section (Safari-Guide, Wonders-of-the-World, US-National-Parks, National-Parks-World) follow the identical format — the former per-card-description (`.best-of-desc`) exception on those pages was removed 2026-07-05. All 29 pages share identical `.best-of-section-label`, `.best-of-card`, `.best-of-name`, `.best-of-tag`, `.best-of-meta`, `.best-of-links`, `.best-of-link`.
