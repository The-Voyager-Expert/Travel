...
(function () {
  ...
  var GM_SPRITE = {
    ...
    'walk': ['0 0 24 24', '<path d="M4.8 7.6h2.4M3.2 11.8h2.8M4.4 16h2.2" stroke="var(--c-sun)" stroke-width="1.8"/> <circle cx="13.2" cy="3.7" r="2.4" fill="url(#gm-tan)" stroke="var(--c-tan-rim)" stroke-width="0.5"/> <path d="M13.2 7.6 11.6 12.8" stroke="var(--c-blue)"/> <path d="M12.4 9.2 15.8 11.4" stroke="var(--c-blue)"/> <path d="M12.6 8.9 9.4 11.2" stroke="var(--c-blue)"/> <path d="M11.6 12.8 13.9 16.2 13.4 20.9" stroke="var(--c-rust)"/> <path d="M11.6 12.8 9.4 16.4 7.9 20.4" stroke="var(--c-rust)"/>'],
