...
(function () {
  ...
  var GM_SPRITE = {
    ...
    'kids': ['0 0 24 24', '<rect x="1.8" y="6.4" width="8.4" height="1.9" rx="0.8" fill="url(#gm-slate)" stroke="var(--c-slate-rim)" stroke-width="0.5"/> <g fill="url(#gm-stone)" stroke="var(--c-stone-rim)" stroke-width="0.5"> <rect x="2.2" y="7.6" width="1.5" height="14.2" rx="0.7"/> <rect x="6.2" y="7.6" width="1.5" height="14.2" rx="0.7"/> <rect x="3.4" y="10.4" width="3" height="1.2" rx="0.6"/> <rect x="3.4" y="13.6" width="3" height="1.2" rx="0.6"/> <rect x="3.4" y="16.8" width="3" height="1.2" rx="0.6"/> <rect x="3.4" y="20" width="3" height="1.2" rx="0.6"/> </g> <path d="M9.4 6.4h3.6c3.4 0 4.2 4 5.2 7.6.7 2.6 1.8 4.2 3.8 5v2.8h-4.2c-2.6-1.4-3.8-4-4.6-7-.9-3.2-1.4-5.6-3.8-5.6z" fill="url(#gm-blue)" stroke="var(--c-blue-rim)" stroke-width="0.5"/><path d="M9.4 6.4h3.6c3.4 0 4.2 4 5.2 7.6.7 2.6 1.8 4.2 3.8 5v2.8h-4.2c-2.6-1.4-3.8-4-4.6-7-.9-3.2-1.4-5.6-3.8-5.6z" fill="url(#gm-gloss)"/> <path d="M10 7.6h2.8c2.6 0 3.4 3.6 4.4 7 .6 2.2 1.6 3.8 3.2 4.8" fill="none" stroke="var(--c-sky)" stroke-width="1.2" stroke-linecap="round" opacity="0.75"/> <rect x="16.6" y="20.2" width="5.6" height="1.7" rx="0.8" fill="url(#gm-navy)" stroke="var(--c-navy-rim)" stroke-width="0.5"/>'],
