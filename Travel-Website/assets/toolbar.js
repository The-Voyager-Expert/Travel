...
(function () {
  ...
  hamBtn.style.cssText = 'background:#fff;border-radius:6px;border:none;box-shadow:none;outline:none;-webkit-tap-highlight-color:transparent;padding:9px 10px;margin:0 14px 0 0;min-height:auto;cursor:pointer;user-select:none;align-items:center;gap:6px;color:#3d3a32;flex-shrink:0;';
