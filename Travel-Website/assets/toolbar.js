...
(function () {
  ...
  var GM_SPRITE = {
    ...
    'cave': ['0 0 24 24', '<path d="M2 21v-7a10 10 0 0 1 20 0v7z" fill="url(#gm-tan)" stroke="var(--c-tan-rim)" stroke-width="0.5"/><path d="M7.6 21v-5.6a4.4 4.4 0 0 1 8.8 0V21z" fill="url(#gm-navy)" stroke="var(--c-navy-rim)" stroke-width="0.5"/><path d="M10 12.6l.75 2.9.75-2.9z" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.4"/><path d="M12.9 13.2l.7 2.6.7-2.6z" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.4"/>'],
    ...
    'packing': ['0 0 24 24', '<rect x="2.4" y="6" width="19.2" height="14.6" rx="2.2" fill="url(#gm-rust)" stroke="var(--c-rust-rim)" stroke-width="0.5"/><path d="M9 5.4V4.2h6v1.2h2V4a2 2 0 0 0-2-2H9a2 2 0 0 0-2 2v1.4z" fill="url(#gm-cocoa)" stroke="var(--c-cocoa-rim)" stroke-width="0.5"/><rect x="2.4" y="10" width="19.2" height="2.4" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"/><g fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"><rect x="9.6" y="13.6" width="1.8" height="2.6" rx="0.5"/><rect x="12.6" y="13.6" width="1.8" height="2.6" rx="0.5"/></g>'],
    ...
    'nearby-guides': ['0 0 24 24', '<path d="M2 5.2 8.6 3v16L2 21.2z" fill="url(#gm-green)" stroke="var(--c-green-rim)" stroke-width="0.5"/> <path d="M8.6 3 15.4 5.2v16L8.6 19z" fill="url(#gm-cream)" stroke="var(--c-rim-cool)" stroke-width="1" stroke-linejoin="round" /> <path d="M15.4 5.2 22 3v16l-6.6 2.2z" fill="url(#gm-green)" stroke="var(--c-green-rim)" stroke-width="0.5"/> <g stroke="var(--c-paper)" stroke-width="1" opacity="0.5"> <path d="M8.6 3v16M15.4 5.2v16"/> </g> <circle cx="6" cy="12.6" r="1.8" fill="url(#gm-red)" stroke="var(--c-red-rim)" stroke-width="0.5"/> <circle cx="11.8" cy="9.4" r="1.8" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/> <circle cx="18.2" cy="13.4" r="1.8" fill="url(#gm-teal)" stroke="var(--c-teal-rim)" stroke-width="0.5"/>'],
    ...
    'train': ['0 0 24 24', '<path d="M12 1.6c3.9 0 6.4 2.6 6.4 6.4v9.6a2.6 2.6 0 0 1-2.6 2.6H8.2a2.6 2.6 0 0 1-2.6-2.6V8c0-3.8 2.5-6.4 6.4-6.4z" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="1" stroke-linejoin="round" /> <path d="M12 1.6c3.9 0 6.4 2.6 6.4 6.4v1.2H5.6V8c0-3.8 2.5-6.4 6.4-6.4z" fill="url(#gm-navy)" stroke="var(--c-navy-rim)" stroke-width="0.5"/> <path d="M8.3 6.4C9 4.9 10.4 4.1 12 4.1s3 .8 3.7 2.3z" fill="url(#gm-sky)" stroke="var(--c-sky-rim)" stroke-width="0.5"/> <rect x="5.6" y="10.6" width="12.8" height="4.4" fill="url(#gm-blue)" stroke="var(--c-blue-rim)" stroke-width="0.5"/> <rect x="7" y="16.4" width="2.9" height="1.8" rx="0.9" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/> <rect x="14.1" y="16.4" width="2.9" height="1.8" rx="0.9" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/> <path d="M8.6 20.4 6.6 22.8M15.4 20.4l2 2.4" stroke="var(--c-stone)" stroke-width="1.6" stroke-linecap="round"/>'],
    ...
    'walk': ['0 0 24 24', '<path d="M4.8 7.6h2.4M3.2 11.8h2.8M4.4 16h2.2" stroke="var(--c-sun)" stroke-width="1.8"/> <circle cx="13.2" cy="3.7" r="2.4" fill="url(#gm-tan)" stroke="var(--c-tan-rim)" stroke-width="0.5" stroke="none"/> <path d="M13.2 7.6 11.6 12.8" stroke="var(--c-blue)"/> <path d="M12.4 9.2 15.8 11.4" stroke="var(--c-blue)"/> <path d="M12.6 8.9 9.4 11.2" stroke="var(--c-blue)"/> <path d="M11.6 12.8 13.9 16.2 13.4 20.9" stroke="var(--c-rust)"/> <path d="M11.6 12.8 9.4 16.4 7.9 20.4" stroke="var(--c-rust)"/>'],
  ...
  var GM_PALETTE =
    ...
    '--c-paper-shade:#e6ded2;--c-cream-shade:#e6d5b8;--c-rim-warm:#c25a20;--c-rim-cool:#93a4b2;--c-tire-shade:#322c28;--c-tire-rim:#26221e;--c-stone-shade:#90867a;--c-stone-rim:#6f675e;--c-tan-shade:#c18d55;--c-tan-rim:#946c41;--c-cocoa-shade:#5c3a21;--c-cocoa-rim:#472c19;--c-rust-shade:#a74d1c;--c-rust-rim:#803b15;--c-clay-shade:#c26032;--c-clay-rim:#954a26;--c-red-shade:#c13225;--c-red-rim:#94261c;--c-rose-shade:#c7597c;--c-rose-rim:#98455f;--c-plum-shade:#844c9d;--c-plum-rim:#663a78;--c-sun-shade:#d4a315;--c-sun-rim:#a37d10;--c-amber-shade:#ce6c15;--c-amber-rim:#9e5210;--c-green-shade:#4b9a2d;--c-green-rim:#397622;--c-leaf-shade:#36771f;--c-leaf-rim:#2a5b18;--c-teal-shade:#1b8e80;--c-teal-rim:#146d62;--c-blue-shade:#266ead;--c-blue-rim:#1d5485;--c-navy-shade:#194363;--c-navy-rim:#13334c;--c-sky-shade:#7ab0ce;--c-sky-rim:#5e879e}' +
    ...
    '--c-rim-warm:#e0873f;--c-rim-cool:#a9bac8;--c-tire-shade:#4f453f;--c-tire-rim:#8d8480;--c-stone-shade:#847a6e;--c-stone-rim:#b8b0a6;--c-tan-shade:#cea16c;--c-tan-rim:#f4cfa5;--c-cocoa-shade:#774e31;--c-cocoa-rim:#ad8c74;--c-rust-shade:#c17436;--c-rust-rim:#e9ab79;--c-clay-shade:#ce764d;--c-clay-rim:#f4ac8c;--c-red-shade:#db5b49;--c-red-rim:#ff9788;--c-rose-shade:#db8294;--c-rose-rim:#ffb6c5;--c-plum-shade:#976d99;--c-plum-rim:#c8a5c9;--c-sun-shade:#dbb242;--c-sun-rim:#ffdd82;--c-amber-shade:#db842d;--c-amber-rim:#ffb871;--c-green-shade:#6db64d;--c-green-rim:#a5e18c;--c-leaf-shade:#5e8843;--c-leaf-rim:#99bb83;--c-teal-shade:#36ad9e;--c-teal-rim:#79d9cd;--c-blue-shade:#4d91c1;--c-blue-rim:#8cc3e9;--c-navy-shade:#366d96;--c-navy-rim:#79a5c6;--c-sky-shade:#91bdd4;--c-sky-rim:#c3e6f9}}' +
