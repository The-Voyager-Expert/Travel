...
(function () {
  ...
  var GM_SPRITE = {
    'artframe': ['0 0 24 24', '<rect x="2.2" y="3.4" width="19.6" height="17.2" rx="1" fill="var(--c-amber)"/> <rect x="4.4" y="5.6" width="15.2" height="12.8" fill="var(--c-sky)"/> <circle cx="8.4" cy="9.2" r="1.7" fill="var(--c-sun)"/> <path d="M4.4 18.4 9.6 11.6l3.2 4 2.6-3 4.2 5.8z" fill="var(--c-green)"/> <rect x="4.4" y="5.6" width="15.2" height="12.8" fill="none" stroke="var(--c-cocoa)" stroke-width="0.8" opacity="0.35"/>'],
    'aurora': ['0 0 24 24', '<rect x="1.4" y="1.6" width="21.2" height="20.8" rx="2" fill="var(--c-navy)"/> <path d="M3 21c0-6.6 4-12 9-12s9 5.4 9 12h-2.2c0-5.4-3-10-6.8-10S5.2 15.6 5.2 21z" fill="var(--c-green)" opacity="0.85"/> <path d="M5.6 21c0-4.8 2.9-8.8 6.4-8.8s6.4 4 6.4 8.8h-2c0-3.7-2-6.8-4.4-6.8s-4.4 3.1-4.4 6.8z" fill="var(--c-teal)" opacity="0.85"/> <path d="M8.2 21c0-3 1.7-5.4 3.8-5.4s3.8 2.4 3.8 5.4h-1.9c0-2-.9-3.6-1.9-3.6s-1.9 1.6-1.9 3.6z" fill="var(--c-plum)" opacity="0.85"/> <g fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"><circle cx="4.6" cy="4.6" r="0.7"/><circle cx="19.4" cy="5.4" r="0.7"/><circle cx="15" cy="3.4" r="0.55"/></g>'],
    'balloon': ['0 0 24 24', '<path d="M12 1.6a7.4 7.4 0 0 0-7.4 7.4c0 4.1 3.7 8 6.2 9.2h2.4c2.5-1.2 6.2-5.1 6.2-9.2A7.4 7.4 0 0 0 12 1.6z" fill="var(--c-red)"/> <path d="M12 1.6c-1.9 0-3.5 3.3-3.5 7.4 0 3.6 1.4 7 2.7 8.9h1.6c1.3-1.9 2.7-5.3 2.7-8.9 0-4.1-1.6-7.4-3.5-7.4z" fill="var(--c-sun)"/> <path d="M12 1.6c-.8 0-1.5 3.3-1.5 7.4 0 3.6.6 7 1.2 8.9h.6c.6-1.9 1.2-5.3 1.2-8.9 0-4.1-.7-7.4-1.5-7.4z" fill="var(--c-teal)"/> <path d="M9.6 18.6h4.8l-.8 3.4a1 1 0 0 1-1 .8h-1.2a1 1 0 0 1-1-.8z" fill="var(--c-cocoa)"/>'],
    'bang': ['0 0 24 24', '<path d="M9.3 2.2h5.4l-1 13.2h-3.4z" fill="var(--c-red)"/> <rect x="9.3" y="17.4" width="5.4" height="5.2" rx="1.6" fill="var(--c-red)"/> <path d="M10.2 3.4h1.5l-.75 11h-.5z" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6" opacity="0.4"/> <rect x="10.1" y="18.3" width="1.5" height="1.6" rx="0.7" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6" opacity="0.4"/>'],
    'beach': ['0 0 24 24', '<path d="M12 2.4C7.5 2.4 3.8 5.6 3 9.8L12 7.5l9 2.3C20.2 5.6 16.5 2.4 12 2.4z" fill="var(--c-red)"/> <path d="M12 2.4C9.8 2.4 8 5.6 7.6 9.8L12 7.5l4.4 2.3C16 5.6 14.2 2.4 12 2.4z" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"/> <rect x="11.3" y="7.5" width="1.4" height="10" fill="var(--c-cocoa)"/> <path d="M1.6 17.6h20.8v2.2H1.6z" fill="var(--c-tan)"/> <path d="M1.6 20.2c1.7 0 1.7 1.4 3.4 1.4s1.7-1.4 3.4-1.4 1.7 1.4 3.4 1.4 1.7-1.4 3.4-1.4 1.7 1.4 3.4 1.4 1.7-1.4 3.4-1.4" fill="none" stroke="var(--c-blue)" stroke-width="1.6" stroke-linecap="round"/>'],
    'book': ['0 0 24 24', '<path d="M1.4 4.6c2.9-1.2 7.6-1.1 10.6 1 3-2.1 7.7-2.2 10.6-1v15c-2.9-1.2-7.6-1.1-10.6 1-3-2.1-7.7-2.2-10.6-1z" fill="var(--c-blue)"/> <path d="M2.9 6.4c2.4-.9 6.1-.8 8.4.9v11.6c-2.3-1.7-6-1.8-8.4-.9z" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="1" stroke-linejoin="round" /> <path d="M21.1 6.4c-2.4-.9-6.1-.8-8.4.9v11.6c2.3-1.7 6-1.8 8.4-.9z" fill="url(#gm-cream)" stroke="var(--c-rim-cool)" stroke-width="1" stroke-linejoin="round" /> <g stroke="var(--c-stone)" stroke-width="1" stroke-linecap="round"> <path d="M4.6 9h5M4.6 11.4h5M4.6 13.8h3.4M14.4 9.6h5M14.4 12h5M14.4 14.4h3.4"/> </g> <path d="M16.4 3.8h1.9v6.4l-.95-1.2-.95 1.2z" fill="var(--c-red)"/>'],
    'burst': ['0 0 24 24', '<path d="M12 1.4l2.4 4.3 4.3-1.5-1.5 4.3 4.3 2.4-4.3 2.4 1.5 4.3-4.3-1.5L12 22.4l-2.4-4.3-4.3 1.5 1.5-4.3-4.3-2.4 4.3-2.4-1.5-4.3 4.3 1.5z" fill="var(--c-sun)"/> <path d="M12 5.6l1.6 2.9 2.9-1-1 2.9 2.9 1.6-2.9 1.6 1 2.9-2.9-1L12 18.4l-1.6-2.9-2.9 1 1-2.9L5.6 12l2.9-1.6-1-2.9 2.9 1z" fill="var(--c-clay)"/> <circle cx="12" cy="12" r="2.4" fill="var(--c-red)"/>'],
    'calendar': ['0 0 24 24', '<rect x="2.6" y="4" width="18.8" height="17.2" rx="2.4" fill="url(#gm-paper)" stroke="var(--c-rim-warm)" stroke-width="1" stroke-linejoin="round" /> <path d="M2.6 6.4A2.4 2.4 0 0 1 5 4h14a2.4 2.4 0 0 1 2.4 2.4v2.4H2.6z" fill="var(--c-rust)"/> <rect x="6.3" y="1.9" width="2.2" height="4" rx="1.1" fill="var(--c-clay)"/> <rect x="15.5" y="1.9" width="2.2" height="4" rx="1.1" fill="var(--c-clay)"/> <g fill="var(--c-stone)" opacity="0.45"> <rect x="5.4" y="11" width="3.1" height="2.7" rx="0.7"/><rect x="10.45" y="11" width="3.1" height="2.7" rx="0.7"/> <rect x="15.5" y="11" width="3.1" height="2.7" rx="0.7"/><rect x="5.4" y="15.4" width="3.1" height="2.7" rx="0.7"/> <rect x="15.5" y="15.4" width="3.1" height="2.7" rx="0.7"/> </g> <rect x="10.45" y="15.4" width="3.1" height="2.7" rx="0.7" fill="var(--c-sun)"/>'],
    'card': ['0 0 24 24', '<rect x="1.6" y="4.6" width="20.8" height="14.8" rx="2.4" fill="var(--c-navy)"/><rect x="1.6" y="7.8" width="20.8" height="3.4" fill="var(--c-tire)"/><rect x="4" y="13.4" width="5.4" height="3.6" rx="0.7" fill="var(--c-sun)"/><g stroke="var(--c-amber)" stroke-width="0.7" opacity="0.85"><path d="M6.7 13.4v3.6M4 15.2h5.4"/></g><g fill="var(--c-sky)" opacity="0.8"><rect x="12.4" y="14.6" width="4.4" height="1.4" rx="0.7"/><rect x="18" y="14.6" width="2.4" height="1.4" rx="0.7"/></g>'],
    'chart': ['0 0 24 24', '<rect x="3.2" y="12.6" width="4.6" height="8" rx="1.1" fill="var(--c-sun)"/> <rect x="9.7" y="8.4" width="4.6" height="12.2" rx="1.1" fill="var(--c-blue)"/> <rect x="16.2" y="4.4" width="4.6" height="16.2" rx="1.1" fill="var(--c-rust)"/> <path d="M2 22h20" stroke="var(--c-stone)" stroke-width="1.5" stroke-linecap="round"/>'],
    'church': ['0 0 24 24', '<rect x="11.2" y="1.4" width="1.6" height="5" fill="var(--c-sun)"/><rect x="9.6" y="2.8" width="4.8" height="1.6" fill="var(--c-sun)"/> <path d="M12 7 20 13.4V21.6H4V13.4z" fill="url(#gm-cream)" stroke="var(--c-rim-cool)" stroke-width="1" stroke-linejoin="round" /> <path d="M12 7 20 13.4h-2.6L12 9.6 6.6 13.4H4z" fill="var(--c-rust)"/> <path d="M10 21.6v-4.2a2 2 0 0 1 4 0v4.2z" fill="var(--c-cocoa)"/> <circle cx="12" cy="14.4" r="1.7" fill="var(--c-sky)"/> <rect x="3.2" y="21.4" width="17.6" height="1.6" rx="0.8" fill="var(--c-stone)"/>'],
    'clock-stop': ['0 0 24 24', '<circle cx="12" cy="12" r="10" fill="var(--c-rust)"/> <circle cx="12" cy="12" r="8.1" fill="url(#gm-cream)" stroke="var(--c-rim-cool)" stroke-width="1" stroke-linejoin="round" /> <g fill="var(--c-stone)"> <rect x="11.4" y="4.6" width="1.2" height="2" rx="0.6"/><rect x="11.4" y="17.4" width="1.2" height="2" rx="0.6"/> <rect x="4.6" y="11.4" width="2" height="1.2" rx="0.6"/><rect x="17.4" y="11.4" width="2" height="1.2" rx="0.6"/> </g> <g stroke="var(--c-navy)" stroke-width="1.9" stroke-linecap="round" fill="none"> <path d="M12 7.6V12"/><path d="M12 12l3.6 2.1"/> </g> <circle cx="12" cy="12" r="1.2" fill="var(--c-sun)"/>'],
    'clock': ['0 0 24 24', '<circle cx="12" cy="12" r="10" fill="var(--c-rust)"/> <circle cx="12" cy="12" r="8.1" fill="url(#gm-cream)" stroke="var(--c-rim-cool)" stroke-width="1" stroke-linejoin="round" /> <g fill="var(--c-stone)"> <rect x="11.4" y="4.6" width="1.2" height="2" rx="0.6"/><rect x="11.4" y="17.4" width="1.2" height="2" rx="0.6"/> <rect x="4.6" y="11.4" width="2" height="1.2" rx="0.6"/><rect x="17.4" y="11.4" width="2" height="1.2" rx="0.6"/> </g> <g stroke="var(--c-navy)" stroke-width="1.9" stroke-linecap="round" fill="none"> <path d="M12 7.6V12"/><path d="M12 12l3.6 2.1"/> </g> <circle cx="12" cy="12" r="1.2" fill="var(--c-sun)"/>'],
    'closed': ['0 0 24 24', '<circle cx="12" cy="12" r="9.6" fill="none" stroke="var(--c-red)" stroke-width="3.2"/> <rect x="10.4" y="2.8" width="3.2" height="18.4" rx="1.6" fill="var(--c-red)" transform="rotate(45 12 12)"/>'],
    'coffee': ['0 0 24 24', '<g stroke="var(--c-sky)" stroke-width="1.4" fill="none" stroke-linecap="round"> <path d="M7.4 1.2c-1.1 1-1.1 1.9 0 2.9"/><path d="M11 1c-1.1 1-1.1 1.9 0 2.9"/> </g> <path d="M3.6 5.6h12.8v7.6a5.4 5.4 0 0 1-5.4 5.4H9a5.4 5.4 0 0 1-5.4-5.4z" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="1" stroke-linejoin="round" /> <path d="M3.6 5.6h12.8v2.6H3.6z" fill="var(--c-cocoa)"/> <path d="M17.6 7.2h1.1a3.3 3.3 0 0 1 0 6.6h-1.1v-2.1h1.1a1.2 1.2 0 0 0 0-2.4h-1.1z" fill="var(--c-rust)"/> <rect x="2.2" y="19.6" width="15.6" height="2.4" rx="1.2" fill="var(--c-rust)"/>'],
    'dessert': ['0 0 24 24', '<circle cx="12" cy="2.9" r="1.3" fill="var(--c-red)"/> <path d="M11.7 4.1c0 1.1.6 1.4.6 2.1" stroke="var(--c-leaf)" stroke-width="0.9" fill="none"/> <circle cx="12" cy="6.4" r="3.5" fill="var(--c-cocoa)"/> <circle cx="8.6" cy="9.2" r="3.5" fill="var(--c-rose)"/> <circle cx="15.4" cy="9.2" r="3.5" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"/> <path d="M5.9 11.6h12.2L12 22.6z" fill="var(--c-amber)"/> <g stroke="var(--c-cocoa)" stroke-width="0.8" opacity="0.5"> <path d="M7.6 13.6 14.4 13.6M8.9 16 13.1 16M10.2 18.4h3.6"/> </g>'],
    'disney-parks': ['0 0 24 24', '<path d="M6.6 4.6h0.5v3h-0.5z" fill="var(--c-stone)"/> <path d="M7.1 4.7 9.3 5.5 7.1 6.3z" fill="var(--c-red)"/> <path d="M16.9 4.6h0.5v3h-0.5z" fill="var(--c-stone)"/> <path d="M17.4 4.7 19.6 5.5 17.4 6.3z" fill="var(--c-red)"/> <path d="M4.4 9.8 7 4.6l2.6 5.2z" fill="var(--c-blue)"/> <path d="M14.4 9.8 17 4.6l2.6 5.2z" fill="var(--c-blue)"/> <path d="M8.4 7.6 12 1.4l3.6 6.2z" fill="var(--c-navy)"/> <rect x="4.7" y="9.8" width="4.6" height="12" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"/> <rect x="14.7" y="9.8" width="4.6" height="12" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"/> <rect x="8.6" y="7.6" width="6.8" height="14.2" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="1" stroke-linejoin="round" /> <g fill="var(--c-blue)"> <rect x="6.1" y="12.2" width="1.8" height="2.6" rx="0.9"/><rect x="16.1" y="12.2" width="1.8" height="2.6" rx="0.9"/> <rect x="11.2" y="10" width="1.7" height="2.5" rx="0.85"/> </g> <path d="M9.9 21.8v-4.2a2.1 2.1 0 0 1 4.2 0v4.2z" fill="var(--c-rust)"/>'],
    ...
    'ferris': ['0 0 24 24', '<circle cx="12" cy="10.6" r="8.2" fill="none" stroke="var(--c-teal)" stroke-width="1.7"/> <g stroke="var(--c-teal)" stroke-width="1.2"><path d="M12 2.4v16.4M3.8 10.6h16.4M6.2 4.8l11.6 11.6M17.8 4.8 6.2 16.4"/></g> <circle cx="12" cy="10.6" r="2" fill="var(--c-rust)"/> <g fill="var(--c-sun)"><circle cx="12" cy="2.4" r="1.7"/><circle cx="20.2" cy="10.6" r="1.7"/><circle cx="3.8" cy="10.6" r="1.7"/><circle cx="17.8" cy="4.8" r="1.7"/><circle cx="6.2" cy="4.8" r="1.7"/><circle cx="17.8" cy="16.4" r="1.7"/><circle cx="6.2" cy="16.4" r="1.7"/></g> <path d="M8.4 21.6 12 12l3.6 9.6z" fill="var(--c-cocoa)"/><rect x="4.6" y="21.2" width="14.8" height="1.6" rx="0.8" fill="var(--c-stone)"/>'],
    'first-timer': ['0 0 24 24', '<circle cx="9.4" cy="7.2" r="3.6" fill="var(--c-tan)"/> <path d="M9.4 12c3.6 0 6.6 2.4 6.6 5.4v4.2H2.8v-4.2c0-3 3-5.4 6.6-5.4z" fill="var(--c-clay)"/> <circle cx="18.4" cy="7" r="4.8" fill="var(--c-amber)"/> <text x="18.4" y="9.8" font-family="ui-sans-serif, system-ui, sans-serif" font-size="7.4" font-weight="700" fill="var(--c-cocoa)" text-anchor="middle">?</text>'],
    'fish': ['0 0 24 24', '<path d="M21.8 12c-2-3.5-5.9-5.8-9.8-5.8-3.3 0-6.1 1.6-8 3.7L1.6 7.4v9.2l2.4-2.5c1.9 2.1 4.7 3.7 8 3.7 3.9 0 7.8-2.3 9.8-5.8z" fill="var(--c-blue)"/> <path d="M12 6.2c-3.3 0-6.1 1.6-8 3.7L1.6 7.4v9.2l2.4-2.5c1.9 2.1 4.7 3.7 8 3.7z" fill="var(--c-teal)"/> <circle cx="17.2" cy="10.8" r="1.5" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6"/><circle cx="17.5" cy="10.9" r="0.75" fill="var(--c-cocoa)"/> <path d="M10.6 12.6c1.6 1 3.4 1.4 5.2 1.2" stroke="var(--c-sky)" stroke-width="1.1" fill="none" stroke-linecap="round" opacity="0.8"/>'],
    'fountain': ['0 0 24 24', '<circle cx="12" cy="3.2" r="1.9" fill="var(--c-sky)"/> <path d="M10.6 5.2C8.2 6.3 6.7 8 6.2 10.4h2.1c.4-1.6 1.4-2.8 3-3.5z" fill="var(--c-sky)"/> <path d="M13.4 5.2c2.4 1.1 3.9 2.8 4.4 5.2h-2.1c-.4-1.6-1.4-2.8-3-3.5z" fill="var(--c-sky)"/> <path d="M10.9 7.4h2.2v6.4h-2.2z" fill="var(--c-stone)"/> <path d="M3.2 13.6h17.6v1.8a5.6 5.6 0 0 1-5.6 5.6H8.8a5.6 5.6 0 0 1-5.6-5.6z" fill="var(--c-stone)"/> <path d="M4.8 15.4h14.4a5.5 5.5 0 0 1-2.1 3.4H6.9a5.5 5.5 0 0 1-2.1-3.4z" fill="var(--c-blue)"/> <circle cx="9.4" cy="17.4" r="1.1" fill="var(--c-sun)"/> <circle cx="13.6" cy="17.9" r="0.9" fill="var(--c-sun)"/>'],
    'globe': ['0 0 24 24', '<circle cx="12" cy="12" r="10.2" fill="var(--c-blue)"/> <path d="M4.8 5.6c2.4-.9 4.6-.4 5.8 1.1 1.1 1.5.2 3.2-1.7 4-2 .8-4.2 0-5.2-1.4-.9-1.3-.5-3 1.1-3.7z" fill="var(--c-green)"/> <path d="M13.4 12.4c2.4-.7 4.4.2 5 1.9.6 1.8-.6 3.6-2.6 4.2-2 .6-3.9-.3-4.4-2-.5-1.7.3-3.5 2-4.1z" fill="var(--c-green)"/> <path d="M17.4 4.4c1.4-.2 2.5.4 2.7 1.4.2 1-.6 1.9-1.9 2.1-1.3.2-2.4-.4-2.6-1.4-.2-1 .5-1.9 1.8-2.1z" fill="var(--c-leaf)"/> <g stroke="var(--c-paper)" stroke-width="0.9" fill="none" opacity="0.7"> <ellipse cx="12" cy="12" rx="4.5" ry="10.2"/><path d="M1.8 12h20.4"/><path d="M3.8 6.4h16.4M3.8 17.6h16.4"/> </g>'],
    'hotel': ['0 0 24 24', '<rect x="4.2" y="2.6" width="15.6" height="19" rx="1" fill="url(#gm-cream)" stroke="var(--c-rim-cool)" stroke-width="1" stroke-linejoin="round" /> <rect x="3.6" y="2.6" width="16.8" height="2.8" rx="0.6" fill="var(--c-rust)"/> <g fill="var(--c-blue)"> <rect x="6.2" y="7" width="2.7" height="2.6" rx="0.4"/><rect x="10.65" y="7" width="2.7" height="2.6" rx="0.4"/> <rect x="15.1" y="7" width="2.7" height="2.6" rx="0.4"/> <rect x="6.2" y="11.2" width="2.7" height="2.6" rx="0.4"/><rect x="15.1" y="11.2" width="2.7" height="2.6" rx="0.4"/> <rect x="6.2" y="15.4" width="2.7" height="2.6" rx="0.4"/><rect x="15.1" y="15.4" width="2.7" height="2.6" rx="0.4"/> </g> <rect x="10.65" y="11.2" width="2.7" height="2.6" rx="0.4" fill="var(--c-sun)"/> <rect x="7.2" y="17.8" width="9.6" height="1.4" rx="0.7" fill="var(--c-clay)"/> <rect x="10.1" y="19.2" width="3.8" height="2.4" rx="0.4" fill="var(--c-rust)"/>'],
    'hotspring': ['0 0 24 24', '<g stroke="var(--c-sky)" stroke-width="1.5" fill="none" stroke-linecap="round"> <path d="M8 3.2c1.4 1.4 1.4 2.8 0 4.2s-1.4 2.8 0 4.2"/><path d="M12 2.4c1.4 1.4 1.4 2.8 0 4.2s-1.4 2.8 0 4.2"/><path d="M16 3.2c1.4 1.4 1.4 2.8 0 4.2s-1.4 2.8 0 4.2"/></g> <path d="M2.4 14.6h19.2a9.6 9.6 0 0 1-19.2 0z" fill="var(--c-stone)"/> <path d="M4.4 14.6h15.2a7.6 7.6 0 0 1-15.2 0z" fill="var(--c-blue)"/> <path d="M6.2 17.6c1.4 0 1.4 1.2 2.9 1.2s1.4-1.2 2.9-1.2 1.4 1.2 2.9 1.2 1.4-1.2 2.9-1.2" fill="none" stroke="var(--c-sky)" stroke-width="1.2" stroke-linecap="round"/>'],
    'hourglass': ['0 0 24 24', '<rect x="3.6" y="1.4" width="16.8" height="2.6" rx="0.8" fill="var(--c-navy)"/> <rect x="3.6" y="20" width="16.8" height="2.6" rx="0.8" fill="var(--c-navy)"/> <rect x="4.6" y="4" width="1.8" height="16" fill="var(--c-amber)"/> <rect x="17.6" y="4" width="1.8" height="16" fill="var(--c-amber)"/> <g fill="var(--c-navy)" opacity="0.45"> <rect x="4.4" y="7.2" width="2.2" height="1"/><rect x="4.4" y="15.8" width="2.2" height="1"/> <rect x="17.4" y="7.2" width="2.2" height="1"/><rect x="17.4" y="15.8" width="2.2" height="1"/> </g> <path d="M7.6 4.4h8.8v2.8L12.4 12l4 4.8v2.8H7.6v-2.8L11.6 12 7.6 7.2z" fill="var(--c-sky)"/> <path d="M8.9 5.6h6.2v1.4L12 10.4 8.9 7z" fill="var(--c-sun)"/> <path d="M12 13.6 15.4 18.4H8.6z" fill="var(--c-sun)"/> <rect x="11.6" y="10.6" width="0.8" height="3.2" fill="var(--c-amber)"/>'],
    'insurance': ['0 0 24 24', '<path d="M12 1.2 2.8 5.2v6.3c0 5.8 3.9 11.2 9.2 12.5 5.3-1.3 9.2-6.7 9.2-12.5V5.2z" fill="var(--c-sun)"/> <path d="M12 3.4 5 6.4v5.1c0 4.7 3 9.1 7 10.3 4-1.2 7-5.6 7-10.3V6.4z" fill="var(--c-blue)"/> <rect x="10.9" y="7.2" width="2.2" height="6.6" rx="1.1" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6"/> <rect x="10.9" y="15.4" width="2.2" height="2.2" rx="1.1" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6"/>'],
    'language': ['0 0 24 24', '<circle cx="8.6" cy="6.6" r="3.4" fill="var(--c-tan)"/> <path d="M8.6 11c3.5 0 6.4 2.4 6.4 5.4v5.2H2.2v-5.2c0-3 2.9-5.4 6.4-5.4z" fill="var(--c-blue)"/> <path d="M13.6 2.2h8.2a1.6 1.6 0 0 1 1.6 1.6v4.8a1.6 1.6 0 0 1-1.6 1.6h-4.6l-3.2 2.6V10.2h-0.4a1.6 1.6 0 0 1-1.6-1.6V3.8a1.6 1.6 0 0 1 1.6-1.6z" fill="var(--c-sun)"/> <text x="17.9" y="8.4" font-family="ui-serif, Georgia, serif" font-size="6.6" font-weight="700" fill="var(--c-cocoa)" text-anchor="middle">文</text>'],
    'map': ['0 0 24 24', '<path d="M2 5.2 8.6 3v16L2 21.2z" fill="var(--c-green)"/> <path d="M8.6 3 15.4 5.2v16L8.6 19z" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="1" stroke-linejoin="round" /> <path d="M15.4 5.2 22 3v16l-6.6 2.2z" fill="var(--c-green)"/> <path d="M4.6 17.4c2-3 3.6-2 5.2-4.6 1.6-2.6 4-2 6-4.8" fill="none" stroke="var(--c-rust)" stroke-width="1.4" stroke-linecap="round" stroke-dasharray="2.4 1.9"/> <path d="M17.4 5.6a2.3 2.3 0 0 0-2.3 2.3c0 1.7 2.3 4.3 2.3 4.3s2.3-2.6 2.3-4.3a2.3 2.3 0 0 0-2.3-2.3z" fill="var(--c-red)"/> <circle cx="17.4" cy="7.9" r="0.9" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6"/>'],
    'money': ['0 0 24 24', '<rect x="1.4" y="5.6" width="17" height="10" rx="1.7" fill="var(--c-green)"/> <rect x="3.2" y="7.4" width="13.4" height="6.4" rx="0.9" fill="none" stroke="var(--c-cream)" stroke-width="0.9" opacity="0.75"/> <circle cx="9.9" cy="10.6" r="2.4" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"/> <circle cx="17.4" cy="16.6" r="5.4" fill="var(--c-sun)"/> <circle cx="17.4" cy="16.6" r="3.8" fill="var(--c-amber)"/> <g stroke="var(--c-cream)" stroke-width="1.1" stroke-linecap="round"> <path d="M17.4 13.8v5.6M16 15.3h2.8M16 17.9h2.8"/> </g>'],
    'mountain': ['0 0 24 24', '<circle cx="18.6" cy="5" r="2.6" fill="var(--c-sun)"/> <path d="M1.4 21.2 9 6.4l4.4 8.8 2.4-3.8 6.8 9.8z" fill="var(--c-green)"/> <path d="M1.4 21.2 9 6.4l4.4 8.8H8.2z" fill="var(--c-stone)"/> <path d="M9 6.4 11.2 10.8 9 12.4 6.8 10.6z" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6"/> <path d="M15.8 11.4 18.4 15.2h-4.2z" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6"/>'],
    'museumstar': ['0 0 24 24', '<path d="M12 2.6 21.4 8H2.6z" fill="var(--c-clay)"/> <rect x="2.2" y="8" width="19.6" height="1.7" fill="var(--c-rust)"/> <g fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="1" stroke-linejoin="round"><rect x="4.4" y="10" width="2.3" height="7.4"/><rect x="8.6" y="10" width="2.3" height="7.4"/><rect x="12.8" y="10" width="2.3" height="7.4"/><rect x="17" y="10" width="2.3" height="7.4"/></g> <rect x="2.6" y="17.4" width="18.8" height="2" fill="var(--c-stone)"/> <path d="M18.6 14.6 19.7 16.8 22.1 17.2 20.35 18.9 20.8 21.3 18.6 20.2 16.4 21.3 16.85 18.9 15.1 17.2 17.5 16.8z" fill="var(--c-sun)"/>'],
    'paddle': ['0 0 24 24', '<g transform="rotate(-15 9 11)"> <rect x="3.2" y="1.4" width="11.6" height="13.8" rx="2.8" fill="var(--c-tan)"/> <rect x="4.8" y="2.9" width="8.4" height="10.8" rx="2" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6" opacity="0.5"/> <rect x="7.6" y="15" width="2.8" height="2.6" fill="var(--c-cocoa)"/> <rect x="6.9" y="17.2" width="4.2" height="5.6" rx="1.7" fill="var(--c-rust)"/> <g stroke="var(--c-cocoa)" stroke-width="0.7" opacity="0.45"> <path d="M7 18.7h4M7 20.1h4M7 21.5h4"/> </g> </g> <circle cx="19.1" cy="18.3" r="4.1" fill="var(--c-sun)"/> <g fill="var(--c-amber)"> <circle cx="17.6" cy="16.9" r="0.8"/><circle cx="20.4" cy="17.2" r="0.8"/> <circle cx="18.1" cy="19.8" r="0.8"/><circle cx="20.7" cy="19.9" r="0.8"/> </g>'],
    'paw': ['0 0 24 24', '<g fill="var(--c-cocoa)"><ellipse cx="6.2" cy="10.4" rx="2.4" ry="3"/><ellipse cx="17.8" cy="10.4" rx="2.4" ry="3"/><ellipse cx="9.6" cy="5.8" rx="2.3" ry="2.9"/><ellipse cx="14.4" cy="5.8" rx="2.3" ry="2.9"/></g> <path d="M12 11.4c3.4 0 6.2 2.6 6.2 5.6 0 2.4-2 4-4.4 4-.8 0-1.4-.3-1.8-.3s-1 .3-1.8.3c-2.4 0-4.4-1.6-4.4-4 0-3 2.8-5.6 6.2-5.6z" fill="var(--c-tan)"/>'],
    'pennant': ['0 0 24 24', '<rect x="4.2" y="2" width="2.1" height="20" rx="1" fill="var(--c-navy)"/> <path d="M7 3.2 20.8 8.1 7 13z" fill="var(--c-red)"/> <path d="M7 6.6 15.4 9.6 7 12.6z" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6" opacity="0.55"/>'],
    'people': ['0 0 24 24', '<circle cx="17.2" cy="8.4" r="2.7" fill="var(--c-tan)"/> <path d="M17.2 12.4c2.6 0 4.6 1.9 4.6 4.3V19h-8.2v-2.3c0-2.4 1-4.3 3.6-4.3z" fill="var(--c-rust)"/> <circle cx="8.8" cy="7.6" r="3.4" fill="var(--c-tan)"/> <path d="M8.8 12.4c3.6 0 6.5 2.1 6.5 4.8V19H2.3v-1.8c0-2.7 2.9-4.8 6.5-4.8z" fill="var(--c-blue)"/> <path d="M8.8 12.4c1 0 1.9.2 2.8.5l-1.4 2.9-1.4-2.9z" fill="var(--c-sky)"/>'],
    'pin': ['0 0 24 24', '<ellipse cx="12" cy="21.4" rx="4" ry="1.3" fill="var(--c-stone)" opacity="0.45"/> <path d="M12 1.6a7.4 7.4 0 0 0-7.4 7.4c0 5.5 7.4 13.4 7.4 13.4s7.4-8 7.4-13.4A7.4 7.4 0 0 0 12 1.6z" fill="var(--c-red)"/> <path d="M12 1.6a7.4 7.4 0 0 0-7.4 7.4c0 5.5 7.4 13.4 7.4 13.4z" fill="var(--c-clay)" opacity="0.55"/> <circle cx="12" cy="9" r="2.9" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6"/> <circle cx="12" cy="9" r="1.3" fill="var(--c-rust)"/>'],
    'blocks': ['0 0 24 24', '<rect x="2.4" y="11" width="8.4" height="10.6" rx="1" fill="var(--c-teal)"/><rect x="13.2" y="6.4" width="8.4" height="15.2" rx="1" fill="var(--c-clay)"/><rect x="7" y="2.4" width="8.4" height="6.4" rx="1" fill="var(--c-sun)"/>'],
    'books': ['0 0 24 24', '<rect x="2.6" y="4" width="4.4" height="16.4" rx="0.8" fill="var(--c-red)"/><rect x="7.6" y="6" width="4.2" height="14.4" rx="0.8" fill="var(--c-teal)"/><rect x="12.4" y="3.2" width="4.4" height="17.2" rx="0.8" fill="var(--c-sun)"/><rect x="17.4" y="7" width="4" height="13.4" rx="0.8" fill="var(--c-blue)"/><rect x="1.6" y="20.4" width="20.8" height="1.8" rx="0.9" fill="var(--c-cocoa)"/>'],
    'budget': ['0 0 24 24', '<circle cx="6.6" cy="12" r="5.8" fill="var(--c-sun)"/><circle cx="6.6" cy="12" r="4.1" fill="var(--c-amber)"/><circle cx="17.4" cy="12" r="5.8" fill="var(--c-teal)"/><circle cx="17.4" cy="12" r="4.1" fill="var(--c-blue)"/>'],
    'building': ['0 0 24 24', '<rect x="3.4" y="3" width="17.2" height="18.4" rx="1.4" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6" stroke="var(--c-rim-warm)" stroke-width="1" stroke-linejoin="round"/><rect x="3" y="3" width="18" height="2.8" rx="0.8" fill="var(--c-rust)"/><g fill="var(--c-blue)"><rect x="6" y="7.6" width="2.8" height="2.8" rx="0.5"/><rect x="10.6" y="7.6" width="2.8" height="2.8" rx="0.5"/><rect x="15.2" y="7.6" width="2.8" height="2.8" rx="0.5"/><rect x="6" y="12.4" width="2.8" height="2.8" rx="0.5"/><rect x="15.2" y="12.4" width="2.8" height="2.8" rx="0.5"/></g><rect x="10.6" y="12.4" width="2.8" height="2.8" rx="0.5" fill="var(--c-sun)"/><rect x="9.6" y="17" width="4.8" height="4.4" rx="0.5" fill="var(--c-cocoa)"/>'],
    'bulb': ['0 0 24 24', '<g stroke="var(--c-amber)" stroke-width="1.7" stroke-linecap="round"><path d="M12 1.2v1.8M4 5.6 5.4 6.8M20 5.6 18.6 6.8"/></g><path d="M12 3.6a6.6 6.6 0 0 0-3.8 12c.5.4.8 1 .8 1.6v.6h6v-.6c0-.6.3-1.2.8-1.6A6.6 6.6 0 0 0 12 3.6z" fill="var(--c-sun)"/><path d="M9 18.6h6v1.2a1.4 1.4 0 0 1-1.4 1.4h-3.2A1.4 1.4 0 0 1 9 19.8z" fill="var(--c-cocoa)"/>'],
    'castle': ['0 0 24 24', '<path d="M4.4 9.8 7 4.6l2.6 5.2z" fill="var(--c-blue)"/><path d="M14.4 9.8 17 4.6l2.6 5.2z" fill="var(--c-blue)"/><path d="M8.4 7.6 12 1.4l3.6 6.2z" fill="var(--c-navy)"/><rect x="4.7" y="9.8" width="4.6" height="12" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6" stroke="var(--c-rim-warm)" stroke-width="0.9"/><rect x="14.7" y="9.8" width="4.6" height="12" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6" stroke="var(--c-rim-warm)" stroke-width="0.9"/><rect x="8.6" y="7.6" width="6.8" height="14.2" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6" stroke="var(--c-rim-warm)" stroke-width="0.9"/><path d="M9.9 21.8v-4.2a2.1 2.1 0 0 1 4.2 0v4.2z" fill="var(--c-rust)"/>'],
    'category': ['0 0 24 24', '<rect x="2.4" y="2.4" width="8.6" height="8.6" rx="1.6" fill="var(--c-blue)"/><rect x="13" y="2.4" width="8.6" height="8.6" rx="1.6" fill="var(--c-sun)"/><rect x="2.4" y="13" width="8.6" height="8.6" rx="1.6" fill="var(--c-teal)"/><rect x="13" y="13" width="8.6" height="8.6" rx="1.6" fill="var(--c-clay)"/>'],
    'cave': ['0 0 24 24', '<path d="M1.6 21.4C1.6 10.6 6.2 3.4 12 3.4s10.4 7.2 10.4 18z" fill="var(--c-cocoa)"/><path d="M7.4 21.4c0-6 2-10.4 4.6-10.4s4.6 4.4 4.6 10.4z" fill="var(--c-tire)"/><g fill="var(--c-stone)"><path d="M9 8.6l1.2 2.4H7.8zM14 7.4l1.3 2.6h-2.6z"/></g>'],
    'check': ['0 0 24 24', '<circle cx="12" cy="12" r="10.6" fill="var(--c-green)"/><path d="M6.8 12.4 10.4 16l6.8-8" fill="none" stroke="var(--c-paper)" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"/>'],
    'close': ['0 0 24 24', '<circle cx="12" cy="12" r="10.6" fill="var(--c-stone)"/><path d="M8.2 8.2 15.8 15.8M15.8 8.2 8.2 15.8" stroke="var(--c-paper)" stroke-width="2.6" stroke-linecap="round"/>'],
    'compare': ['0 0 24 24', '<rect x="2.2" y="3.2" width="8.8" height="17.6" rx="1.6" fill="var(--c-blue)"/><rect x="13" y="3.2" width="8.8" height="17.6" rx="1.6" fill="var(--c-clay)"/><g fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6" opacity="0.85"><rect x="4" y="6" width="5.2" height="1.4" rx="0.7"/><rect x="4" y="9" width="3.6" height="1.4" rx="0.7"/><rect x="14.8" y="6" width="5.2" height="1.4" rx="0.7"/><rect x="14.8" y="9" width="4.4" height="1.4" rx="0.7"/></g><rect x="4" y="12.6" width="5.2" height="5.6" rx="0.8" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6" opacity="0.5"/><rect x="14.8" y="14.6" width="5.2" height="3.6" rx="0.8" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6" opacity="0.5"/>'],
    'compass': ['0 0 24 24', '<circle cx="12" cy="12" r="10.6" fill="var(--c-navy)"/><circle cx="12" cy="12" r="8.2" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"/><path d="M12 3.4 15.6 12 12 12.6z" fill="var(--c-red)"/><path d="M12 3.4 8.4 12 12 12.6z" fill="var(--c-clay)"/><path d="M12 20.6 8.4 12 12 11.4z" fill="var(--c-stone)"/><path d="M12 20.6 15.6 12 12 11.4z" fill="var(--c-cocoa)" opacity="0.75"/><circle cx="12" cy="12" r="1.5" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6"/>'],
    'flower': ['0 0 24 24', '<g fill="var(--c-rose)"><ellipse cx="12" cy="5.6" rx="3" ry="4"/><ellipse cx="12" cy="14.4" rx="3" ry="4"/><ellipse cx="7.6" cy="10" rx="4" ry="3"/><ellipse cx="16.4" cy="10" rx="4" ry="3"/></g><circle cx="12" cy="10" r="2.6" fill="var(--c-sun)"/><path d="M12 14v8" stroke="var(--c-leaf)" stroke-width="1.8" stroke-linecap="round"/><path d="M12 18c2.4 0 3.6-1.4 3.6-3.2-2.2 0-3.6 1.2-3.6 3.2z" fill="var(--c-green)"/>'],
    'island': ['0 0 24 24', '<path d="M11.6 10.6h1.6v9h-1.6z" fill="var(--c-cocoa)"/><path d="M12.4 10.4c-2.6-2.4-5.4-2.6-7.4-.8 2.4-.6 4.6 0 6.4 1.6zM11.6 10.4c2.6-2.4 5.4-2.6 7.4-.8-2.4-.6-4.6 0-6.4 1.6zM12 9.6c-.8-3-2.6-4.6-4.8-4.6 1.8 1.2 3 2.8 3.6 5z" fill="var(--c-green)"/><path d="M12 9.6c.8-3 2.6-4.6 4.8-4.6-1.8 1.2-3 2.8-3.6 5z" fill="var(--c-leaf)"/><path d="M2.4 19.4h19.2v1.2c0 .8-.6 1.4-1.4 1.4H3.8c-.8 0-1.4-.6-1.4-1.4z" fill="var(--c-tan)"/><path d="M1.6 17.6c1.7 0 1.7 1.4 3.4 1.4s1.7-1.4 3.4-1.4 1.7 1.4 3.4 1.4 1.7-1.4 3.4-1.4 1.7 1.4 3.4 1.4 1.7-1.4 3.4-1.4" fill="none" stroke="var(--c-blue)" stroke-width="1.5" stroke-linecap="round"/>'],
    'laptop': ['0 0 24 24', '<rect x="3" y="4" width="18" height="12" rx="1.8" fill="var(--c-navy)"/><rect x="4.6" y="5.6" width="14.8" height="8.8" rx="1" fill="var(--c-sky)"/><rect x="1" y="17" width="22" height="2.6" rx="1.3" fill="var(--c-blue)"/><rect x="9.6" y="17.6" width="4.8" height="1.4" rx="0.7" fill="var(--c-navy)"/>'],
    'neighborhoods': ['0 0 24 24', '<rect x="1.6" y="9.4" width="6.6" height="12.2" rx="0.8" fill="var(--c-green)"/><rect x="8.8" y="4.6" width="6.4" height="17" rx="0.8" fill="var(--c-clay)"/><rect x="15.8" y="11.8" width="6.6" height="9.8" rx="0.8" fill="var(--c-blue)"/><g fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"><rect x="3" y="11.4" width="1.7" height="1.9"/><rect x="5.5" y="11.4" width="1.7" height="1.9"/><rect x="10.1" y="6.8" width="1.8" height="2"/><rect x="12.5" y="6.8" width="1.8" height="2"/><rect x="17.2" y="13.8" width="1.7" height="1.9"/></g><rect x="12.5" y="14" width="1.8" height="2" fill="var(--c-sun)"/><rect x="1" y="21.4" width="22" height="1.6" rx="0.8" fill="var(--c-stone)"/>'],
    'packing': ['0 0 24 24', '<rect x="2.4" y="6" width="19.2" height="14.6" rx="2.2" fill="var(--c-rust)"/><path d="M9 5.4V4.2h6v1.2h2V4a2 2 0 0 0-2-2H9a2 2 0 0 0-2 2v1.4z" fill="var(--c-cocoa)"/><rect x="2.4" y="10" width="19.2" height="2.4" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"/><g fill="var(--c-sun)"><rect x="9.6" y="13.6" width="1.8" height="2.6" rx="0.5"/><rect x="12.6" y="13.6" width="1.8" height="2.6" rx="0.5"/></g>'],
    'palm': ['0 0 24 24', '<path d="M11.4 9.6h1.8l.8 12.4h-3.4z" fill="var(--c-cocoa)"/><path d="M12.4 9.4c-2.8-2.6-5.8-2.8-8-.8 2.6-.7 5 0 6.9 1.7zM11.6 9.4c2.8-2.6 5.8-2.8 8-.8-2.6-.7-5 0-6.9 1.7zM12 8.6c-.9-3.2-2.8-5-5.2-5 2 1.3 3.3 3 3.9 5.4z" fill="var(--c-green)"/><path d="M12 8.6c.9-3.2 2.8-5 5.2-5-2 1.3-3.3 3-3.9 5.4z" fill="var(--c-leaf)"/><circle cx="12" cy="8.8" r="1.5" fill="var(--c-sun)"/>'],
    'printer': ['0 0 24 24', '<rect x="6.4" y="2.4" width="11.2" height="5" rx="0.6" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6" stroke="var(--c-rim-warm)" stroke-width="0.9"/><rect x="2.4" y="7.4" width="19.2" height="9.2" rx="2" fill="var(--c-navy)"/><rect x="4.4" y="9.6" width="3.4" height="1.8" rx="0.9" fill="var(--c-sky)"/><circle cx="18.6" cy="10.4" r="1.2" fill="var(--c-green)"/><rect x="6.4" y="14.4" width="11.2" height="7.2" rx="0.6" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6" stroke="var(--c-rim-warm)" stroke-width="0.9"/><g stroke="var(--c-stone)" stroke-width="1" stroke-linecap="round"><path d="M8.4 16.8h7.2M8.4 19h4.6"/></g>'],
    'pyramid': ['0 0 24 24', '<circle cx="18.4" cy="5.6" r="2.8" fill="var(--c-sun)"/><path d="M8.4 6.6 17.6 19.6H-0.8z" fill="var(--c-tan)"/><path d="M8.4 6.6V19.6H-0.8z" fill="var(--c-amber)" opacity="0.35"/><path d="M17.2 11.4 23.6 19.6h-12.8z" fill="var(--c-tan)"/><path d="M17.2 11.4v8.2h-6.4z" fill="var(--c-amber)" opacity="0.35"/><rect x="0.6" y="19.4" width="22.8" height="2" rx="1" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6" stroke="var(--c-rim-warm)" stroke-width="0.8"/>'],
    'rental-cars': ['0 0 24 24', '<path d="M5.8 10.4 7.5 6.6c.3-.8 1-1.3 1.9-1.3h5.2c.9 0 1.6.5 1.9 1.3l1.7 3.8z" fill="var(--c-sky)"/><rect x="2.4" y="9.9" width="19.2" height="6.5" rx="2.4" fill="var(--c-blue)"/><rect x="2.7" y="11.4" width="3.1" height="1.9" rx="0.95" fill="var(--c-sun)"/><rect x="18.2" y="11.4" width="3.1" height="1.9" rx="0.95" fill="var(--c-red)"/><circle cx="6.8" cy="17.3" r="2.6" fill="var(--c-tire)"/><circle cx="6.8" cy="17.3" r="1.1" fill="var(--c-stone)"/><circle cx="17.2" cy="17.3" r="2.6" fill="var(--c-tire)"/><circle cx="17.2" cy="17.3" r="1.1" fill="var(--c-stone)"/>'],
    'scams': ['0 0 24 24', '<path d="M2.4 9.4h12.8v9.4a2.2 2.2 0 0 1-2.2 2.2H4.6a2.2 2.2 0 0 1-2.2-2.2z" fill="var(--c-navy)"/><rect x="2.4" y="9.4" width="12.8" height="2.1" fill="var(--c-blue)"/><rect x="5.4" y="4.8" width="6.4" height="5.6" rx="0.8" fill="var(--c-cocoa)"/><rect x="6.8" y="3.2" width="3.6" height="2.6" rx="0.5" fill="var(--c-green)"/><path d="M22.6 5.6 16.4 8.6" stroke="var(--c-tan)" stroke-width="3.2" stroke-linecap="round"/><circle cx="14.8" cy="9.2" r="2.6" fill="var(--c-tan)"/>'],
    ...
    'sim': ['0 0 24 24', '<path d="M6.4 2h8l5.2 5.2V20a2 2 0 0 1-2 2H6.4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2z" fill="var(--c-navy)"/><rect x="7.6" y="11" width="8.8" height="7.4" rx="1.2" fill="var(--c-sun)"/><g stroke="var(--c-amber)" stroke-width="0.9"><path d="M12 11v7.4M7.6 14.7h8.8"/></g>'],
    'surf': ['0 0 24 24', '<path d="M15.4 1.8c4 2.6 6 7.6 4.4 12.6-1.6 4.8-6 7.8-10.6 7.6 0-5 1-9.6 2.8-13 1.2-2.4 2.4-4.4 3.4-7.2z" fill="var(--c-sun)"/><path d="M15.4 1.8c-1 2.8-2.2 4.8-3.4 7.2-1.8 3.4-2.8 8-2.8 13-1.6 0-3-.4-4.2-1.2 1.6-8.8 5-15 10.4-19z" fill="var(--c-red)"/><path d="M1.6 19.6c1.7 0 1.7 1.5 3.4 1.5s1.7-1.5 3.4-1.5 1.7 1.5 3.4 1.5 1.7-1.5 3.4-1.5 1.7 1.5 3.4 1.5" fill="none" stroke="var(--c-blue)" stroke-width="1.6" stroke-linecap="round"/>'],
    'tours-tickets': ['0 5.5 24 13', '<path d="M3 7h18a1.6 1.6 0 0 1 1.6 1.6V10a2 2 0 0 0 0 4v1.4A1.6 1.6 0 0 1 21 17H3a1.6 1.6 0 0 1-1.6-1.6V14a2 2 0 0 0 0-4V8.6A1.6 1.6 0 0 1 3 7z" fill="var(--c-sun)"/><path d="M15.6 7H21a1.6 1.6 0 0 1 1.6 1.6V10a2 2 0 0 0 0 4v1.4A1.6 1.6 0 0 1 21 17h-5.4z" fill="var(--c-amber)"/><path d="M15.6 7.8v8.4" stroke="var(--c-cream)" stroke-width="1.1" stroke-dasharray="1.5 1.5"/>'],
    'tower': ['0 0 24 24', '<path d="M12 0.6 15.4 6.4H8.6z" fill="var(--c-rust)"/><rect x="7.8" y="6.4" width="8.4" height="15.4" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6" stroke="var(--c-rim-warm)" stroke-width="1"/><circle cx="12" cy="11.4" r="3.2" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6" stroke="var(--c-cocoa)" stroke-width="0.9"/><path d="M12 9.2v2.2l1.8 1.1" stroke="var(--c-cocoa)" stroke-width="1.1" stroke-linecap="round" fill="none"/><g fill="var(--c-blue)"><rect x="9.4" y="16" width="1.8" height="2.8" rx="0.9"/><rect x="12.8" y="16" width="1.8" height="2.8" rx="0.9"/></g>'],
    'transit': ['0 0 24 24', '<path d="M6.2 3.4h11.6a2.6 2.6 0 0 1 2.6 2.6v10a2.6 2.6 0 0 1-2.6 2.6H6.2A2.6 2.6 0 0 1 3.6 16V6a2.6 2.6 0 0 1 2.6-2.6z" fill="var(--c-green)"/><rect x="5.4" y="5.8" width="13.2" height="5.4" rx="0.9" fill="var(--c-sky)"/><rect x="11.4" y="5.8" width="1.2" height="5.4" fill="var(--c-green)"/><rect x="3.6" y="12.6" width="16.8" height="1.6" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"/><rect x="5.2" y="15.4" width="3" height="1.8" rx="0.9" fill="var(--c-sun)"/><rect x="15.8" y="15.4" width="3" height="1.8" rx="0.9" fill="var(--c-sun)"/><path d="M5.6 19.6h12.8" stroke="var(--c-tire)" stroke-width="1.6" stroke-linecap="round"/>'],
    'travel-apps': ['0 0 24 24', '<rect x="4.6" y="1.2" width="14.8" height="21.6" rx="2.6" fill="var(--c-cocoa)"/><rect x="6" y="4.6" width="12" height="14.6" rx="0.8" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6"/><g><rect x="7.2" y="5.8" width="3.2" height="3.2" rx="0.9" fill="var(--c-blue)"/><rect x="11.4" y="5.8" width="3.2" height="3.2" rx="0.9" fill="var(--c-sun)"/><rect x="15.6" y="5.8" width="1.2" height="3.2" rx="0.6" fill="var(--c-green)"/><rect x="7.2" y="10" width="3.2" height="3.2" rx="0.9" fill="var(--c-rose)"/><rect x="11.4" y="10" width="3.2" height="3.2" rx="0.9" fill="var(--c-teal)"/><rect x="15.6" y="10" width="1.2" height="3.2" rx="0.6" fill="var(--c-plum)"/><rect x="7.2" y="14.2" width="3.2" height="3.2" rx="0.9" fill="var(--c-amber)"/><rect x="11.4" y="14.2" width="3.2" height="3.2" rx="0.9" fill="var(--c-rust)"/></g><circle cx="12" cy="21" r="1.1" fill="var(--c-stone)"/>'],
    'tree': ['0 0 24 24', '<path d="M12 1.6 19 11h-4.2l4.6 7H4.6l4.6-7H5z" fill="var(--c-green)"/><path d="M12 1.6 19 11h-4.2l4.6 7H12z" fill="var(--c-leaf)"/><rect x="10.6" y="17.4" width="2.8" height="5" rx="0.6" fill="var(--c-cocoa)"/>'],
    'triptype': ['0 0 24 24', '<path d="M10.4 2.6H4a1.4 1.4 0 0 0-1.4 1.4v6.4c0 .4.1.7.4 1l9.6 9.6c.5.5 1.4.5 2 0l6.4-6.4c.5-.6.5-1.5 0-2L11.4 3a1.4 1.4 0 0 0-1-.4z" fill="var(--c-teal)"/><circle cx="6.6" cy="6.6" r="1.9" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6"/>'],
    'list': ['1.5 1 21 21', '<rect x="4.2" y="2.6" width="15.6" height="18.4" rx="1.8" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6" stroke="var(--c-rim-warm)" stroke-width="1.2"/><rect x="8.6" y="1" width="6.8" height="3.2" rx="1.1" fill="var(--c-clay)"/><g stroke="var(--c-stone)" stroke-width="1.3" stroke-linecap="round"><path d="M10.6 8.6h6.4M10.6 12.6h6.4M10.6 16.6h4.4"/></g><g fill="none" stroke="var(--c-green)" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M6.4 8.4 7.6 9.6 9.6 7.4"/><path d="M6.4 12.4 7.6 13.6 9.6 11.4"/></g>'],
    'luggage': ['1 1 22 22', '<path d="M9 6V4.6h6V6h2V4.2A2.2 2.2 0 0 0 14.8 2H9.2A2.2 2.2 0 0 0 7 4.2V6z" fill="var(--c-cocoa)"/><rect x="2.6" y="6" width="18.8" height="14" rx="2.2" fill="var(--c-clay)"/><rect x="2.6" y="10.4" width="18.8" height="2.6" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"/><rect x="9.4" y="14.6" width="1.8" height="2.6" rx="0.5" fill="var(--c-sun)"/><rect x="12.8" y="14.6" width="1.8" height="2.6" rx="0.5" fill="var(--c-sun)"/>'],
    'passport': ['0 0 24 24', '<rect x="4.4" y="2.4" width="15.2" height="19.2" rx="2" fill="var(--c-navy)"/><rect x="5.6" y="2.4" width="1.6" height="19.2" fill="var(--c-blue)"/><rect x="17.8" y="4.4" width="2.4" height="15.2" rx="1" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6" stroke="var(--c-rim-warm)" stroke-width="0.8"/><circle cx="12.4" cy="9.6" r="3.4" fill="none" stroke="var(--c-sun)" stroke-width="1.3"/><path d="M12.4 6.2v6.8M9 9.6h6.8" stroke="var(--c-sun)" stroke-width="0.9"/><rect x="8.6" y="15.6" width="7.6" height="1.7" rx="0.85" fill="var(--c-sun)"/>'],
    'trophy': ['1.5 1.5 21 21', '<path d="M6.6 3h10.8v6.2a5.4 5.4 0 0 1-10.8 0z" fill="var(--c-sun)"/><path d="M12 3h5.4v6.2a5.4 5.4 0 0 1-5.4 5.4z" fill="var(--c-amber)"/><path d="M6.6 4.6H4.4a2.8 2.8 0 0 0 2.6 4.6M17.4 4.6h2.2a2.8 2.8 0 0 1-2.6 4.6" fill="none" stroke="var(--c-amber)" stroke-width="1.7" stroke-linecap="round"/><rect x="10.9" y="14.4" width="2.2" height="3.6" fill="var(--c-amber)"/><rect x="7.8" y="18" width="8.4" height="2.4" rx="1.2" fill="var(--c-rust)"/>'],
    'plane': ['-0.32 0.03 24.64 24.64', '<path d="M12 2a1.4 1.4 0 0 1 1.4 1.4v6.1l8.1 4.8v2.2l-8.1-2.6v5.2l2.6 1.9v1.7L12 21.4l-4 1.3v-1.7l2.6-1.9v-5.2L2.5 16.5v-2.2l8.1-4.8V3.4A1.4 1.4 0 0 1 12 2z" fill="var(--c-blue)"/> <path d="M12 2a1.4 1.4 0 0 1 1.4 1.4v6.1l8.1 4.8v2.2l-8.1-2.6z" fill="var(--c-navy)"/> <path d="M13.4 18.4l2.6 1.9v1.7L12 21.4z" fill="var(--c-navy)"/> <circle cx="12" cy="5.4" r="0.95" fill="var(--c-sun)"/>'],
    'plug': ['0 0 24 24', '<rect x="7.6" y="1.8" width="2.2" height="5.4" rx="1.1" fill="var(--c-navy)"/> <rect x="14.2" y="1.8" width="2.2" height="5.4" rx="1.1" fill="var(--c-navy)"/> <path d="M5.8 7h12.4v3.2a6.2 6.2 0 0 1-12.4 0z" fill="var(--c-stone)"/> <rect x="10.9" y="16" width="2.2" height="5.8" rx="1.1" fill="var(--c-navy)"/> <path d="M12.9 8.2 10.4 12.4h1.9l-1 3.2 3.4-4.4h-2z" fill="var(--c-sun)"/>'],
    'restaurants': ['0 0 24 24', '<circle cx="12" cy="12" r="9.8" fill="url(#gm-cream)" stroke="var(--c-rim-cool)" stroke-width="1" stroke-linejoin="round" /> <circle cx="12" cy="12" r="6.6" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="1" stroke-linejoin="round" /> <g fill="var(--c-navy)"> <rect x="5.3" y="3" width="1.3" height="4.6" rx="0.4"/><rect x="7.2" y="3" width="1.3" height="4.6" rx="0.4"/> <rect x="9.1" y="3" width="1.3" height="4.6" rx="0.4"/> <path d="M4.9 7.2h5.9v0.8a2.95 2.95 0 0 1-5.9 0z"/> <rect x="7" y="9.6" width="1.7" height="11.2" rx="0.85"/> </g> <g fill="var(--c-blue)"> <path d="M16.6 3c1.5 0 2.5 2 2.5 4.4 0 1.7-.6 2.9-1.6 3.3v9.2a.9.9 0 0 1-1.8 0V3z"/> </g>'],
    'food-delivery': ['0 0 24 24', '<path d="M5.4 10.4 7.2 6.2c.32-.8 1.05-1.3 1.95-1.3h5.7c.9 0 1.63.5 1.95 1.3l1.8 4.2z" fill="var(--c-rust)"/> <path d="M7.2 9.6 8.4 6.7h3v2.9zM12.4 6.7h3.2l1.2 2.9h-4.4z" fill="var(--c-sky)"/> <rect x="2.4" y="9.9" width="19.2" height="6.5" rx="2.4" fill="var(--c-clay)"/> <rect x="2.7" y="11.4" width="3.1" height="1.9" rx="0.95" fill="var(--c-sun)"/> <rect x="18.2" y="11.4" width="3.1" height="1.9" rx="0.95" fill="var(--c-red)"/> <circle cx="6.8" cy="17.3" r="2.6" fill="var(--c-tire)"/><circle cx="6.8" cy="17.3" r="1.1" fill="var(--c-stone)"/> <circle cx="17.2" cy="17.3" r="2.6" fill="var(--c-tire)"/><circle cx="17.2" cy="17.3" r="1.1" fill="var(--c-stone)"/>'],
    'nearby-guides': ['0 0 24 24', '<path d="M2 5.2 8.6 3v16L2 21.2z" fill="var(--c-green)"/> <path d="M8.6 3 15.4 5.2v16L8.6 19z" fill="url(#gm-cream)" stroke="var(--c-rim-cool)" stroke-width="1" stroke-linejoin="round" /> <path d="M15.4 5.2 22 3v16l-6.6 2.2z" fill="var(--c-green)"/> <g stroke="var(--c-paper)" stroke-width="1" opacity="0.5"> <path d="M8.6 3v16M15.4 5.2v16"/> </g> <circle cx="6" cy="12.6" r="1.8" fill="var(--c-red)"/> <circle cx="11.8" cy="9.4" r="1.8" fill="var(--c-sun)"/> <circle cx="18.2" cy="13.4" r="1.8" fill="var(--c-teal)"/>'],
    'ride': ['0 0 24 24', '<path d="M5.8 10.4 7.5 6.6c.3-.8 1-1.3 1.9-1.3h5.2c.9 0 1.6.5 1.9 1.3l1.7 3.8z" fill="var(--c-sky)"/> <path d="M11.6 5.3h0.9v5.1h-0.9z" fill="var(--c-teal)"/> <rect x="2.4" y="9.9" width="19.2" height="6.5" rx="2.4" fill="var(--c-teal)"/> <rect x="6.6" y="6.4" width="4" height="2.4" rx="0.6" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6"/> <circle cx="8.6" cy="7.6" r="0.75" fill="var(--c-teal)"/> <rect x="2.7" y="11.4" width="3.1" height="1.9" rx="0.95" fill="var(--c-sun)"/> <rect x="18.2" y="11.4" width="3.1" height="1.9" rx="0.95" fill="var(--c-red)"/> <circle cx="6.8" cy="17.3" r="2.6" fill="var(--c-tire)"/><circle cx="6.8" cy="17.3" r="1.1" fill="var(--c-stone)"/> <circle cx="17.2" cy="17.3" r="2.6" fill="var(--c-tire)"/><circle cx="17.2" cy="17.3" r="1.1" fill="var(--c-stone)"/>'],
    'safari': ['0 0 24 24', '<rect x="4.6" y="11.8" width="9.6" height="5.8" rx="2.4" fill="var(--c-tan)"/> <g fill="var(--c-tan)"><rect x="5.6" y="17.2" width="1.9" height="4.8" rx="0.9"/><rect x="8.6" y="17.2" width="1.9" height="4.8" rx="0.9"/><rect x="11.4" y="17.2" width="1.9" height="4.8" rx="0.9"/></g> <path d="M12.4 13.2 14.4 4.8h3L15.4 13.2z" fill="var(--c-tan)"/> <path d="M14.4 2.6h4.4a1.9 1.9 0 0 1 0 3.8h-3.8z" fill="var(--c-tan)"/> <g stroke="var(--c-cocoa)" stroke-width="1" stroke-linecap="round"><path d="M15.4 2.6V1.2M17.4 2.6V1.2"/></g> <g fill="var(--c-cocoa)"><circle cx="15.4" cy="1" r="0.8"/><circle cx="17.4" cy="1" r="0.8"/><circle cx="16.4" cy="4.4" r="0.7"/> <circle cx="7.2" cy="13.6" r="1.1"/><circle cx="10.6" cy="14.4" r="1.1"/><circle cx="12.6" cy="12.8" r="0.9"/><circle cx="8.4" cy="16" r="0.9"/> <circle cx="14.6" cy="7.6" r="0.85"/><circle cx="13.8" cy="10.6" r="0.85"/></g>'],
    'safety-guide': ['0 0 24 24', '<path d="M12 1.2 2.8 5.2v6.3c0 5.8 3.9 11.2 9.2 12.5 5.3-1.3 9.2-6.7 9.2-12.5V5.2z" fill="var(--c-sun)"/> <path d="M12 3.4 5 6.4v5.1c0 4.7 3 9.1 7 10.3 4-1.2 7-5.6 7-10.3V6.4z" fill="var(--c-blue)"/> <rect x="10.9" y="7.2" width="2.2" height="6.6" rx="1.1" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6"/> <rect x="10.9" y="15.4" width="2.2" height="2.2" rx="1.1" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6"/>'],
    'scuba': ['0 0 24 24', '<path d="M3.6 6.4h16.8a2 2 0 0 1 2 2v3.4a4.4 4.4 0 0 1-4.4 4.4c-1.9 0-3.4-1.2-4.1-2.9L12 10.8l-1.9 2.5c-.7 1.7-2.2 2.9-4.1 2.9A4.4 4.4 0 0 1 1.6 11.8V8.4a2 2 0 0 1 2-2z" fill="var(--c-navy)"/> <path d="M4.4 8.4h5.4v3a2.7 2.7 0 0 1-5.4 0zM14.2 8.4h5.4v3a2.7 2.7 0 0 1-5.4 0z" fill="var(--c-sky)"/> <path d="M20.6 6.4c1.6.6 2.4 2 2.4 4v9a2.6 2.6 0 0 1-5.2 0" fill="none" stroke="var(--c-rust)" stroke-width="1.8" stroke-linecap="round"/>'],
    'ship': ['0 0 24 24', '<rect x="10.2" y="1.6" width="2.4" height="3.2" rx="0.6" fill="var(--c-rust)"/> <rect x="8.4" y="4.4" width="7.6" height="4.2" rx="1" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6"/> <rect x="4.2" y="8.4" width="15.6" height="4.2" rx="1" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"/> <g fill="var(--c-sky)"> <rect x="9.6" y="5.6" width="1.8" height="1.8" rx="0.4"/><rect x="12.6" y="5.6" width="1.8" height="1.8" rx="0.4"/> <rect x="5.8" y="9.6" width="1.9" height="1.9" rx="0.4"/><rect x="9" y="9.6" width="1.9" height="1.9" rx="0.4"/> <rect x="12.2" y="9.6" width="1.9" height="1.9" rx="0.4"/><rect x="15.4" y="9.6" width="1.9" height="1.9" rx="0.4"/> </g> <path d="M2.6 12.8h18.8l-2.8 5H5.4z" fill="var(--c-red)"/> <path d="M2 19.4c1.7 0 1.7 1.5 3.4 1.5s1.7-1.5 3.4-1.5 1.7 1.5 3.4 1.5 1.7-1.5 3.4-1.5 1.7 1.5 3.4 1.5" fill="none" stroke="var(--c-blue)" stroke-width="1.7" stroke-linecap="round"/>'],
    'shuffle': ['0 0 24 24', '<path d="M12 5.4c5 0 9.2 3.1 11 6.6-1.8 3.5-6 6.6-11 6.6S2.8 15.5 1 12c1.8-3.5 6-6.6 11-6.6z" fill="url(#gm-cream)" stroke="var(--c-rim-cool)" stroke-width="1" stroke-linejoin="round" /><circle cx="12" cy="12" r="4" fill="var(--c-blue)"/><circle cx="12" cy="12" r="1.7" fill="var(--c-navy)"/><circle cx="10.6" cy="10.6" r="0.8" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6" opacity="0.8"/>'],
    'ski': ['0 0 24 24', '<circle cx="7.6" cy="4.6" r="2.5" fill="var(--c-tan)"/> <rect x="6.4" y="7" width="5.4" height="7" rx="2.4" fill="var(--c-blue)" transform="rotate(20 9.1 10.5)"/> <rect x="9.8" y="12.4" width="5" height="2.7" rx="1.35" fill="var(--c-navy)" transform="rotate(20 12.3 13.7)"/> <path d="M12.6 8.2 18.2 13.8" stroke="var(--c-cocoa)" stroke-width="1.3" stroke-linecap="round"/> <path d="M2.8 18 20.4 12.4" stroke="var(--c-red)" stroke-width="2.2" stroke-linecap="round"/> <path d="M4.2 20.8 21.6 15.2" stroke="var(--c-red)" stroke-width="2.2" stroke-linecap="round"/>'],
    'sparkle': ['0 0 24 24', '<path d="M12 1.6 14.5 9.5 22.4 12 14.5 14.5 12 22.4 9.5 14.5 1.6 12 9.5 9.5z" fill="var(--c-sun)"/><path d="M12 6.4 13.4 10.6 17.6 12 13.4 13.4 12 17.6 10.6 13.4 6.4 12 10.6 10.6z" fill="var(--c-amber)" opacity="0.5"/>'],
    'star': ['0 0 24 24', '<path d="M12 2.4l2.9 6 6.6.9-4.8 4.6 1.2 6.5L12 17.3l-5.9 3.1 1.2-6.5L2.5 9.3l6.6-.9z" fill="var(--c-sun)"/> <path d="M12 2.4l2.9 6 6.6.9-4.8 4.6 1.2 6.5L12 17.3z" fill="var(--c-amber)" opacity="0.55"/> <path d="M9.6 6.4 11 7.1l-.8 1.5-1.5.2z" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6" opacity="0.55"/>'],
    'sun': ['0 0 24 24', '<circle cx="9.6" cy="9" r="4.6" fill="var(--c-sun)"/> <g stroke="var(--c-amber)" stroke-width="1.8" stroke-linecap="round"> <path d="M9.6 1.6v1.8"/><path d="M1.6 9h1.8"/><path d="M3.9 3.3 5.2 4.6"/> <path d="M15.3 3.3 14 4.6"/><path d="M3.9 14.7 5.2 13.4"/> </g> <path d="M9 21.4a3.9 3.9 0 0 1 .4-7.8 5.2 5.2 0 0 1 9.7 1.3 3.2 3.2 0 0 1-.5 6.5z" fill="var(--c-sky)"/> <path d="M9.4 13.6a5.2 5.2 0 0 1 6 1.4 3.6 3.6 0 0 0-5.1 1.9 3.9 3.9 0 0 0-1.3-3.3z" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6" opacity="0.65"/>'],
    'sunset': ['0 0 24 24', '<circle cx="12" cy="11.4" r="5" fill="var(--c-sun)"/> <g stroke="var(--c-amber)" stroke-width="1.9" stroke-linecap="round"> <path d="M12 2.4v2.2"/><path d="M4.4 4.6 5.9 6.1"/><path d="M19.6 4.6 18.1 6.1"/> <path d="M2.2 11.4h2.2"/><path d="M19.6 11.4h2.2"/> </g> <rect x="2" y="15.4" width="20" height="2.3" rx="1.15" fill="var(--c-rust)"/> <rect x="4.4" y="19.2" width="15.2" height="2.3" rx="1.15" fill="var(--c-clay)"/>'],
    'tap-water': ['0 0 24 24', '<path d="M12 2.2C12 2.2 5 10.4 5 14.4a7 7 0 0 0 14 0c0-4-7-12.2-7-12.2z" fill="var(--c-blue)"/> <path d="M12 5.4c0 0-4.4 5.6-4.4 9a4.4 4.4 0 0 0 2 3.7C8.4 16.6 8 15.4 8 14.2c0-2.8 4-8.8 4-8.8z" fill="var(--c-sky)" opacity="0.75"/> <ellipse cx="9.4" cy="15.4" rx="1.5" ry="2.1" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6" opacity="0.5" transform="rotate(-20 9.4 15.4)"/>'],
    'theatre': ['0 0 24 24', '<path d="M2.6 4.4h10.2v6.8a5.1 5.1 0 0 1-10.2 0z" fill="var(--c-sun)"/> <g fill="var(--c-cocoa)"><circle cx="5" cy="8" r="1"/><circle cx="10.4" cy="8" r="1"/></g> <path d="M5.6 12.4h4.6a2.5 2.5 0 0 1-4.6 0z" fill="var(--c-cocoa)"/> <path d="M11.2 8.6h10.2v6.8a5.1 5.1 0 0 1-10.2 0z" fill="var(--c-plum)"/> <g fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"><circle cx="13.6" cy="12.2" r="1"/><circle cx="19" cy="12.2" r="1"/></g> <path d="M14.2 18.4a2.3 2.3 0 0 1 4.6 0z" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"/>'],
    'ticket': ['0 5.5 24 13', '<path d="M3 7h18a1.6 1.6 0 0 1 1.6 1.6V10a2 2 0 0 0 0 4v1.4A1.6 1.6 0 0 1 21 17H3a1.6 1.6 0 0 1-1.6-1.6V14a2 2 0 0 0 0-4V8.6A1.6 1.6 0 0 1 3 7z" fill="var(--c-sun)"/> <path d="M15.6 7H21a1.6 1.6 0 0 1 1.6 1.6V10a2 2 0 0 0 0 4v1.4A1.6 1.6 0 0 1 21 17h-5.4z" fill="var(--c-amber)"/> <path d="M15.6 7.8v8.4" stroke="var(--c-cream)" stroke-width="1.1" stroke-dasharray="1.5 1.5"/> <rect x="3.6" y="9.9" width="8.4" height="1.5" rx="0.75" fill="var(--c-cocoa)" opacity="0.5"/> <rect x="3.6" y="12.6" width="5.4" height="1.5" rx="0.75" fill="var(--c-cocoa)" opacity="0.35"/>'],
    'tipping': ['0 0 24 24', '<circle cx="12" cy="7" r="5.6" fill="var(--c-sun)"/> <circle cx="12" cy="7" r="4" fill="var(--c-amber)"/> <text x="12" y="10.1" font-family="ui-serif, Georgia, serif" font-size="7.8" font-weight="700" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6" text-anchor="middle">$</text> <path d="M4 15h4.6l2.2 1.6h2.9c.9 0 1.6.7 1.6 1.6H11v1.4h4.6l4.4-2.3 1 1.7-5 3.5H4z" fill="var(--c-tan)"/> <rect x="1.4" y="14.6" width="3" height="8" rx="1.1" fill="var(--c-rust)"/>'],
    'train': ['0 0 24 24', '<path d="M12 1.6c3.9 0 6.4 2.6 6.4 6.4v9.6a2.6 2.6 0 0 1-2.6 2.6H8.2a2.6 2.6 0 0 1-2.6-2.6V8c0-3.8 2.5-6.4 6.4-6.4z" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="1" stroke-linejoin="round" /> <path d="M12 1.6c3.9 0 6.4 2.6 6.4 6.4v1.2H5.6V8c0-3.8 2.5-6.4 6.4-6.4z" fill="var(--c-navy)"/> <path d="M8.3 6.4C9 4.9 10.4 4.1 12 4.1s3 .8 3.7 2.3z" fill="var(--c-sky)"/> <rect x="5.6" y="10.6" width="12.8" height="4.4" fill="var(--c-blue)"/> <rect x="7" y="16.4" width="2.9" height="1.8" rx="0.9" fill="var(--c-sun)"/> <rect x="14.1" y="16.4" width="2.9" height="1.8" rx="0.9" fill="var(--c-sun)"/> <path d="M8.6 20.4 6.6 22.8M15.4 20.4l2 2.4" stroke="var(--c-stone)" stroke-width="1.6" stroke-linecap="round"/>'],
    'trusted': ['0 0 24 24', '<circle cx="10" cy="8" r="4" fill="var(--c-tan)"/> <path d="M10 13.8c-3.9 0-7 1.9-7 4.3V21h8.6a6.4 6.4 0 0 1 2.2-6.6 12.6 12.6 0 0 0-3.8-.6z" fill="var(--c-blue)"/> <circle cx="17.2" cy="17.6" r="4.9" fill="var(--c-green)"/> <path d="M14.9 17.6 16.6 19.3 19.6 16.3" fill="none" stroke="var(--c-paper)" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>'],
    'unesco': ['0 0 24 24', '<path d="M12 2.4 22 8.2H2z" fill="var(--c-clay)"/> <rect x="1.6" y="8.2" width="20.8" height="1.8" fill="var(--c-rust)"/> <g fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="1" stroke-linejoin="round"><rect x="4" y="10.4" width="2.4" height="8"/><rect x="8.4" y="10.4" width="2.4" height="8"/><rect x="12.8" y="10.4" width="2.4" height="8"/><rect x="17.2" y="10.4" width="2.4" height="8"/></g> <rect x="2.2" y="18.4" width="19.6" height="2.2" fill="var(--c-stone)"/> <rect x="1.4" y="20.8" width="21.2" height="1.8" rx="0.9" fill="var(--c-cocoa)"/>'],
    'vaccines': ['0 0 24 24', '<rect x="1.6" y="10.2" width="2.2" height="3.6" rx="0.6" fill="var(--c-stone)"/> <rect x="3.8" y="11.2" width="2.6" height="1.6" fill="var(--c-stone)"/> <rect x="6.4" y="8.6" width="9.6" height="6.8" rx="1.2" fill="var(--c-sky)"/> <rect x="6.4" y="8.6" width="4.2" height="6.8" rx="1.2" fill="var(--c-blue)"/> <g stroke="var(--c-paper)" stroke-width="0.75" opacity="0.9" stroke-linecap="round"><path d="M11.6 9.4v1.5M13 9.4v1.5M14.4 9.4v1.5"/></g> <rect x="16" y="10.4" width="1.8" height="3.2" rx="0.4" fill="var(--c-stone)"/> <rect x="17.8" y="11.6" width="4.6" height="0.9" rx="0.45" fill="var(--c-stone)"/> <circle cx="22" cy="8.8" r="1.5" fill="var(--c-red)"/>'],
    'van': ['0 0 24 24', '<path d="M6 2.4h12a2.8 2.8 0 0 1 2.8 2.8v12a2.8 2.8 0 0 1-2.8 2.8H6A2.8 2.8 0 0 1 3.2 17.2v-12A2.8 2.8 0 0 1 6 2.4z" fill="var(--c-rust)"/> <rect x="4.9" y="5.6" width="14.2" height="6.2" rx="1" fill="var(--c-sky)"/> <rect x="11.4" y="5.6" width="1.2" height="6.2" fill="var(--c-rust)"/> <rect x="3.2" y="13.4" width="17.6" height="1.8" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"/> <circle cx="7.5" cy="17.4" r="1.7" fill="var(--c-sun)"/><circle cx="16.5" cy="17.4" r="1.7" fill="var(--c-sun)"/> <path d="M6.4 20h11.2l1.4 2v.6H5V22z" fill="var(--c-tire)"/>'],
    'visas': ['0 0 24 24', '<rect x="4.2" y="2.4" width="15.4" height="19.2" rx="2" fill="var(--c-navy)"/> <rect x="5.6" y="2.4" width="1.6" height="19.2" fill="var(--c-blue)"/> <rect x="17.8" y="4.4" width="2.4" height="15.2" rx="1" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"/> <circle cx="12.4" cy="9.6" r="3.4" fill="none" stroke="var(--c-sun)" stroke-width="1.3"/> <path d="M12.4 6.2v6.8M9 9.6h6.8" stroke="var(--c-sun)" stroke-width="0.9"/> <rect x="8.6" y="15.6" width="7.6" height="1.7" rx="0.85" fill="var(--c-sun)"/>'],
    'volcano': ['0 0 24 24', '<path d="M8.6 2h6.8v4.4L22.4 22H1.6z" fill="var(--c-cocoa)"/> <path d="M8.6 2h6.8v4.4L18 12.4H6z" fill="var(--c-stone)" opacity="0.35"/> <path d="M9.4 2.2h5.2v3.6c-.8.6-1.7.9-2.6.9s-1.8-.3-2.6-.9z" fill="var(--c-red)"/> <path d="M10.6 6.4c.6.4 1.1 1.6 1.4 2.8.3-1.2.8-2.4 1.4-2.8l1.4 3.4c-.4 2-1.4 4-2.8 5.6-1.4-1.6-2.4-3.6-2.8-5.6z" fill="var(--c-red)"/> <g fill="var(--c-stone)" opacity="0.7"><circle cx="8" cy="1.6" r="1.3"/><circle cx="16.4" cy="1.2" r="1"/></g> <rect x="1" y="21.4" width="22" height="1.6" rx="0.8" fill="var(--c-tan)"/>'],
    'walk': ['0 0 24 24', '<path d="M4.8 7.6h2.4M3.2 11.8h2.8M4.4 16h2.2" stroke="var(--c-sun)" stroke-width="1.8"/> <circle cx="13.2" cy="3.7" r="2.4" fill="var(--c-tan)" stroke="none"/> <path d="M13.2 7.6 11.6 12.8" stroke="var(--c-blue)"/> <path d="M12.4 9.2 15.8 11.4" stroke="var(--c-blue)"/> <path d="M12.6 8.9 9.4 11.2" stroke="var(--c-blue)"/> <path d="M11.6 12.8 13.9 16.2 13.4 20.9" stroke="var(--c-rust)"/> <path d="M11.6 12.8 9.4 16.4 7.9 20.4" stroke="var(--c-rust)"/>'],
    'warn': ['0 0 24 24', '<path d="M12 2.2c-.66 0-1.27.35-1.6.92L.7 20.3A1.85 1.85 0 0 0 2.3 23h19.4a1.85 1.85 0 0 0 1.6-2.7L13.6 3.12A1.85 1.85 0 0 0 12 2.2z" fill="var(--c-amber)"/> <path d="M12 5.9 3.4 20.9h17.2z" fill="var(--c-sun)"/> <rect x="10.9" y="9.6" width="2.2" height="6.1" rx="1.1" fill="var(--c-cocoa)"/> <rect x="10.9" y="17" width="2.2" height="2.2" rx="1.1" fill="var(--c-cocoa)"/>'],
    ...
    'wine': ['0 0 24 24', '<path d="M7 2.4h10v5.2a5 5 0 0 1-10 0z" fill="var(--c-sky)" opacity="0.5"/> <path d="M7.9 5.4h8.2v2.2a4.1 4.1 0 0 1-8.2 0z" fill="var(--c-red)"/> <rect x="11.1" y="12" width="1.8" height="7.2" fill="var(--c-sky)" opacity="0.6"/> <rect x="7.6" y="19.2" width="8.8" height="2" rx="1" fill="var(--c-stone)"/>']
  };

  var GM_PALETTE =
    ':root{--c-tire:#3a332e;--c-stone:#a89c8e;--c-paper:#fff;--c-cream:#f6ecdb;' +
    '--c-tan:#e0a463;--c-cocoa:#6b4326;--c-rust:#c25a20;--c-clay:#e2703a;' +
    '--c-red:#e03a2b;--c-rose:#e76890;--c-plum:#9a58b6;--c-sun:#f7bd18;' +
    '--c-amber:#ef7d18;--c-green:#57b334;--c-leaf:#3f8a24;--c-teal:#1fa595;' +
    '--c-blue:#2c80c9;--c-navy:#1d4e73;--c-sky:#8ecdf0;' +
    '--c-paper-shade:#e6ded2;--c-cream-shade:#e6d5b8;--c-rim-warm:#c25a20;--c-rim-cool:#93a4b2;--c-rim-cool:#93a4b2}' +
    '@media(prefers-color-scheme:dark){:root{--c-tire:#5c5049;--c-stone:#9a8e80;' +
    '--c-paper:#f2ece2;--c-cream:#e4d6bf;--c-tan:#f0bb7e;--c-cocoa:#8a5b39;' +
    '--c-rust:#e0873f;--c-clay:#f0895a;--c-red:#ff6a55;--c-rose:#ff97ac;' +
    '--c-plum:#b07fb2;--c-sun:#ffcf4d;--c-amber:#ff9a34;--c-green:#7fd45a;' +
    '--c-leaf:#6d9e4e;--c-teal:#3fc9b8;--c-blue:#5aa9e0;--c-navy:#3f7fae;' +
    '--c-sky:#a9dcf7;--c-paper-shade:#d8cfc0;--c-cream-shade:#cbb894;' +
    '--c-rim-warm:#e0873f;--c-rim-cool:#a9bac8;--c-rim-cool:#7d95a8}}' +
    '.gm-ic{display:inline-block;vertical-align:-0.15em}' +
    '.gm-mk.gm-mk-c{background:none;-webkit-mask:none;mask:none;line-height:0}' +
    '.gm-mk.gm-mk-c svg{width:1em;height:1em;display:block}';
  ...
  var ITEMS = [
    ...
    { group: '🏆 Best Of', groupIcon: 'trophy', children: [
        ...
        { href: base + 'Trip-Essentials/Best-Animal-Encounters.html',             text: 'Animal Encounters', icon: 'paw' },
        { href: base + 'Trip-Essentials/Best-Aquariums.html',                     text: 'Aquariums', icon: 'fish' },
        { href: base + 'Trip-Essentials/Best-Architecture.html',                  text: 'Architecture', icon: 'building' },
        ...
        { href: base + 'Trip-Essentials/Best-Kids-Friendly-Places.html',          text: 'Kid-Friendly Destinations', icon: 'balloon' },
        { href: base + 'Trip-Essentials/Best-Kids-Museums.html',                  text: "Kids' Museums", icon: 'blocks' },
        { href: base + 'Trip-Essentials/Best-Lakes.html',                         text: 'Lakes', icon: 'waves' },
        { href: base + 'Trip-Essentials/Best-Mountains-and-Rock-Formations.html', text: 'Mountains & Rock Formations', icon: 'mountain' },
        { href: base + 'Trip-Essentials/Best-Museums.html',                       text: 'Museums', icon: 'unesco' },
        ...
        { href: base + 'Trip-Essentials/Best-UNESCO-Sites.html',                  text: 'UNESCO Sites', icon: 'pyramid' },
        { href: base + 'Trip-Essentials/Best-Unique-Museums.html',                text: 'Unique Museums', icon: 'museumstar' },
        { href: base + 'Trip-Essentials/Best-Volcanoes.html',                     text: 'Volcanoes', icon: 'volcano' },
