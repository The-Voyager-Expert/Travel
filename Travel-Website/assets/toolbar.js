...
(function () {
  ...
  styleEl.textContent =
    ...
    '@media(max-width:1260px){' +
      ...
      '.tb-ham-label{display:block;min-height:0!important;flex:1;text-align:center;font-size:20px;font-weight:700;color:#fff;padding:0;letter-spacing:.06em;text-transform:uppercase}' +
