...
(function () {
  ...
  styleEl.textContent =
    ...
    '@media(max-width:600px){' +
      ...
      '.tb{position:fixed;top:0;left:0;right:0;z-index:1000;padding:15px 0 14px;display:flex;align-items:center;justify-content:space-between;min-height:56px;border-bottom:none;background:linear-gradient(135deg,#7a3b1e 0%,#b85c2a 55%,#d4874a 100%);box-shadow:none}' +
      ...
      '.tb-ham-menu{display:none;position:fixed;top:56px;left:0;right:0;' +
        'background:#ffffff;border-top:1px solid #e6e2da;' +
        'box-shadow:0 8px 24px rgba(0,0,0,.18);z-index:1001;padding:4px 0 8px;' +
        'height:calc(100dvh - 56px);overflow-y:auto;-webkit-overflow-scrolling:touch;' +
