...
(function () {
  ...
  var GM_SPRITE = {
    ...
    'mountain': ['0 0 24 24', '<circle cx="18.6" cy="5" r="2.6" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/><circle cx="18.6" cy="5" r="2.6" fill="url(#gm-gloss)"/> <path d="M1.4 21.2 9 6.4l4.4 8.8 2.4-3.8 6.8 9.8z" fill="url(#gm-green)" stroke="var(--c-green-rim)" stroke-width="0.5"/> <path d="M1.4 21.2 9 6.4l4.4 8.8H8.2z" fill="url(#gm-stone)" stroke="var(--c-stone-rim)" stroke-width="0.5"/> <path d="M9 6.4 11.2 10.8 9 12.4 6.8 10.6z" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6"/> <path d="M15.8 11.4 18.4 15.2h-4.2z" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6"/>'],
    ...
    'volcano-erupting': ['0 0 24 24', '<path d="M9 5.2h6l7.4 15.6H1.6z" fill="url(#gm-pine)" stroke="var(--c-pine-rim)" stroke-width="0.5"/><path d="M9 5.2h6l7.4 15.6H1.6z" fill="url(#gm-gloss)"/><path d="M9 5.2h2.6l-.5 15.6H1.6z" fill="url(#gm-green)" stroke="var(--c-green-rim)" stroke-width="0.5" opacity="0.4"/><path d="M10.2 5.6c-.4 2.6-1.2 4.4-1.6 7-.2 1.5-.2 2.9 0 4.3l1.5-1.5.9 2.2 1.2-2.6 1.3 2.1.7-2.3 1.4 1.3c.3-1.9.1-3.6-.3-5.2-.5-2-1.3-3.5-1.6-5.3z" fill="url(#gm-red)" stroke="var(--c-red-rim)" stroke-width="0.5"/><path d="M11.3 6.4c-.2 2-.7 3.4-1 5.2-.2 1.1-.2 2.1 0 3.1l.8-1 .5 1.6.8-1.9.7 1.5.4-1.6.8.9c.2-1.4 0-2.6-.3-3.8-.4-1.4-.9-2.4-1.1-3.9z" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5" opacity="0.9"/><ellipse cx="12" cy="5.2" rx="3" ry="1.15" fill="url(#gm-red)" stroke="var(--c-red-rim)" stroke-width="0.5"/><g fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"><circle cx="8.6" cy="2.8" r="0.8"/><circle cx="15.2" cy="2.2" r="0.65"/><circle cx="11.4" cy="1.2" r="0.55"/><circle cx="17.4" cy="4.4" r="0.5"/></g><rect x="1" y="20.4" width="22" height="1.6" rx="0.8" fill="url(#gm-green)" stroke="var(--c-green-rim)" stroke-width="0.5"/>'],
    'volcano': ['0 0 24 24', '<path d="M8.6 2h6.8v4.4L22.4 22H1.6z" fill="url(#gm-slate)" stroke="var(--c-slate-rim)" stroke-width="0.5"/><path d="M8.6 2h6.8v4.4L22.4 22H1.6z" fill="url(#gm-gloss)"/> <path d="M8.6 2h6.8v4.4L18 12.4H6z" fill="url(#gm-tire)" stroke="var(--c-tire-rim)" stroke-width="0.5" opacity="0.35"/> <path d="M9.4 2.2h5.2v3.6c-.8.6-1.7.9-2.6.9s-1.8-.3-2.6-.9z" fill="url(#gm-amber)" stroke="var(--c-amber-rim)" stroke-width="0.5"/> <path d="M10.6 6.4c.6.4 1.1 1.6 1.4 2.8.3-1.2.8-2.4 1.4-2.8l1.4 3.4c-.4 2-1.4 4-2.8 5.6-1.4-1.6-2.4-3.6-2.8-5.6z" fill="url(#gm-amber)" stroke="var(--c-amber-rim)" stroke-width="0.5"/> <g fill="url(#gm-tire)" stroke="var(--c-tire-rim)" stroke-width="0.5" opacity="0.7"><circle cx="8" cy="1.6" r="1.3"/><circle cx="16.4" cy="1.2" r="1"/></g> <rect x="1" y="21.4" width="22" height="1.6" rx="0.8" fill="url(#gm-stone)" stroke="var(--c-stone-rim)" stroke-width="0.5"/>'],
