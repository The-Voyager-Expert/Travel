...
(function () {
  ...
  hamBtn.style.cssText = 'background:none;border:none;box-shadow:none;outline:none;-webkit-tap-highlight-color:transparent;padding:7px 12px;margin:0 14px 0 0;min-height:auto;cursor:pointer;user-select:none;align-items:center;gap:7px;color:#fff;flex-shrink:0;';
