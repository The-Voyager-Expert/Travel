...
(function () {
  ...
  var GM_SPRITE = {
    ...
    'insurance': ['0 0 24 24', '<path d="M12 2.6c5.3 0 9.6 4.3 9.6 9.6H2.4c0-5.3 4.3-9.6 9.6-9.6z" fill="var(--c-blue)"/> <path d="M12 2.6c1.9 0 3.4 4.3 3.4 9.6H8.6c0-5.3 1.5-9.6 3.4-9.6z" fill="var(--c-navy)"/> <path d="M11.2 12.2h1.6v6.6a2.6 2.6 0 0 1-5.2 0v-.6h1.6v.6a1 1 0 0 0 2 0z" fill="var(--c-stone)"/> <circle cx="12" cy="1.8" r="1.1" fill="var(--c-sun)"/>'],
    ...
    'scams': ['0 0 24 24', '<path d="M8.4 1.6h7.2l5.6 5.6v7.2l-5.6 5.6H8.4L2.8 14.4V7.2z" fill="var(--c-red)"/> <g fill="url(#gm-paper)" stroke="var(--c-rim-warm)" stroke-width="1" stroke-linejoin="round"> <rect x="8" y="6.4" width="1.8" height="5.6" rx="0.9"/> <rect x="10.2" y="5.4" width="1.8" height="6.6" rx="0.9"/> <rect x="12.4" y="5.6" width="1.8" height="6.4" rx="0.9"/> <rect x="14.6" y="6.8" width="1.8" height="5.2" rx="0.9"/> <path d="M8 10.4h8.4v2.6a4.2 4.2 0 0 1-8.4 0z"/> <path d="M8.2 11.6 6.2 9.6 5 10.8l3.2 3.2z"/> </g>'],
