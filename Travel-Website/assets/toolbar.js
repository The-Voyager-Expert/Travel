...
(function () {
  ...
  var GM_SPRITE = {
    ...
    'ticket': ['0 0 24 24', '<path d="M2 6.4h20v4a2 2 0 0 0 0 4v3.2H2v-3.2a2 2 0 0 0 0-4z" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"/><path d="M14.6 6.4h7.4v4a2 2 0 0 0 0 4v3.2h-7.4z" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/><rect x="4" y="9.6" width="7.4" height="1.4" rx="0.7" fill="url(#gm-stone)" stroke="var(--c-stone-rim)" stroke-width="0.5"/><rect x="4" y="12.6" width="5" height="1.4" rx="0.7" fill="url(#gm-stone)" stroke="var(--c-stone-rim)" stroke-width="0.5"/><path d="M16 14.6 20 11.4l-1.4-1.2-1.6 1L15 10l-.8.7 1 1.6-1 .8-1.4-.7-.6.5z" fill="url(#gm-navy)" stroke="var(--c-navy-rim)" stroke-width="0.5"/>'],
