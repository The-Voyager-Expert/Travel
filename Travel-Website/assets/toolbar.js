...
(function () {
  ...
  var GM_SPRITE = {
    ...
    'burst': ['0 0 24 24', '<path d="M9 15 15 9" stroke="var(--c-stone)" stroke-width="2.4" stroke-linecap="round"/><path d="M8.4 12.2 5.6 15a3.6 3.6 0 0 0 5.1 5.1l2.8-2.8" fill="none" stroke="var(--c-rust)" stroke-width="2.4" stroke-linecap="round"/><path d="M15.6 11.8 18.4 9a3.6 3.6 0 0 0-5.1-5.1l-2.8 2.8" fill="none" stroke="var(--c-clay)" stroke-width="2.4" stroke-linecap="round"/>'],
    ...
    'partly-cloudy': ['0 0 24 24', '<circle cx="9.6" cy="9" r="4.6" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/> <g stroke="var(--c-amber)" stroke-width="1.8" stroke-linecap="round"> <path d="M9.6 1.6v1.8"/><path d="M1.6 9h1.8"/><path d="M3.9 3.3 5.2 4.6"/> <path d="M15.3 3.3 14 4.6"/><path d="M3.9 14.7 5.2 13.4"/> </g> <path d="M9 21.4a3.9 3.9 0 0 1 .4-7.8 5.2 5.2 0 0 1 9.7 1.3 3.2 3.2 0 0 1-.5 6.5z" fill="url(#gm-sky)" stroke="var(--c-sky-rim)" stroke-width="0.5"/> <path d="M9.4 13.6a5.2 5.2 0 0 1 6 1.4 3.6 3.6 0 0 0-5.1 1.9 3.9 3.9 0 0 0-1.3-3.3z" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6" opacity="0.65"/>'],
    ...
    'sparkle': ['0 0 24 24', '<path d="M11.30 7.66L12.00 0.50L12.70 7.66ZM14.58 8.43L20.13 3.87L15.57 9.42ZM16.34 11.30L23.50 12.00L16.34 12.70ZM15.57 14.58L20.13 20.13L14.58 15.57ZM12.70 16.34L12.00 23.50L11.30 16.34ZM9.42 15.57L3.87 20.13L8.43 14.58ZM7.66 12.70L0.50 12.00L7.66 11.30ZM8.43 9.42L3.87 3.87L9.42 8.43Z" fill="url(#sph-red)" stroke="#8a1a11" stroke-width="0.5" stroke-linejoin="round"/><path d="M11.30 7.66L12.00 0.50L12.70 7.66ZM14.58 8.43L20.13 3.87L15.57 9.42ZM16.34 11.30L23.50 12.00L16.34 12.70ZM15.57 14.58L20.13 20.13L14.58 15.57ZM12.70 16.34L12.00 23.50L11.30 16.34ZM9.42 15.57L3.87 20.13L8.43 14.58ZM7.66 12.70L0.50 12.00L7.66 11.30ZM8.43 9.42L3.87 3.87L9.42 8.43Z" fill="url(#sph-red-b)"/><circle cx="12" cy="12" r="3.4" fill="url(#sph-red)" stroke="#8a1a11" stroke-width="0.5"/>'],
