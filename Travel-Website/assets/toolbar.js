...
(function () {
  ...
  var GM_SPRITE = {
    ...
    'hourglass': ['0 0 24 24', '<rect x="3.6" y="1.4" width="16.8" height="2.6" rx="0.8" fill="var(--c-cocoa)"/> <rect x="3.6" y="20" width="16.8" height="2.6" rx="0.8" fill="var(--c-cocoa)"/> <rect x="4.6" y="4" width="1.8" height="16" fill="var(--c-tan)"/> <rect x="17.6" y="4" width="1.8" height="16" fill="var(--c-tan)"/> <g fill="var(--c-cocoa)" opacity="0.45"> <rect x="4.4" y="7.2" width="2.2" height="1"/><rect x="4.4" y="15.8" width="2.2" height="1"/> <rect x="17.4" y="7.2" width="2.2" height="1"/><rect x="17.4" y="15.8" width="2.2" height="1"/> </g> <path d="M7.6 4.4h8.8v2.8L12.4 12l4 4.8v2.8H7.6v-2.8L11.6 12 7.6 7.2z" fill="var(--c-sky)"/> <path d="M8.9 5.6h6.2v1.4L12 10.4 8.9 7z" fill="var(--c-sun)"/> <path d="M12 13.6 15.4 18.4H8.6z" fill="var(--c-sun)"/> <rect x="11.6" y="10.6" width="0.8" height="3.2" fill="var(--c-amber)"/>'],
    ...
    'restaurants': ['0 0 24 24', '<path d="M3.2 14.4a8.8 8.8 0 0 1 17.6 0z" fill="var(--c-rust)"/> <path d="M6.2 14.4a5.8 5.8 0 0 1 9.4-4.5A8.8 8.8 0 0 0 6.2 14.4z" fill="var(--c-clay)"/> <circle cx="12" cy="4.4" r="1.6" fill="var(--c-sun)"/> <rect x="11.4" y="5.6" width="1.2" height="1.4" fill="var(--c-rust)"/> <rect x="1.8" y="14.8" width="20.4" height="2.6" rx="1.3" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"/> <rect x="4.6" y="18.6" width="14.8" height="2" rx="1" fill="var(--c-stone)" opacity="0.5"/>'],
