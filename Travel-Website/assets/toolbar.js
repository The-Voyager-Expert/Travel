...
(function () {
  ...
  var GM_SPRITE = {
    ...
    'budget': ['0 0 24 24', '<path d="M2.6 12.4c0-3.6 3.6-6.4 8.4-6.4 1.6 0 3.1.3 4.4.9l2.6-2.1v3.8c1 .9 1.8 2 2.2 3.2h1.8v4h-2.3c-.5.9-1.2 1.7-2.1 2.4v2.4h-3.4v-1.2c-.9.2-1.9.3-2.9.3s-2-.1-2.9-.3v1.2H4.6v-2.6C3.4 16.8 2.6 14.7 2.6 12.4z" fill="url(#gm-rose)" stroke="var(--c-rose-rim)" stroke-width="0.5"/><path d="M15.4 6.9 18 4.8V8c-.8-.5-1.7-.9-2.6-1.1z" fill="url(#gm-rose)" stroke="var(--c-rose-rim)" stroke-width="0.5"/><circle cx="6.6" cy="11.6" r="0.6" fill="url(#gm-tire)" stroke="var(--c-tire-rim)" stroke-width="0.5"/><rect x="9.4" y="4.2" width="5.2" height="1.6" rx="0.8" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/><path d="M2.6 12.4c-.9-.4-1.4-1.2-1.4-2.2 1 0 1.8.4 2.3 1.1z" fill="url(#gm-rose)" stroke="var(--c-rose-rim)" stroke-width="0.5"/>'],
