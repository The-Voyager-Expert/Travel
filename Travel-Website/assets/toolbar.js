...
(function () {
  ...
  var GM_SPRITE = {
    ...
    'museum-columned': ['0 0 24 24', '<path d="M12 2.6 21.4 8H2.6z" fill="url(#gm-clay)" stroke="var(--c-clay-rim)" stroke-width="0.5"/><path d="M12 2.6 21.4 8H2.6z" fill="url(#gm-gloss)"/> <rect x="2.2" y="8" width="19.6" height="1.7" fill="url(#gm-rust)" stroke="var(--c-rust-rim)" stroke-width="0.5"/> <g fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6" stroke-linejoin="round"><rect x="4.4" y="10" width="2.3" height="7.4"/><rect x="8.6" y="10" width="2.3" height="7.4"/><rect x="12.8" y="10" width="2.3" height="7.4"/><rect x="17" y="10" width="2.3" height="7.4"/></g> <rect x="2.6" y="17.4" width="18.8" height="2" fill="url(#gm-stone)" stroke="var(--c-stone-rim)" stroke-width="0.5"/> <path d="M18.6 14.6 19.7 16.8 22.1 17.2 20.35 18.9 20.8 21.3 18.6 20.2 16.4 21.3 16.85 18.9 15.1 17.2 17.5 16.8z" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/>'],
  ...
  /* THE EMOJI-TO-ICON CONVERSION IS DELETED (owner, 2026-08-20).
     `MARKS`, `markRow` and `_injectRowMarks` turned an authored glyph into a
     drawn mark at load: the guide wrote 🚶 and the site swapped it for a
     coloured symbol, keeping the original in a hidden .gm-mk-src span so
     textContent stayed byte-identical. The owner had every emoji deleted from
     the site source first — 70,854 of them across 247 files — so the swap had
     nothing left to convert, and then had the swap itself removed:
     "delete the conversion from one thing to another".
     Do not re-add it. Icons come back as icons, referenced directly, never as
     a character that something rewrites at render time. */
