...
(function () {
  ...
  var GM_SPRITE = {
    ...
    'hourglass': ['0 0 24 24', '<rect x="4.8" y="1.8" width="14.4" height="2.3" rx="1.15" fill="var(--c-rust)"/> <rect x="4.8" y="19.9" width="14.4" height="2.3" rx="1.15" fill="var(--c-rust)"/> <path d="M6.9 4.1h10.2v3.2L12.6 12l4.5 4.7v3.2H6.9v-3.2L11.4 12 6.9 7.3z" fill="var(--c-sky)"/> <path d="M8.3 5.5h7.4v1.5L12 10.7 8.3 7z" fill="var(--c-sun)"/> <path d="M12 13.5 15.7 18.5H8.3z" fill="var(--c-sun)"/> <rect x="11.4" y="10.6" width="1.2" height="3.4" fill="var(--c-amber)"/>'],
    ...
    'plane': ['-0.32 0.03 24.64 24.64', '<path d=\'M12 2a1.4 1.4 0 0 1 1.4 1.4v6.1l8.1 4.8v2.2l-8.1-2.6v5.2l2.6 1.9v1.7L12 21.4l-4 1.3v-1.7l2.6-1.9v-5.2L2.5 16.5v-2.2l8.1-4.8V3.4A1.4 1.4 0 0 1 12 2z\' fill=\'var(--c-blue)\'/><path d=\'M12 2a1.4 1.4 0 0 1 1.4 1.4v6.1l8.1 4.8v2.2l-8.1-2.6z\' fill=\'var(--c-navy)\'/><circle cx=\'12\' cy=\'5.4\' r=\'0.95\' fill=\'var(--c-sun)\'/>'],
    ...
    'sparkle': ['0 0 24 24', '<path d="M13 0.5 15.4 7.1 22 9.5 15.4 11.9 13 18.5 10.6 11.9 4 9.5 10.6 7.1z" fill="var(--c-sun)"/> <path d="M13 4.6 14.3 8.2 17.9 9.5 14.3 10.8 13 14.4z" fill="var(--c-amber)" opacity="0.55"/> <path d="M6 14.3 7.1 17.4 10.2 18.5 7.1 19.6 6 23.8 4.9 19.6 1.8 18.5 4.9 17.4z" fill="var(--c-blue)"/> <circle cx="20.2" cy="18.4" r="1.5" fill="var(--c-rose)"/>'],
