...
(function () {
  ...
  var GM_SPRITE = {
    ...
    'bang': ['0 0 24 24', '<path d="M9.3 2.2h5.4l-1 13.2h-3.4z" fill="var(--c-red)"/> <rect x="9.3" y="17.4" width="5.4" height="5.2" rx="1.6" fill="var(--c-red)"/> <path d="M10.2 3.4h1.5l-.75 11h-.5z" fill="var(--c-paper)" opacity="0.4"/> <rect x="10.1" y="18.3" width="1.5" height="1.6" rx="0.7" fill="var(--c-paper)" opacity="0.4"/>'],
    'beach': ['0 0 24 24', '<path d="M12 2.4C7.5 2.4 3.8 5.6 3 9.8L12 7.5l9 2.3C20.2 5.6 16.5 2.4 12 2.4z" fill="var(--c-red)"/> <path d="M12 2.4C9.8 2.4 8 5.6 7.6 9.8L12 7.5l4.4 2.3C16 5.6 14.2 2.4 12 2.4z" fill="var(--c-cream)"/> <rect x="11.3" y="7.5" width="1.4" height="10" fill="var(--c-cocoa)"/> <path d="M1.6 17.6h20.8v2.2H1.6z" fill="var(--c-tan)"/> <path d="M1.6 20.2c1.7 0 1.7 1.4 3.4 1.4s1.7-1.4 3.4-1.4 1.7 1.4 3.4 1.4 1.7-1.4 3.4-1.4 1.7 1.4 3.4 1.4 1.7-1.4 3.4-1.4" fill="none" stroke="var(--c-blue)" stroke-width="1.6" stroke-linecap="round"/>'],
    ...
    'dessert': ['0 0 24 24', '<circle cx="12" cy="2.9" r="1.3" fill="var(--c-red)"/> <path d="M11.7 4.1c0 1.1.6 1.4.6 2.1" stroke="var(--c-leaf)" stroke-width="0.9" fill="none"/> <circle cx="12" cy="6.4" r="3.5" fill="var(--c-cocoa)"/> <circle cx="8.6" cy="9.2" r="3.5" fill="var(--c-rose)"/> <circle cx="15.4" cy="9.2" r="3.5" fill="var(--c-cream)"/> <path d="M5.9 11.6h12.2L12 22.6z" fill="var(--c-tan)"/> <g stroke="var(--c-cocoa)" stroke-width="0.8" opacity="0.5"> <path d="M7.6 13.6 14.4 13.6M8.9 16 13.1 16M10.2 18.4h3.6"/> </g>'],
    'disney-parks': ['0 0 24 24', '<path d="M6.6 4.6h0.5v3h-0.5z" fill="var(--c-stone)"/> <path d="M7.1 4.7 9.3 5.5 7.1 6.3z" fill="var(--c-red)"/> <path d="M16.9 4.6h0.5v3h-0.5z" fill="var(--c-stone)"/> <path d="M17.4 4.7 19.6 5.5 17.4 6.3z" fill="var(--c-red)"/> <path d="M4.4 9.8 7 4.6l2.6 5.2z" fill="var(--c-blue)"/> <path d="M14.4 9.8 17 4.6l2.6 5.2z" fill="var(--c-blue)"/> <path d="M8.4 7.6 12 1.4l3.6 6.2z" fill="var(--c-navy)"/> <rect x="4.7" y="9.8" width="4.6" height="12" fill="var(--c-cream)"/> <rect x="14.7" y="9.8" width="4.6" height="12" fill="var(--c-cream)"/> <rect x="8.6" y="7.6" width="6.8" height="14.2" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="1" stroke-linejoin="round" /> <g fill="var(--c-blue)"> <rect x="6.1" y="12.2" width="1.8" height="2.6" rx="0.9"/><rect x="16.1" y="12.2" width="1.8" height="2.6" rx="0.9"/> <rect x="11.2" y="10" width="1.7" height="2.5" rx="0.85"/> </g> <path d="M9.9 21.8v-4.2a2.1 2.1 0 0 1 4.2 0v4.2z" fill="var(--c-rust)"/>'],
    ...
    'insurance': ['0 0 24 24', '<path d="M12 1.2 2.8 5.2v6.3c0 5.8 3.9 11.2 9.2 12.5 5.3-1.3 9.2-6.7 9.2-12.5V5.2z" fill="var(--c-sun)"/> <path d="M12 3.4 5 6.4v5.1c0 4.7 3 9.1 7 10.3 4-1.2 7-5.6 7-10.3V6.4z" fill="var(--c-blue)"/> <rect x="10.9" y="7.2" width="2.2" height="6.6" rx="1.1" fill="var(--c-paper)"/> <rect x="10.9" y="15.4" width="2.2" height="2.2" rx="1.1" fill="var(--c-paper)"/>'],
    ...
    'pennant': ['0 0 24 24', '<rect x="4.2" y="2" width="2.1" height="20" rx="1" fill="var(--c-navy)"/> <path d="M7 3.2 20.8 8.1 7 13z" fill="var(--c-red)"/> <path d="M7 6.6 15.4 9.6 7 12.6z" fill="var(--c-cream)" opacity="0.55"/>'],
    ...
    'castle': ['0 0 24 24', '<path d="M4.4 9.8 7 4.6l2.6 5.2z" fill="var(--c-blue)"/><path d="M14.4 9.8 17 4.6l2.6 5.2z" fill="var(--c-blue)"/><path d="M8.4 7.6 12 1.4l3.6 6.2z" fill="var(--c-navy)"/><rect x="4.7" y="9.8" width="4.6" height="12" fill="var(--c-cream)" stroke="var(--c-rim-warm)" stroke-width="0.9"/><rect x="14.7" y="9.8" width="4.6" height="12" fill="var(--c-cream)" stroke="var(--c-rim-warm)" stroke-width="0.9"/><rect x="8.6" y="7.6" width="6.8" height="14.2" fill="var(--c-cream)" stroke="var(--c-rim-warm)" stroke-width="0.9"/><path d="M9.9 21.8v-4.2a2.1 2.1 0 0 1 4.2 0v4.2z" fill="var(--c-rust)"/>'],
    ...
    'compare': ['0 0 24 24', '<rect x="2.2" y="3.2" width="8.8" height="17.6" rx="1.6" fill="var(--c-blue)"/><rect x="13" y="3.2" width="8.8" height="17.6" rx="1.6" fill="var(--c-clay)"/><g fill="var(--c-paper)" opacity="0.85"><rect x="4" y="6" width="5.2" height="1.4" rx="0.7"/><rect x="4" y="9" width="3.6" height="1.4" rx="0.7"/><rect x="14.8" y="6" width="5.2" height="1.4" rx="0.7"/><rect x="14.8" y="9" width="4.4" height="1.4" rx="0.7"/></g><rect x="4" y="12.6" width="5.2" height="5.6" rx="0.8" fill="var(--c-paper)" opacity="0.5"/><rect x="14.8" y="14.6" width="5.2" height="3.6" rx="0.8" fill="var(--c-paper)" opacity="0.5"/>'],
    'compass': ['0 0 24 24', '<circle cx="12" cy="12" r="10.6" fill="var(--c-navy)"/><circle cx="12" cy="12" r="8.2" fill="var(--c-cream)"/><path d="M12 3.4 15.6 12 12 12.6z" fill="var(--c-red)"/><path d="M12 3.4 8.4 12 12 12.6z" fill="var(--c-clay)"/><path d="M12 20.6 8.4 12 12 11.4z" fill="var(--c-stone)"/><path d="M12 20.6 15.6 12 12 11.4z" fill="var(--c-cocoa)" opacity="0.75"/><circle cx="12" cy="12" r="1.5" fill="var(--c-paper)"/>'],
    ...
    'neighborhoods': ['0 0 24 24', '<rect x="1.6" y="9.4" width="6.6" height="12.2" rx="0.8" fill="var(--c-green)"/><rect x="8.8" y="4.6" width="6.4" height="17" rx="0.8" fill="var(--c-clay)"/><rect x="15.8" y="11.8" width="6.6" height="9.8" rx="0.8" fill="var(--c-blue)"/><g fill="var(--c-cream)"><rect x="3" y="11.4" width="1.7" height="1.9"/><rect x="5.5" y="11.4" width="1.7" height="1.9"/><rect x="10.1" y="6.8" width="1.8" height="2"/><rect x="12.5" y="6.8" width="1.8" height="2"/><rect x="17.2" y="13.8" width="1.7" height="1.9"/></g><rect x="12.5" y="14" width="1.8" height="2" fill="var(--c-sun)"/><rect x="1" y="21.4" width="22" height="1.6" rx="0.8" fill="var(--c-stone)"/>'],
    'packing': ['0 0 24 24', '<rect x="2.4" y="6" width="19.2" height="14.6" rx="2.2" fill="var(--c-rust)"/><path d="M9 5.4V4.2h6v1.2h2V4a2 2 0 0 0-2-2H9a2 2 0 0 0-2 2v1.4z" fill="var(--c-cocoa)"/><rect x="2.4" y="10" width="19.2" height="2.4" fill="var(--c-cream)"/><g fill="var(--c-sun)"><rect x="9.6" y="13.6" width="1.8" height="2.6" rx="0.5"/><rect x="12.6" y="13.6" width="1.8" height="2.6" rx="0.5"/></g>'],
    ...
    'printer': ['0 0 24 24', '<rect x="6.4" y="2.4" width="11.2" height="5" rx="0.6" fill="var(--c-cream)" stroke="var(--c-rim-warm)" stroke-width="0.9"/><rect x="2.4" y="7.4" width="19.2" height="9.2" rx="2" fill="var(--c-navy)"/><rect x="4.4" y="9.6" width="3.4" height="1.8" rx="0.9" fill="var(--c-sky)"/><circle cx="18.6" cy="10.4" r="1.2" fill="var(--c-green)"/><rect x="6.4" y="14.4" width="11.2" height="7.2" rx="0.6" fill="var(--c-paper)" stroke="var(--c-rim-warm)" stroke-width="0.9"/><g stroke="var(--c-stone)" stroke-width="1" stroke-linecap="round"><path d="M8.4 16.8h7.2M8.4 19h4.6"/></g>'],
    'pyramid': ['0 0 24 24', '<circle cx="18.4" cy="5.6" r="2.8" fill="var(--c-sun)"/><path d="M8.4 6.6 17.6 19.6H-0.8z" fill="var(--c-tan)"/><path d="M8.4 6.6V19.6H-0.8z" fill="var(--c-amber)" opacity="0.35"/><path d="M17.2 11.4 23.6 19.6h-12.8z" fill="var(--c-tan)"/><path d="M17.2 11.4v8.2h-6.4z" fill="var(--c-amber)" opacity="0.35"/><rect x="0.6" y="19.4" width="22.8" height="2" rx="1" fill="var(--c-cream)" stroke="var(--c-rim-warm)" stroke-width="0.8"/>'],
    ...
    'tower': ['0 0 24 24', '<path d="M12 0.6 15.4 6.4H8.6z" fill="var(--c-rust)"/><rect x="7.8" y="6.4" width="8.4" height="15.4" fill="var(--c-cream)" stroke="var(--c-rim-warm)" stroke-width="1"/><circle cx="12" cy="11.4" r="3.2" fill="var(--c-paper)" stroke="var(--c-cocoa)" stroke-width="0.9"/><path d="M12 9.2v2.2l1.8 1.1" stroke="var(--c-cocoa)" stroke-width="1.1" stroke-linecap="round" fill="none"/><g fill="var(--c-blue)"><rect x="9.4" y="16" width="1.8" height="2.8" rx="0.9"/><rect x="12.8" y="16" width="1.8" height="2.8" rx="0.9"/></g>'],
    'transit': ['0 0 24 24', '<path d="M6.2 3.4h11.6a2.6 2.6 0 0 1 2.6 2.6v10a2.6 2.6 0 0 1-2.6 2.6H6.2A2.6 2.6 0 0 1 3.6 16V6a2.6 2.6 0 0 1 2.6-2.6z" fill="var(--c-green)"/><rect x="5.4" y="5.8" width="13.2" height="5.4" rx="0.9" fill="var(--c-sky)"/><rect x="11.4" y="5.8" width="1.2" height="5.4" fill="var(--c-green)"/><rect x="3.6" y="12.6" width="16.8" height="1.6" fill="var(--c-cream)"/><rect x="5.2" y="15.4" width="3" height="1.8" rx="0.9" fill="var(--c-sun)"/><rect x="15.8" y="15.4" width="3" height="1.8" rx="0.9" fill="var(--c-sun)"/><path d="M5.6 19.6h12.8" stroke="var(--c-tire)" stroke-width="1.6" stroke-linecap="round"/>'],
    'travel-apps': ['0 0 24 24', '<rect x="4.6" y="1.2" width="14.8" height="21.6" rx="2.6" fill="var(--c-cocoa)"/><rect x="6" y="4.6" width="12" height="14.6" rx="0.8" fill="var(--c-paper)"/><g><rect x="7.2" y="5.8" width="3.2" height="3.2" rx="0.9" fill="var(--c-blue)"/><rect x="11.4" y="5.8" width="3.2" height="3.2" rx="0.9" fill="var(--c-sun)"/><rect x="15.6" y="5.8" width="1.2" height="3.2" rx="0.6" fill="var(--c-green)"/><rect x="7.2" y="10" width="3.2" height="3.2" rx="0.9" fill="var(--c-rose)"/><rect x="11.4" y="10" width="3.2" height="3.2" rx="0.9" fill="var(--c-teal)"/><rect x="15.6" y="10" width="1.2" height="3.2" rx="0.6" fill="var(--c-plum)"/><rect x="7.2" y="14.2" width="3.2" height="3.2" rx="0.9" fill="var(--c-amber)"/><rect x="11.4" y="14.2" width="3.2" height="3.2" rx="0.9" fill="var(--c-rust)"/></g><circle cx="12" cy="21" r="1.1" fill="var(--c-stone)"/>'],
    ...
    'triptype': ['0 0 24 24', '<path d="M10.4 2.6H4a1.4 1.4 0 0 0-1.4 1.4v6.4c0 .4.1.7.4 1l9.6 9.6c.5.5 1.4.5 2 0l6.4-6.4c.5-.6.5-1.5 0-2L11.4 3a1.4 1.4 0 0 0-1-.4z" fill="var(--c-teal)"/><circle cx="6.6" cy="6.6" r="1.9" fill="var(--c-paper)"/>'],
    'list': ['1.5 1 21 21', '<rect x="4.2" y="2.6" width="15.6" height="18.4" rx="1.8" fill="var(--c-paper)" stroke="var(--c-rim-warm)" stroke-width="1.2"/><rect x="8.6" y="1" width="6.8" height="3.2" rx="1.1" fill="var(--c-clay)"/><g stroke="var(--c-stone)" stroke-width="1.3" stroke-linecap="round"><path d="M10.6 8.6h6.4M10.6 12.6h6.4M10.6 16.6h4.4"/></g><g fill="none" stroke="var(--c-green)" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M6.4 8.4 7.6 9.6 9.6 7.4"/><path d="M6.4 12.4 7.6 13.6 9.6 11.4"/></g>'],
    'luggage': ['1 1 22 22', '<path d="M9 6V4.6h6V6h2V4.2A2.2 2.2 0 0 0 14.8 2H9.2A2.2 2.2 0 0 0 7 4.2V6z" fill="var(--c-cocoa)"/><rect x="2.6" y="6" width="18.8" height="14" rx="2.2" fill="var(--c-clay)"/><rect x="2.6" y="10.4" width="18.8" height="2.6" fill="var(--c-cream)"/><rect x="9.4" y="14.6" width="1.8" height="2.6" rx="0.5" fill="var(--c-sun)"/><rect x="12.8" y="14.6" width="1.8" height="2.6" rx="0.5" fill="var(--c-sun)"/>'],
    'passport': ['0 0 24 24', '<rect x="4.4" y="2.4" width="15.2" height="19.2" rx="2" fill="var(--c-navy)"/><rect x="5.6" y="2.4" width="1.6" height="19.2" fill="var(--c-blue)"/><rect x="17.8" y="4.4" width="2.4" height="15.2" rx="1" fill="var(--c-cream)" stroke="var(--c-rim-warm)" stroke-width="0.8"/><circle cx="12.4" cy="9.6" r="3.4" fill="none" stroke="var(--c-sun)" stroke-width="1.3"/><path d="M12.4 6.2v6.8M9 9.6h6.8" stroke="var(--c-sun)" stroke-width="0.9"/><rect x="8.6" y="15.6" width="7.6" height="1.7" rx="0.85" fill="var(--c-sun)"/>'],
    ...
    'restaurants': ['0 0 24 24', '<path d="M3.2 14.4a8.8 8.8 0 0 1 17.6 0z" fill="var(--c-rust)"/> <path d="M6.2 14.4a5.8 5.8 0 0 1 9.4-4.5A8.8 8.8 0 0 0 6.2 14.4z" fill="var(--c-clay)"/> <circle cx="12" cy="4.4" r="1.6" fill="var(--c-sun)"/> <rect x="11.4" y="5.6" width="1.2" height="1.4" fill="var(--c-rust)"/> <rect x="1.8" y="14.8" width="20.4" height="2.6" rx="1.3" fill="var(--c-cream)"/> <rect x="4.6" y="18.6" width="14.8" height="2" rx="1" fill="var(--c-stone)" opacity="0.5"/>'],
    'ride': ['0 0 24 24', '<rect x="9.4" y="2.2" width="5.2" height="2.6" rx="0.9" fill="var(--c-amber)"/> <path d="M6.2 10.4 7.7 6.8c.3-.8.9-1.2 1.7-1.2h5.2c.8 0 1.4.4 1.7 1.2l1.5 3.6z" fill="var(--c-sky)"/> <rect x="2.4" y="9.8" width="19.2" height="6.6" rx="2.1" fill="var(--c-sun)"/> <g fill="var(--c-tire)"> <rect x="4.2" y="11.9" width="2.1" height="1.5"/><rect x="8.4" y="11.9" width="2.1" height="1.5"/> <rect x="12.6" y="11.9" width="2.1" height="1.5"/><rect x="16.8" y="11.9" width="2.1" height="1.5"/> <rect x="6.3" y="13.4" width="2.1" height="1.5"/><rect x="10.5" y="13.4" width="2.1" height="1.5"/> <rect x="14.7" y="13.4" width="2.1" height="1.5"/><rect x="18.9" y="13.4" width="1.5" height="1.5"/> </g> <circle cx="6.8" cy="17.4" r="2.6" fill="var(--c-tire)"/><circle cx="6.8" cy="17.4" r="1.1" fill="var(--c-stone)"/> <circle cx="17.2" cy="17.4" r="2.6" fill="var(--c-tire)"/><circle cx="17.2" cy="17.4" r="1.1" fill="var(--c-stone)"/>'],
    ...
    'ship': ['0 0 24 24', '<rect x="10.2" y="1.6" width="2.4" height="3.2" rx="0.6" fill="var(--c-rust)"/> <rect x="8.4" y="4.4" width="7.6" height="4.2" rx="1" fill="var(--c-paper)"/> <rect x="4.2" y="8.4" width="15.6" height="4.2" rx="1" fill="var(--c-cream)"/> <g fill="var(--c-sky)"> <rect x="9.6" y="5.6" width="1.8" height="1.8" rx="0.4"/><rect x="12.6" y="5.6" width="1.8" height="1.8" rx="0.4"/> <rect x="5.8" y="9.6" width="1.9" height="1.9" rx="0.4"/><rect x="9" y="9.6" width="1.9" height="1.9" rx="0.4"/> <rect x="12.2" y="9.6" width="1.9" height="1.9" rx="0.4"/><rect x="15.4" y="9.6" width="1.9" height="1.9" rx="0.4"/> </g> <path d="M2.6 12.8h18.8l-2.8 5H5.4z" fill="var(--c-red)"/> <path d="M2 19.4c1.7 0 1.7 1.5 3.4 1.5s1.7-1.5 3.4-1.5 1.7 1.5 3.4 1.5 1.7-1.5 3.4-1.5 1.7 1.5 3.4 1.5" fill="none" stroke="var(--c-blue)" stroke-width="1.7" stroke-linecap="round"/>'],
    'shuffle': ['0 0 24 24', '<path d="M12 5.4c5 0 9.2 3.1 11 6.6-1.8 3.5-6 6.6-11 6.6S2.8 15.5 1 12c1.8-3.5 6-6.6 11-6.6z" fill="url(#gm-cream)" stroke="var(--c-rim-cool)" stroke-width="1" stroke-linejoin="round" /><circle cx="12" cy="12" r="4" fill="var(--c-blue)"/><circle cx="12" cy="12" r="1.7" fill="var(--c-navy)"/><circle cx="10.6" cy="10.6" r="0.8" fill="var(--c-paper)" opacity="0.8"/>'],
    ...
    'tap-water': ['0 0 24 24', '<path d="M12 2.2C12 2.2 5 10.4 5 14.4a7 7 0 0 0 14 0c0-4-7-12.2-7-12.2z" fill="var(--c-blue)"/> <path d="M12 5.4c0 0-4.4 5.6-4.4 9a4.4 4.4 0 0 0 2 3.7C8.4 16.6 8 15.4 8 14.2c0-2.8 4-8.8 4-8.8z" fill="var(--c-sky)" opacity="0.75"/> <ellipse cx="9.4" cy="15.4" rx="1.5" ry="2.1" fill="var(--c-paper)" opacity="0.5" transform="rotate(-20 9.4 15.4)"/>'],
    'theatre': ['0 0 24 24', '<path d="M2.6 4.4h10.2v6.8a5.1 5.1 0 0 1-10.2 0z" fill="var(--c-sun)"/> <g fill="var(--c-cocoa)"><circle cx="5" cy="8" r="1"/><circle cx="10.4" cy="8" r="1"/></g> <path d="M5.6 12.4h4.6a2.5 2.5 0 0 1-4.6 0z" fill="var(--c-cocoa)"/> <path d="M11.2 8.6h10.2v6.8a5.1 5.1 0 0 1-10.2 0z" fill="var(--c-plum)"/> <g fill="var(--c-cream)"><circle cx="13.6" cy="12.2" r="1"/><circle cx="19" cy="12.2" r="1"/></g> <path d="M14.2 18.4a2.3 2.3 0 0 1 4.6 0z" fill="var(--c-cream)"/>'],
    ...
    'tipping': ['0 0 24 24', '<circle cx="12" cy="7" r="5.6" fill="var(--c-sun)"/> <circle cx="12" cy="7" r="4" fill="var(--c-amber)"/> <text x="12" y="10.1" font-family="ui-serif, Georgia, serif" font-size="7.8" font-weight="700" fill="var(--c-cream)" text-anchor="middle">$</text> <path d="M4 15h4.6l2.2 1.6h2.9c.9 0 1.6.7 1.6 1.6H11v1.4h4.6l4.4-2.3 1 1.7-5 3.5H4z" fill="var(--c-tan)"/> <rect x="1.4" y="14.6" width="3" height="8" rx="1.1" fill="var(--c-rust)"/>'],
    ...
    'van': ['0 0 24 24', '<path d="M6 2.4h12a2.8 2.8 0 0 1 2.8 2.8v12a2.8 2.8 0 0 1-2.8 2.8H6A2.8 2.8 0 0 1 3.2 17.2v-12A2.8 2.8 0 0 1 6 2.4z" fill="var(--c-rust)"/> <rect x="4.9" y="5.6" width="14.2" height="6.2" rx="1" fill="var(--c-sky)"/> <rect x="11.4" y="5.6" width="1.2" height="6.2" fill="var(--c-rust)"/> <rect x="3.2" y="13.4" width="17.6" height="1.8" fill="var(--c-cream)"/> <circle cx="7.5" cy="17.4" r="1.7" fill="var(--c-sun)"/><circle cx="16.5" cy="17.4" r="1.7" fill="var(--c-sun)"/> <path d="M6.4 20h11.2l1.4 2v.6H5V22z" fill="var(--c-tire)"/>'],
    'visas': ['0 0 24 24', '<rect x="4.2" y="2.4" width="15.4" height="19.2" rx="2" fill="var(--c-navy)"/> <rect x="5.6" y="2.4" width="1.6" height="19.2" fill="var(--c-blue)"/> <rect x="17.8" y="4.4" width="2.4" height="15.2" rx="1" fill="var(--c-cream)"/> <circle cx="12.4" cy="9.6" r="3.4" fill="none" stroke="var(--c-sun)" stroke-width="1.3"/> <path d="M12.4 6.2v6.8M9 9.6h6.8" stroke="var(--c-sun)" stroke-width="0.9"/> <rect x="8.6" y="15.6" width="7.6" height="1.7" rx="0.85" fill="var(--c-sun)"/>'],
  ...
  var GM_PALETTE =
    ...
    '--c-paper-shade:#e6ded2;--c-cream-shade:#e6d5b8;--c-rim-warm:#c25a20;--c-rim-cool:#93a4b2}' +
    ...
    '--c-rim-warm:#e0873f;--c-rim-cool:#7d95a8}}' +
