...
(function () {
  ...
  var ITEMS = [
    ...
    { group: '🏆 Best Of', groupIcon: 'star-cup', children: [
        ...
        { href: base + 'Trip-Essentials/Best-Islands.html',                       text: 'Islands', icon: 'star-cup' },
        ...
        { href: base + 'Trip-Essentials/Best-Mountains-and-Rock-Formations.html', text: 'Mountains & Rock Formations', icon: 'star-cup' },
        { href: base + 'Trip-Essentials/Best-Museums.html',                       text: 'Museums', icon: 'star-cup' },
        ...
        { href: base + 'Trip-Essentials/Best-Surfing.html',                       text: 'Surfing', icon: 'star-cup' },
