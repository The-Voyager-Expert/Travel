...
(function () {
  ...
  styleEl.textContent =
    ...
    '@media(max-width:1260px){' +
      ...
      '.tb-ham-label{display:block;min-height:0!important;flex:1;text-align:center;font-size:20px!important;font-weight:700;color:#fff;padding:0;letter-spacing:.06em;text-transform:uppercase}' +
  ...
  var NEIGH_DATA = {
    ...
    'corfu':        { n: [{ name: 'Corfu Town (Old Town)',    why: 'UNESCO quarter, all main sights walkable', rec: true },
                           { name: 'Kanoni / Garitsa Bay',   why: 'South of Old Town, quieter, near airport' },
                           { name: 'Gouvia / Kontokali',     why: 'North marina resort strip, 7km from centre' }] },
        'curacao':      { n: [{ name: 'Pietermaai',               why: 'Boutique hotels, lively nightlife, walkable to Punda', rec: true },
                           { name: 'Punda (Downtown)',         why: 'Historic merchant district, Queen Emma Bridge steps away' },
                           { name: 'Jan Thiel',               why: 'East coast beach resort area, quieter and car-dependent' }] },
