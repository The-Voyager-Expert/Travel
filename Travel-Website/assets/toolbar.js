...
(function () {
  ...
  var GM_SPRITE = {
    ...
    /* Site-Icons.html #302 */
    'wx-rain': ['0 0 24 24', '<path d="M7 14.6a4 4 0 0 1 .5-8 5.4 5.4 0 0 1 10 1.4 3.3 3.3 0 0 1-.5 6.6z" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6" stroke-linejoin="round" /><path d="M7 14.6a4 4 0 0 1 .5-8 5.4 5.4 0 0 1 10 1.4 3.3 3.3 0 0 1-.5 6.6z" fill="url(#gm-gloss)"/> <g stroke="var(--c-blue)" stroke-width="2.1" stroke-linecap="round"> <path d="M7.6 17.2 6.4 20.4"/><path d="M12 17.2 10.8 20.4"/><path d="M16.4 17.2 15.2 20.4"/> </g>'],
    /* Site-Icons.html #303 */
    ...
    'restaurants-hotel': ['0 0 24 24', '<circle cx="12" cy="12.4" r="6.0" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"/><circle cx="12" cy="12.4" r="6.0" fill="url(#gm-gloss)"/><circle cx="12" cy="12.4" r="4.2" fill="none" stroke="var(--c-stone)" stroke-width="0.9" opacity="0.65"/><path fill-rule="evenodd" d="M1.01 5.40H4.19A0.46 0.46 0 0 1 4.65 5.86V10.10A2.05 1.75 0 0 1 0.55 10.10V5.86A0.46 0.46 0 0 1 1.01 5.40ZM1.22 5.02h0.48v3.39a0.24 0.24 0 0 1 -0.48 0zM2.36 5.02h0.48v3.39a0.24 0.24 0 0 1 -0.48 0zM3.51 5.02h0.48v3.39a0.24 0.24 0 0 1 -0.48 0z" fill="url(#gm-stone)" stroke="var(--c-stone-rim)" stroke-width="0.5"/><rect x="1.90" y="11.70" width="1.40" height="9.70" rx="0.70" fill="url(#gm-navy)" stroke="var(--c-navy-rim)" stroke-width="0.5"/><path d="M22.10 12.60C22.40 11.10 22.40 9.00 22.30 7.20C22.06 5.55 21.90 4.50 21.42 4.50C20.86 4.50 20.29 5.35 20.07 6.60C19.87 8.10 19.85 9.60 19.95 10.80C20.09 11.75 20.40 12.25 20.70 12.60Z" fill="url(#gm-stone)" stroke="var(--c-stone-rim)" stroke-width="0.5"/><rect x="20.70" y="12.30" width="1.40" height="9.10" rx="0.70" fill="url(#gm-navy)" stroke="var(--c-navy-rim)" stroke-width="0.5"/>'],
    ...
    'wx-partly': ['0 0 24 24', '<circle cx="8.8" cy="8.4" r="4.2" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/><circle cx="8.8" cy="8.4" r="4.2" fill="url(#gm-gloss)"/> <g stroke="var(--c-sun)" stroke-width="1.8" stroke-linecap="round"> <path d="M8.8 1.6v1.8"/><path d="M1.8 8.4h1.8"/><path d="M3.8 3.4 5.1 4.7"/><path d="M13.8 3.4 12.5 4.7"/><path d="M3.8 13.4l1.3-1.3"/> </g> <path d="M8.6 20.8a3.9 3.9 0 0 1 .5-7.8 5.2 5.2 0 0 1 9.7 1.3 3.2 3.2 0 0 1-.5 6.5z" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6" stroke-linejoin="round" /> <path d="M9.1 13a5.2 5.2 0 0 1 6 1.5 3.6 3.6 0 0 0-5.1 1.9A3.9 3.9 0 0 0 9.1 13z" fill="url(#gm-sky)" stroke="var(--c-sky-rim)" stroke-width="0.5" opacity="0.45"/>'],
    'wx-overcast': ['0 0 24 24', '<path d="M6.6 13.6a3.4 3.4 0 0 1 .4-6.8 4.6 4.6 0 0 1 8.6 1.2 2.8 2.8 0 0 1-.4 5.6z" fill="url(#gm-stone)" stroke="var(--c-stone-rim)" stroke-width="0.5" opacity="0.55"/> <path d="M8.4 20.4a4.1 4.1 0 0 1 .5-8.2 5.5 5.5 0 0 1 10.2 1.4 3.4 3.4 0 0 1-.5 6.8z" fill="url(#gm-paper)" stroke="var(--c-rim-warm)" stroke-width="0.6" stroke-linejoin="round" /><path d="M8.4 20.4a4.1 4.1 0 0 1 .5-8.2 5.5 5.5 0 0 1 10.2 1.4 3.4 3.4 0 0 1-.5 6.8z" fill="url(#gm-gloss)"/>'],
    'wx-snow': ['0 0 24 24', '<path d="M7 13.8a4 4 0 0 1 .5-8 5.4 5.4 0 0 1 10 1.4 3.3 3.3 0 0 1-.5 6.6z" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6" stroke-linejoin="round" /><path d="M7 13.8a4 4 0 0 1 .5-8 5.4 5.4 0 0 1 10 1.4 3.3 3.3 0 0 1-.5 6.6z" fill="url(#gm-gloss)"/> <g stroke="var(--c-sky)" stroke-width="1.5" stroke-linecap="round"> <path d="M8.4 16.6v4.4M6.5 17.7l3.8 2.2M10.3 17.7l-3.8 2.2"/> <path d="M15.6 16.6v4.4M13.7 17.7l3.8 2.2M17.5 17.7l-3.8 2.2"/> </g>'],
    ...
    'entry-req': ['0 0 24 24', '<rect x="2" y="3.6" width="20" height="16.8" rx="2" fill="url(#gm-cream)" stroke="var(--c-rim-cool)" stroke-width="0.6" stroke-linejoin="round" /><rect x="2" y="3.6" width="20" height="16.8" rx="2" fill="url(#gm-gloss)"/> <rect x="2" y="3.6" width="20" height="3.4" rx="2" fill="url(#gm-navy)" stroke="var(--c-navy-rim)" stroke-width="0.5"/><rect x="2" y="5.6" width="20" height="1.4" fill="url(#gm-navy)" stroke="var(--c-navy-rim)" stroke-width="0.5"/> <g fill="url(#gm-stone)" stroke="var(--c-stone-rim)" stroke-width="0.5" opacity="0.6"><rect x="4.6" y="9.6" width="9" height="1.4" rx="0.7"/><rect x="4.6" y="12.4" width="7" height="1.4" rx="0.7"/><rect x="4.6" y="15.2" width="5" height="1.4" rx="0.7"/></g> <g transform="rotate(-16 16.4 14.4)"><circle cx="16.4" cy="14.4" r="4.4" fill="none" stroke="var(--c-red)" stroke-width="1.5"/><path d="M13.6 14.4h5.6" stroke="var(--c-red)" stroke-width="1.5" stroke-linecap="round"/></g>'],
    'exchange': ['0 0 24 24', '<circle cx="4.9" cy="12.0" r="4.5" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/><circle cx="4.9" cy="12.0" r="4.5" fill="url(#gm-gloss)"/><circle cx="4.9" cy="12.0" r="3.54" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"/><text x="4.9" y="13.85" font-family="ui-sans-serif, system-ui, sans-serif" font-size="5.1" font-weight="700" text-anchor="middle" fill="url(#gm-amber)" stroke="var(--c-amber-rim)" stroke-width="0.4">$</text><circle cx="19.1" cy="12.0" r="4.5" fill="url(#gm-navy)" stroke="var(--c-navy-rim)" stroke-width="0.5"/><circle cx="19.1" cy="12.0" r="4.5" fill="url(#gm-gloss)"/><circle cx="19.1" cy="12.0" r="3.54" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"/><text x="19.1" y="13.85" font-family="ui-sans-serif, system-ui, sans-serif" font-size="5.1" font-weight="700" text-anchor="middle" fill="url(#gm-navy)" stroke="var(--c-navy-rim)" stroke-width="0.4">&#8364;</text><path d="M9.55 9.60L12.75 9.60L12.75 8.78L14.60 10.20L12.75 11.62L12.75 10.80L9.55 10.80Z" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5" stroke-linejoin="round"/><path d="M14.60 13.20L11.40 13.20L11.40 12.38L9.55 13.80L11.40 15.22L11.40 14.40L14.60 14.40Z" fill="url(#gm-navy)" stroke="var(--c-navy-rim)" stroke-width="0.5" stroke-linejoin="round"/>'],
    ...
    'globe': ['0 0 24 24', '<circle cx="10.4" cy="10.4" r="7.4" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6"/><circle cx="10.4" cy="10.4" r="7.4" fill="none" stroke="var(--c-navy-rim)" stroke-width="1.5"/><circle cx="9" cy="9" r="2.7" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/><path d="M8.2 14.6a2.3 2.3 0 0 1 .2-4.5 3 3 0 0 1 5.6.7 2 2 0 0 1-.5 3.8z" fill="url(#gm-sky)" stroke="var(--c-sky-rim)" stroke-width="0.5"/><path d="M15.9 15.9l5.4 5.4" stroke="var(--c-navy-rim)" stroke-width="2.6" stroke-linecap="round" fill="none"/>'],
    /* Site-Icons.html #941 */
    'link-out': ['0 0 24 24', '<rect x="2.4" y="6.4" width="12.8" height="15.2" rx="2" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6" stroke-linejoin="round" /><g stroke="var(--c-stone)" stroke-width="1.3" stroke-linecap="round" opacity="0.6"><path d="M5.4 11h6.8M5.4 14.4h6.8M5.4 17.8h4"/></g><path d="M13.6 10.4 21.4 2.6" stroke="var(--c-rust)" stroke-width="2.4" stroke-linecap="round"/><path d="M15.2 2.4h6.6V9" fill="none" stroke="var(--c-rust)" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/>'],
    'hotel': ['0 0 24 24', '<rect x="4.2" y="2.6" width="15.6" height="19" rx="1" fill="url(#gm-cream)" stroke="var(--c-rim-cool)" stroke-width="0.6" stroke-linejoin="round" /><rect x="4.2" y="2.6" width="15.6" height="19" rx="1" fill="url(#gm-gloss)"/> <rect x="3.6" y="2.6" width="16.8" height="2.8" rx="0.6" fill="url(#gm-rust)" stroke="var(--c-rust-rim)" stroke-width="0.5"/> <g fill="url(#gm-blue)" stroke="var(--c-blue-rim)" stroke-width="0.5"> <rect x="6.2" y="7" width="2.7" height="2.6" rx="0.4"/><rect x="10.65" y="7" width="2.7" height="2.6" rx="0.4"/> <rect x="15.1" y="7" width="2.7" height="2.6" rx="0.4"/> <rect x="6.2" y="11.2" width="2.7" height="2.6" rx="0.4"/><rect x="15.1" y="11.2" width="2.7" height="2.6" rx="0.4"/> <rect x="6.2" y="15.4" width="2.7" height="2.6" rx="0.4"/><rect x="15.1" y="15.4" width="2.7" height="2.6" rx="0.4"/> </g> <rect x="10.65" y="11.2" width="2.7" height="2.6" rx="0.4" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/> <rect x="7.2" y="17.8" width="9.6" height="1.4" rx="0.7" fill="url(#gm-clay)" stroke="var(--c-clay-rim)" stroke-width="0.5"/> <rect x="10.1" y="19.2" width="3.8" height="2.4" rx="0.4" fill="url(#gm-rust)" stroke="var(--c-rust-rim)" stroke-width="0.5"/>'],
    ...
    'peak': ['0 0 24 24', '<path d="M1.4 20.6 12 4 22.6 20.6z" fill="url(#gm-slate)" stroke="var(--c-slate-rim)" stroke-width="0.5"/><path d="M12 4 16.1 10.4c-1.3.7-2.3.2-3.3-.4-1-.6-2.2-.5-3.3.2L7.9 10.4z" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6"/><path d="M12 4 16.1 10.4c-1.3.7-2.3.2-3.3-.4-1-.6-2.2-.5-3.3.2L7.9 10.4z" fill="url(#gm-gloss)"/><path d="M12 4 9.4 20.6h-8z" fill="url(#gm-tire)" stroke="var(--c-tire-rim)" stroke-width="0.5" opacity="0.35"/><rect x="0.8" y="20.4" width="22.4" height="1.6" rx="0.8" fill="url(#gm-stone)" stroke="var(--c-stone-rim)" stroke-width="0.5"/>'],
    ...
    'high-speed-train': ['0 0 24 24', '<path d="M12 1.6c3.9 0 6.4 2.6 6.4 6.4v9.6a2.6 2.6 0 0 1-2.6 2.6H8.2a2.6 2.6 0 0 1-2.6-2.6V8c0-3.8 2.5-6.4 6.4-6.4z" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6" stroke-linejoin="round" /><path d="M12 1.6c3.9 0 6.4 2.6 6.4 6.4v9.6a2.6 2.6 0 0 1-2.6 2.6H8.2a2.6 2.6 0 0 1-2.6-2.6V8c0-3.8 2.5-6.4 6.4-6.4z" fill="url(#gm-gloss)"/> <path d="M12 1.6c3.9 0 6.4 2.6 6.4 6.4v1.2H5.6V8c0-3.8 2.5-6.4 6.4-6.4z" fill="url(#gm-navy)" stroke="var(--c-navy-rim)" stroke-width="0.5"/> <path d="M8.3 6.4C9 4.9 10.4 4.1 12 4.1s3 .8 3.7 2.3z" fill="url(#gm-sky)" stroke="var(--c-sky-rim)" stroke-width="0.5"/> <rect x="5.6" y="10.6" width="12.8" height="4.4" fill="url(#gm-blue)" stroke="var(--c-blue-rim)" stroke-width="0.5"/> <rect x="7" y="16.4" width="2.9" height="1.8" rx="0.9" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/> <rect x="14.1" y="16.4" width="2.9" height="1.8" rx="0.9" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/> <path d="M8.6 20.4 6.6 22.8M15.4 20.4l2 2.4" stroke="var(--c-stone)" stroke-width="1.6" stroke-linecap="round"/>'],
    ...
    'star6-yellow': ['0 0 24 24', '<path d="M12 0.5 15.1 6.63 21.96 6.25 18.2 12 21.96 17.75 15.1 17.37 12 23.5 8.9 17.37 2.04 17.75 5.8 12 2.04 6.25 8.9 6.63z" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5" stroke-linejoin="round"/><path d="M12 0.5 15.1 6.63 21.96 6.25 18.2 12 21.96 17.75 15.1 17.37 12 23.5 8.9 17.37 2.04 17.75 5.8 12 2.04 6.25 8.9 6.63z" fill="url(#gm-amber)" stroke="var(--c-amber-rim)" stroke-width="0.5" opacity="0.35"/>'],
    ...
    /* Site-Icons.html #1420 / #1421 / #1422 — the accessibility marks.
       Straight from the catalogue, never redrawn. A stop authors the icon
       directly: <svg class="gm-icon" data-icon="steps" data-role="steps"
       viewBox="0 0 24 24" aria-hidden="true"><use href="#gm-i-steps"/></svg>. */
    'steps': ['0 0 24 24', '<path d="M2.0 21.75 L2.0 16.875 L7.0 16.875 L7.0 12.0 L12.0 12.0 L12.0 7.125 L17.0 7.125 L17.0 2.25 L22.0 2.25 L22.0 21.75 Z" fill="url(#gm-slate)" stroke="var(--c-slate-rim)" stroke-width="0.5" stroke-linejoin="round"/><path d="M2.0 21.75 L2.0 16.875 L7.0 16.875 L7.0 12.0 L12.0 12.0 L12.0 7.125 L17.0 7.125 L17.0 2.25 L22.0 2.25 L22.0 21.75 Z" fill="url(#gm-gloss)"/>'],
    ...
    'viaduct': ['0 0 24 24', '<path d="M2.0 2.25 L22.0 2.25 L22.0 4.85 L2.0 4.85 Z" fill="url(#gm-stone)" stroke="var(--c-stone-rim)" stroke-width="0.5" stroke-linejoin="round"/><path d="M2.0 2.25 L22.0 2.25 L22.0 4.85 L2.0 4.85 Z" fill="url(#gm-gloss)"/><path d="M3.2 4.85 L6.2 4.85 L6.2 19.15 L3.2 19.15 Z M10.5 4.85 L13.5 4.85 L13.5 19.15 L10.5 19.15 Z M17.8 4.85 L20.8 4.85 L20.8 19.15 L17.8 19.15 Z" fill="url(#gm-slate)" stroke="var(--c-slate-rim)" stroke-width="0.5" stroke-linejoin="round"/><path d="M3.2 4.85 L6.2 4.85 L6.2 19.15 L3.2 19.15 Z M10.5 4.85 L13.5 4.85 L13.5 19.15 L10.5 19.15 Z M17.8 4.85 L20.8 4.85 L20.8 19.15 L17.8 19.15 Z" fill="url(#gm-gloss)"/><g fill="none" stroke="var(--c-slate-rim)" stroke-width="1.5"><path d="M6.2 13.9 A2.15 2.15 0 0 1 10.5 13.9"/><path d="M13.5 13.9 A2.15 2.15 0 0 1 17.8 13.9"/></g><path d="M2.0 19.15 L22.0 19.15 L22.0 21.75 L2.0 21.75 Z" fill="url(#gm-slate)" stroke="var(--c-slate-rim)" stroke-width="0.5" stroke-linejoin="round"/><path d="M2.0 19.15 L22.0 19.15 L22.0 21.75 L2.0 21.75 Z" fill="url(#gm-gloss)"/>'],
  ...
  function toggleHamMenu(e) {
    ...
    hamBtn.innerHTML = open
      /* currentColor, not #fff. The white ✕ dates from the terracotta bar; the
         ...
         .tb-ham colour — #C04E1A here, and whatever the theme sets elsewhere —
  ...
  /* ── In-guide bookmark — pin this guide as current trip from inside the guide.
     ...
     All viewports. Resting colour: terracotta #C04E1A (outline when unpinned,
  ...
  if (isRealGuide) {
    function injectGuideBookmark() {
      ...
      btn.style.cssText =
        ...
        'color:#C04E1A;transition:opacity .12s;opacity:' + (on ? '1' : '.65') + ';';
  ...
  var HOTEL_ALT_DATA = {
    ...
    'abu-dhabi': { h: [
      { name: 'Grand Mercure Majlis Residences Abu Dhabi', note: 'Independent — Zayed the First Street in the downtown grid, indoor pool, sauna and steam room, 24h reception · 9.2 Booking.com', url: 'https://www.booking.com/hotel/ae/grand-mercure-residence.html', tier: 'budget' },
      { name: 'Al Maha Arjaan by Rotana', note: 'Independent — suites with kitchenettes on Fatima bint Mubarak Street, rooftop pool, 24h reception · 9.0 Booking.com', url: 'https://www.booking.com/hotel/ae/al-maha-rotana-suites.html', tier: 'budget' },
      { name: 'Courtyard by Marriott World Trade Center, Abu Dhabi', note: 'Marriott Courtyard brand — Hamdan Bin Mohammed Street above the WTC souk, heated rooftop pool · 8.7 Booking.com', url: 'https://www.booking.com/hotel/ae/courtyard-by-marriott-world-trade-center-abu-dhabi.html', tier: 'mid' },
      { name: 'Radisson Blu Hotel & Resort, Abu Dhabi Corniche', note: 'Radisson Blu brand — Corniche Road West with a private beach, heated outdoor pool, spa · 9.0 Booking.com', url: 'https://www.booking.com/hotel/ae/radisson-blu-hotel-and-resort-abu-dhabi-corniche.html', tier: 'mid' },
      { name: 'Sheraton Abu Dhabi Hotel & Resort', note: 'Marriott Sheraton brand — beachfront at the Corniche and Al Salam Street end, tennis courts, kids club · 9.1 Booking.com', url: 'https://www.booking.com/hotel/ae/sheraton-abu-dhabi-resort.html', tier: 'expensive' },
      { name: 'InterContinental Abu Dhabi by IHG', note: 'IHG first-tier brand — Al Bateen marina beachfront, infinity pool, tennis courts, spa · 9.0 Booking.com', url: 'https://www.booking.com/hotel/ae/intercontinental-abu-dhabi.html', tier: 'expensive' },
      { name: 'Conrad Abu Dhabi Etihad Towers', note: 'Hilton Conrad brand — Etihad Towers on the Corniche, infinity pool, private beach area, spa with steam room · 9.2 Booking.com', url: 'https://www.booking.com/hotel/ae/conrad-abu-dhabi-etihad-towers.html', tier: 'expensive' },
    ...
    'bali': { h: [
      ...
      { name: 'Four Seasons Resort Bali at Sayan', note: 'Four Seasons brand — Ubud jungle ridge above the Ayung River gorge, signature treetop restaurant, 2 pools, riverside spa · 9.5 Booking.com', url: 'https://www.booking.com/hotel/id/four-seasons-resort-bali-at-sayan.html', tier: 'luxury' },
      { name: 'The St. Regis Bali Resort', note: 'Marriott Luxury Collection — Nusa Dua beachfront, private pool villas, 24-hr butler service, Kayuputi Pan-Asian dining · 9.7 Booking.com', url: 'https://www.booking.com/hotel/id/the-st-regis-bali-resort.html', tier: 'luxury' },
      { name: 'Bliss Ubud Spa Resort', note: 'Independent — Jalan Raya Sanggingan north of central Ubud, 24h reception, AC, year-round outdoor pool, on-site spa and free airport shuttle · 9.1 Booking.com', url: 'https://www.booking.com/hotel/id/bliss-bungalow-ubud.html', tier: 'budget' },
      { name: 'Sri Ratih Cottages', note: 'Independent — Jalan Campuhan in Penestanan west of Ubud centre, 24h reception, AC, indoor pool and spa, family rooms · 9.0 Booking.com', url: 'https://www.booking.com/hotel/id/sri-ratih-cottages.html', tier: 'budget' },
    ...
    'banff': { h: [
      ...
      { name: 'Banff Park Lodge', note: 'Independent — Lynx Street a block off Banff Avenue, year-round indoor pool, steam room, on-site dining · 8.7 Booking.com', url: 'https://www.booking.com/hotel/ca/banff-park-lodge.html', tier: 'mid' },
      { name: 'Mount Royal Hotel', note: 'Independent — 138 Banff Avenue in the town centre, rooftop hot tubs, ski storage, mountain-view rooms · 8.4 Booking.com', url: 'https://www.booking.com/hotel/ca/mount-royal-banff.html', tier: 'budget' },
      { name: 'Banff Aspen Lodge', note: 'Independent — 401 Banff Avenue at the north end of the townsite, 24h reception, AC, sauna and rooftop hot tubs, free parking and ski storage · 8.8 Booking.com', url: 'https://www.booking.com/hotel/ca/banff-aspen-lodge.html', tier: 'budget' },
    ...
    'bangkok': { h: [
      ...
      { name: 'Capella Bangkok', note: 'Capella brand — Chao Phraya riverside, 101 villas and suites, three pools, Côte by Mauro Colagreco dining, Auriga Spa · 9.6 Booking.com' , url: 'https://www.booking.com/hotel/th/capella-bangkok.html', tier: 'luxury' },
      { name: 'Rosewood Bangkok', note: 'Rosewood brand — Ploenchit CBD skyline tower, rooftop pool, Nan Bei Chinese restaurant, Sense, a Rosewood Spa · 9.3 Booking.com' , url: 'https://www.booking.com/hotel/th/rosewood-bangkok.html', tier: 'luxury' },
      { name: 'Away Bangkok Sukhumvit', note: 'Independent — Sukhumvit Soi 20 in Khlong Toei, 4-star, 24h reception, AC, saltwater rooftop pool and pool bar, fitness centre · 9.1 Booking.com', url: 'https://www.booking.com/hotel/th/away-bangkok-sukhumvit.html', tier: 'budget' },
      { name: 'Paradox Bangkok Sukhumvit', note: 'Independent — Sukhumvit Soi 15 between BTS Asoke and MRT Sukhumvit, 24h reception, AC, outdoor pool with pool bar, fitness centre · 9.0 Booking.com', url: 'https://www.booking.com/hotel/th/paradox-bangkok-sukhumvit.html', tier: 'budget' },
      { name: 'Aloft by Marriott Bangkok Sukhumvit 11', note: 'Marriott Aloft brand — Sukhumvit Soi 11 near BTS Nana, 24h reception, rooftop infinity pool, W XYZ bar with live music · 8.8 Booking.com', url: 'https://www.booking.com/hotel/th/aloft-bangkok-sukhumvit-11.html', tier: 'mid' },
    ...
    'barbados': { h: [
      ...
      { name: 'Treasure Beach Art Hotel, An Autograph Collection All-Inclusive Resort', note: 'Marriott Autograph — adults-only on Paynes Bay, 24h reception, beachfront, rotating Barbadian art collection · 7.7 Booking.com', url: 'https://www.booking.com/hotel/bb/treasure-beach-amp-spa.html', tier: 'expensive' },
      { name: 'Tamarind, Barbados, An Autograph Collection All-Inclusive Resort', note: 'Marriott Autograph — Paynes Bay Beach, 24h reception, two beachfront pools, kids club, water sports · 7.4 Booking.com', url: 'https://www.booking.com/hotel/bb/tamarind-by-elegant-hotels.html', tier: 'expensive' },
      { name: 'Coral Reef Club', note: 'Independent boutique — adults-focused west coast retreat, private beach, lush tropical gardens, suites and cottages', url: 'https://www.booking.com/hotel/bb/coral-reef-club.html', tier: 'luxury' },
      { name: 'South Gap Hotel', note: 'Independent — beachfront at St Lawrence Gap in Christ Church, 24h reception, AC, poolside bar, walkable to the south-coast restaurant strip · 9.0 Booking.com', url: 'https://www.booking.com/hotel/bb/south-gap.html', tier: 'budget' },
    ...
    'barcelona': { h: [
      ...
      { name: 'Cotton House Hotel, Autograph Collection', note: 'Marriott Autograph — 1905 Casa Garriga Nogués on Gran Via, rooftop pool and terrace bar, The Cotton Club restaurant, Eixample · 9.2 Booking.com', url: 'https://www.booking.com/hotel/es/cotton-house-autograph-collection.html', tier: 'expensive' },
      { name: 'W Barcelona', note: 'Marriott W brand — sail-shaped tower on Barceloneta beach, Eclipse rooftop bar, WET pool deck, direct beach access · 8.7 Booking.com', url: 'https://www.booking.com/hotel/es/w-barcelona.html', tier: 'expensive' },
      { name: 'Hotel Villa Emilia', note: 'Independent — Carrer de Calàbria in the Eixample Esquerra, 24h reception, AC, roof terrace and bar, soundproof rooms · 9.0 Booking.com', url: 'https://www.booking.com/hotel/es/villa-emilia.html', tier: 'budget' },
      { name: 'Praktik Rambla', note: 'Independent — a 19th-century flat on Rambla de Catalunya, 24h reception, AC, interior garden terrace, walkable to Passeig de Gràcia · 8.7 Booking.com', url: 'https://www.booking.com/hotel/es/praktik-rambla.html', tier: 'budget' },
    ...
    'beijing': { h: [
      ...
      { name: 'The Peninsula Beijing', note: 'Peninsula brand — Wangfujing near the Forbidden City, indoor pool, Jing restaurant, Rolls-Royce fleet transfer, butler service · 9.1 Booking.com' , url: 'https://www.booking.com/hotel/cn/the-peninsula-beijing.html', tier: 'luxury' },
      { name: 'Park Hyatt Beijing', note: 'Hyatt brand — CCTV district skyline tower in Chaoyang, The East restaurant, rooftop bar, indoor pool, spa · 9.0 Booking.com' , url: 'https://www.booking.com/hotel/cn/park-hyatt-beijing.html', tier: 'luxury' },
      { name: 'Inner Mongolia Grand Hotel', note: 'Independent — Chongwen Inner Street in Dongcheng, a short walk south of Wangfujing, 24h reception, AC, fitness centre and on-site restaurant · 9.2 Booking.com', url: 'https://www.booking.com/hotel/cn/inner-mongolia-grand-wangfujing.html', tier: 'budget' },
      { name: 'Happy Dragon Alley Hotel Beijing Tian An Men Forbidden City', note: 'Independent — Dongsi Jiutiao hutong in Dongcheng, walking distance to the Forbidden City, 24h reception, AC, courtyard restaurant and bar · 9.4 Booking.com', url: 'https://www.booking.com/hotel/cn/dragon-house.html', tier: 'budget' },
      { name: 'Doubletree By Hilton Beijing East Third Ring Road', note: 'Hilton DoubleTree brand — Huaweili in Chaoyang on the East Third Ring, 24h reception, AC, fitness centre, soundproof rooms · 8.7 Booking.com', url: 'https://www.booking.com/hotel/cn/days-hotels-suites-beijing.html', tier: 'mid' },
    ...
    'bend': { h: [
      ...
      { name: 'Campfire Hotel', note: 'Independent boutique — east Bend, outdoor pool and fire pits, in-room craft beer taps, walkable east-side dining · 8.4 Booking.com', url: 'https://www.booking.com/hotel/us/bend-campfire-hotel.html', tier: 'budget' },
      { name: 'Riverhouse on the Deschutes', note: 'Independent — on the Deschutes River, indoor pool and hot tub, private beach access · 8.6 Booking.com', url: 'https://www.booking.com/hotel/us/riverhouse-on-the-deschutes.html', tier: 'mid' },
      { name: 'Hampton Inn & Suites Bend', note: 'Hilton Hampton brand — SW Columbia Street near the Old Mill District, 24h reception, AC, year-round indoor pool and hot tub, free parking · 8.9 Booking.com', url: 'https://www.booking.com/hotel/us/hampton-inn-amp-suites-bend.html', tier: 'mid' },
      { name: 'SpringHill Suites by Marriott Bend', note: 'Marriott SpringHill brand — SW Industrial Way beside the Old Mill District, 24h reception, AC, indoor pool and hot tub, all-suite rooms · 9.2 Booking.com', url: 'https://www.booking.com/hotel/us/springhill-suites-by-marriott-bend.html', tier: 'expensive' },
    ...
    'berlin': { h: [
      ...
      { name: 'Hotel Adlon Kempinski', note: 'Kempinski brand — Pariser Platz beside the Brandenburg Gate, most iconic Berlin address, rooftop spa, Lorenz Adlon Esszimmer restaurant · 9.0 Booking.com' , url: 'https://www.booking.com/hotel/de/adlon.html', tier: 'luxury' },
      { name: 'Das Stue', note: 'Design Hotels — 1939 Danish Embassy conversion in Tiergarten, Cinco by Paco Pérez restaurant, spa with pool, 78 rooms · 9.0 Booking.com' , url: 'https://www.booking.com/hotel/de/das-stue.html', tier: 'luxury' },
      { name: 'Adina Apartment Hotel Berlin Hackescher Markt', note: 'Independent — An der Spandauer Brücke by Hackescher Markt, 24h reception, AC, apartments with kitchens, sauna and fitness centre · 8.7 Booking.com', url: 'https://www.booking.com/hotel/de/adina-apartment-berlin-hackescher-markt.html', tier: 'budget' },
      { name: 'HighPark Berlin am Potsdamer Platz', note: 'Independent — Gabriele-Tergit-Promenade a short walk from Potsdamer Platz, 24h reception, soundproof rooms, garden, no AC · 9.1 Booking.com', url: 'https://www.booking.com/hotel/de/high-park-apartments-by-palmira.html', tier: 'budget' },
      { name: 'Novotel Berlin Mitte', note: 'Novotel first-tier brand — Fischerinsel on the Spree between Alexanderplatz and Gendarmenmarkt, 24h reception, AC, sauna and fitness centre · 8.5 Booking.com', url: 'https://www.booking.com/hotel/de/berlin-mitte.html', tier: 'mid' },
  ...
  function _injectShareStopButtons() {
    ...
    var _checkSvg =
      '<svg width="12" height="12" viewBox="0 0 12 12" fill="none" aria-hidden="true">' +
        '<path d="M2 6l3 3 5-5" stroke="#C04E1A" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>' +
      '</svg>';
  ...
  function _injectWishlistButtons() {
    ...
    _wlCss.textContent =
      ...
      '.tve-wl-btn{background:none;border:none;cursor:pointer;color:#C04E1A;padding:0;margin-left:8px;' +
      ...
      '.tve-wl-pclear:hover{color:#C04E1A;}' +
      ...
      '.tve-wl-prow-rm:hover{color:#C04E1A;}' +
  ...
  function _injectStopNotes() {
    ...
    _nCss.textContent =
      ...
      'border-left:3px solid #C04E1A;border-radius:0 5px 5px 0;' +
      ...
      'text-transform:uppercase;color:#C04E1A;flex-shrink:0;padding-top:2px;}' +
      ...
      '.tve-note-input:focus{outline:none;border-color:#C04E1A;box-shadow:0 0 0 2px rgba(192,78,26,.15);}' +
      ...
      '.tve-notes-act:hover{color:#C04E1A;}' +
  ...
  (function _loungeChipInject() {
    ...
    var CHIP_DATA = {
      ...
      'foz-do-iguacu':     {iata:'IGU', name:'Foz do Iguaçu International'},
      ...
      'sao-luis':          {iata:'SLZ', name:'Marechal Cunha Machado International'},
      'sao-paulo':         {iata:'GRU', name:'São Paulo Guarulhos International'},
    ...
    function _inject() {
      ...
      var gi = parts.findIndex(function (x) { return x.toLowerCase() === 'guides'; });
      if (gi < 0) return;
      /* The guide is /guides/<city>.html since the 2026-08-16 flatten, and Pages
         also serves it extensionless at /guides/<city> — so strip the extension
         and lowercase rather than taking the segment raw. Before this the raw
         segment was 'athens.html' against a table keyed 'Athens', so the lookup
         missed on EVERY guide and the chip stopped rendering site-wide. */
      var slug = (parts[gi + 1] || '').replace(/\.html$/i, '').toLowerCase();
  ...
  function _injectCopyDayButtons() {
    ...
    var _okSvg =
      '<svg width="12" height="12" viewBox="0 0 12 12" fill="none" aria-hidden="true">' +
        '<path d="M2 6l3 3 5-5" stroke="#C04E1A" stroke-width="1.8" ' +
          'stroke-linecap="round" stroke-linejoin="round"/>' +
      '</svg>';
    ...
    _cdCss.textContent =
      ...
      '.tve-copy-day-btn:hover,.tve-copy-day-btn:focus-visible{color:#C04E1A;}' +
      '.tve-copy-day-btn:focus-visible{outline:2px solid #C04E1A;' +
      'outline-offset:3px;border-radius:4px;}' +
      '.tve-copy-day-btn.copied{color:#C04E1A;}';
