...
(function () {
  ...
  var ITEMS = [
    ...
    { group: '🏆 Best Of', groupIcon: 'star-cup', children: [
        ...
        { href: base + 'Trip-Essentials/Best-Amusement-Parks.html',               text: 'Amusement Parks', icon: 'star-cup' },
        { href: base + 'Trip-Essentials/Best-Animal-Encounters.html',             text: 'Animal Encounters', icon: 'star-cup' },
        { href: base + 'Trip-Essentials/Best-Aquariums.html',                     text: 'Aquariums', icon: 'star-cup' },
        { href: base + 'Trip-Essentials/Best-Architecture.html',                  text: 'Architecture', icon: 'star-cup' },
        { href: base + 'Trip-Essentials/Best-Art-Museums.html',                   text: 'Art Museums', icon: 'star-cup' },
