...
(function () {
  ...
  var GM_SPRITE = {
    ...
    'steps': ['0 0 24 24', '<path d="M0.5 21.2 L0.5 17.3 L6.25 17.3 L6.25 12.9 L12 12.9 L12 8.5 L17.75 8.5 L17.75 4.1 L23.5 4.1 L23.5 21.2 Z" fill="url(#gm-cocoa)" stroke="var(--c-cocoa-rim)" stroke-width="0.5" stroke-linejoin="round"/><path d="M0.5 21.2 L0.5 17.3 L6.25 17.3 L6.25 12.9 L12 12.9 L12 8.5 L17.75 8.5 L17.75 4.1 L23.5 4.1 L23.5 21.2 Z" fill="url(#gm-gloss)"/>'],
    'step-free': ['0 0 24 24', '<path d="M0.5 21.2 L0.5 17.3 L6.25 17.3 L6.25 12.9 L12 12.9 L12 8.5 L17.75 8.5 L17.75 4.1 L23.5 4.1 L23.5 21.2 Z M2.0 19.7 L2.0 18.8 L7.75 18.8 L7.75 14.4 L13.5 14.4 L13.5 10.0 L19.25 10.0 L19.25 5.6 L22.0 5.6 L22.0 19.7 Z" fill-rule="evenodd" fill="url(#gm-cocoa)" stroke="var(--c-cocoa-rim)" stroke-width="0.5" stroke-linejoin="round"/><path d="M0.5 21.2 L0.5 17.3 L6.25 17.3 L6.25 12.9 L12 12.9 L12 8.5 L17.75 8.5 L17.75 4.1 L23.5 4.1 L23.5 21.2 Z M2.0 19.7 L2.0 18.8 L7.75 18.8 L7.75 14.4 L13.5 14.4 L13.5 10.0 L19.25 10.0 L19.25 5.6 L22.0 5.6 L22.0 19.7 Z" fill-rule="evenodd" fill="url(#gm-gloss)"/>'],
    'wheelchair': ['0 0 24 24', '<path d="M5.299999999999999 14.9a6.9 6.9 0 1 0 13.8 0a6.9 6.9 0 1 0 -13.8 0ZM7.699999999999999 14.9a4.5 4.5 0 1 1 9.0 0a4.5 4.5 0 1 1 -9.0 0Z" fill-rule="evenodd" fill="url(#gm-navy)" stroke="var(--c-navy-rim)" stroke-width="0.5"/><path d="M5.299999999999999 14.9a6.9 6.9 0 1 0 13.8 0a6.9 6.9 0 1 0 -13.8 0ZM7.699999999999999 14.9a4.5 4.5 0 1 1 9.0 0a4.5 4.5 0 1 1 -9.0 0Z" fill-rule="evenodd" fill="url(#gm-gloss)"/><path d="M12.2 6.8 H15.3 L15.95 11.05 H19.6 A1.45 1.45 0 0 1 19.6 13.95 H15.05 L17.15 18.35 L14.35 19.65 L11.95 14.3 L11.6 13.2 Z" fill="url(#gm-navy)" stroke="var(--c-navy-rim)" stroke-width="0.5" stroke-linejoin="round"/><path d="M12.2 6.8 H15.3 L15.95 11.05 H19.6 A1.45 1.45 0 0 1 19.6 13.95 H15.05 L17.15 18.35 L14.35 19.65 L11.95 14.3 L11.6 13.2 Z" fill="url(#gm-gloss)"/><circle cx="13.75" cy="4.05" r="2.7" fill="url(#gm-navy)" stroke="var(--c-navy-rim)" stroke-width="0.5"/><circle cx="13.75" cy="4.05" r="2.7" fill="url(#gm-gloss)"/>'],
