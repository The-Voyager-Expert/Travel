...
(function () {
  ...
  styleEl.textContent =
   ...
   left margin exactly at every width. */
    ...
    '.tb a.tb-active{box-sizing:border-box;display:inline-flex;align-items:center;min-height:28px;color:#7a3b1e!important;background:transparent;border:1.5px solid rgba(184,92,42,0.85);border-radius:16px;padding:4px 16px;font-weight:600;line-height:1.2}' +
    ...
    '.tb-ddbtn.tb-active{box-sizing:border-box;display:inline-flex;align-items:center;min-height:28px;color:#7a3b1e!important;background:transparent;border:1.5px solid rgba(184,92,42,0.85);border-radius:16px;padding:4px 16px;font-weight:600;line-height:1.2}' +
   ...
   colour before, which was invisible against the other tabs. */
    '.tb-dd.tb-open>.tb-ddbtn:not(.tb-active){box-sizing:border-box;display:inline-flex;align-items:center;min-height:28px;color:#7a3b1e!important;background:transparent;'+
      'border:1.5px solid rgba(184,92,42,0.85);border-radius:16px;padding:4px 16px;line-height:1.2}' +
