...
(function () {
  ...
  var GM_SPRITE = {
    ...
    'hourglass': ['0 0 24 24', '<path d="M7.1 4.6C6.3 9.6 9.4 11.0 12 12.6C14.6 11.0 17.7 9.6 16.9 4.6Z" fill="url(#gm-sky)" stroke="var(--c-sky-rim)" stroke-width="1.2" stroke-linejoin="round" opacity="0.20"/><path d="M7.1 21.0C6.3 16.0 9.4 14.6 12 12.6C14.6 14.6 17.7 16.0 16.9 21.0Z" fill="url(#gm-sky)" stroke="var(--c-sky-rim)" stroke-width="1.2" stroke-linejoin="round" opacity="0.20"/><path d="M7.80 20.60Q12 14.20 16.20 20.60Z" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/><path d="M7.1 4.6C6.3 9.6 9.4 11.0 12 12.6C14.6 11.0 17.7 9.6 16.9 4.6Z" fill="none" stroke="var(--c-sky-rim)" stroke-width="1.2" stroke-linejoin="round"/><path d="M7.1 21.0C6.3 16.0 9.4 14.6 12 12.6C14.6 14.6 17.7 16.0 16.9 21.0Z" fill="none" stroke="var(--c-sky-rim)" stroke-width="1.2" stroke-linejoin="round"/><rect x="5.6" y="2.6" width="12.8" height="2" rx="1" fill="url(#gm-rust)" stroke="var(--c-rust-rim)" stroke-width="1.2"/><rect x="5.6" y="20.8" width="12.8" height="2" rx="1" fill="url(#gm-rust)" stroke="var(--c-rust-rim)" stroke-width="1.2"/>'],
