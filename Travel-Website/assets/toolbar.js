...
(function () {
  ...
  var GM_SPRITE = {
    ...
    'wx-overcast': ['0 0 24 24', '<path d="M6.6 13.6a3.4 3.4 0 0 1 .4-6.8 4.6 4.6 0 0 1 8.6 1.2 2.8 2.8 0 0 1-.4 5.6z" fill="url(#gm-stone)" stroke="var(--c-stone-rim)" stroke-width="0.5" opacity="0.55"/> <path d="M8.4 20.4a4.1 4.1 0 0 1 .5-8.2 5.5 5.5 0 0 1 10.2 1.4 3.4 3.4 0 0 1-.5 6.8z" fill="url(#gm-paper)" stroke="var(--c-rim-warm)" stroke-width="1" stroke-linejoin="round" />'],
    'wx-snow': ['0 0 24 24', '<path d="M7 13.8a4 4 0 0 1 .5-8 5.4 5.4 0 0 1 10 1.4 3.3 3.3 0 0 1-.5 6.6z" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="1" stroke-linejoin="round" /> <g stroke="var(--c-sky)" stroke-width="1.5" stroke-linecap="round"> <path d="M8.4 16.6v4.4M6.5 17.7l3.8 2.2M10.3 17.7l-3.8 2.2"/> <path d="M15.6 16.6v4.4M13.7 17.7l3.8 2.2M17.5 17.7l-3.8 2.2"/> </g>'],
    'bills': ['0 0 24 24', '<rect x="1.4" y="8.2" width="16.6" height="9.6" rx="1.5" fill="url(#gm-teal)" stroke="var(--c-teal-rim)" stroke-width="0.5" transform="rotate(-9 9.7 13)"/> <rect x="5.2" y="7.4" width="16.6" height="9.6" rx="1.5" fill="url(#gm-green)" stroke="var(--c-green-rim)" stroke-width="0.5" transform="rotate(7 13.5 12.2)"/> <circle cx="13.5" cy="12.4" r="2.5" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"/> <path d="M13.5 10.2v4.4M12.3 11.3h2.4M12.3 13.3h2.4" stroke="var(--c-green)" stroke-width="0.9" stroke-linecap="round"/>'],

    'dish-cloche': ['0 0 24 24', '<path d="M3.2 14.4a8.8 8.8 0 0 1 17.6 0z" fill="url(#gm-rust)" stroke="var(--c-rust-rim)" stroke-width="0.5"/> <path d="M6.2 14.4a5.8 5.8 0 0 1 9.4-4.5A8.8 8.8 0 0 0 6.2 14.4z" fill="url(#gm-clay)" stroke="var(--c-clay-rim)" stroke-width="0.5"/> <circle cx="12" cy="4.4" r="1.6" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/> <rect x="11.4" y="5.6" width="1.2" height="1.4" fill="url(#gm-rust)" stroke="var(--c-rust-rim)" stroke-width="0.5"/> <rect x="1.8" y="14.8" width="20.4" height="2.6" rx="1.3" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"/> <rect x="4.6" y="18.6" width="14.8" height="2" rx="1" fill="url(#gm-stone)" stroke="var(--c-stone-rim)" stroke-width="0.5" opacity="0.5"/>'],
    'kids': ['0 0 24 24', '<ellipse cx="13.6" cy="13.4" rx="5.0" ry="4.4" fill="url(#gm-tire)" stroke="var(--c-tire-rim)" stroke-width="0.5"/><path d="M9.4 11.6c-2.2.2-3.8 1.4-4.8 3.4 2-.2 3.7-.9 4.9-2.1z" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6"/><path d="M13.2 9.6c-.5-3.4-.7-5.6-.5-7l2 .3c-.2 1.3 0 3.4.5 6.6z" fill="url(#gm-tan)" stroke="var(--c-tan-rim)" stroke-width="0.5"/><ellipse cx="13.4" cy="2.6" rx="1.9" ry="1.6" fill="url(#gm-tan)" stroke="var(--c-tan-rim)" stroke-width="0.5"/><path d="M11.8 2.2 9.2 3l2.6 1.1z" fill="url(#gm-clay)" stroke="var(--c-clay-rim)" stroke-width="0.5"/><circle cx="13.9" cy="2.2" r="0.45" fill="url(#gm-tire)" stroke="var(--c-tire-rim)" stroke-width="0.5"/><g fill="none" stroke="var(--c-rose)" stroke-width="1.5" stroke-linecap="round"><path d="M11.8 17.4v4M15.6 17.4v4"/></g><g fill="none" stroke="var(--c-rose)" stroke-width="1.2" stroke-linecap="round"><path d="M11.8 21.4h2M15.6 21.4h2"/></g>'],
    'tropical-bay': ['0 0 24 24', '<defs><clipPath id="cps"><rect x="3.4" y="5.2" width="17.2" height="13.6" rx="0.8"/></clipPath></defs><rect x="1.6" y="3.4" width="20.8" height="17.2" rx="1.6" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6"/><rect x="3.4" y="5.2" width="17.2" height="13.6" rx="0.8" fill="url(#gm-sky)" stroke="var(--c-sky-rim)" stroke-width="0.5"/><g clip-path="url(#cps)"><circle cx="18.2" cy="7.4" r="2.4" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/><path d="M3.4 13.4h17.2v5.4H3.4z" fill="url(#gm-sky)" stroke="var(--c-sky-rim)" stroke-width="0.5"/><path d="M3.4 12.4c2.6-1.8 5-2.4 8-2.4s5.4.6 9.2 2.4v1.4H3.4z" fill="url(#gm-green)" stroke="var(--c-green-rim)" stroke-width="0.5"/><path d="M6 12.4c-.3-2.4-.2-4 .3-5l1.5.4c-.4.9-.5 2.4-.2 4.6z" fill="url(#gm-cocoa)" stroke="var(--c-cocoa-rim)" stroke-width="0.5"/><path d="M6.6 7.6c1.8-1 3.2-.8 4.2.6-1.2-.4-2.4-.3-3.4.3zM6.6 7.6c-1.8-1-3.2-.8-4.2.6 1.2-.4 2.4-.3 3.4.3z" fill="url(#gm-leaf)" stroke="var(--c-leaf-rim)" stroke-width="0.5"/><g fill="none" stroke="var(--c-paper)" stroke-width="0.7" stroke-linecap="round" opacity="0.85"><path d="M13.6 15.6c.9 0 .9.7 1.8.7s.9-.7 1.8-.7M13.6 17.4c.9 0 .9.7 1.8.7s.9-.7 1.8-.7"/></g></g>'],

    'moorish': ['0 0 24 24', '<rect x="1.6" y="6.2" width="7.2" height="15.2" rx="0.4" fill="url(#gm-tan)" stroke="var(--c-tan-rim)" stroke-width="0.5"/><rect x="15.2" y="6.2" width="7.2" height="15.2" rx="0.4" fill="url(#gm-tan)" stroke="var(--c-tan-rim)" stroke-width="0.5"/><rect x="1.6" y="4" width="1.8" height="2.4" rx="0.2" fill="url(#gm-tan)" stroke="var(--c-tan-rim)" stroke-width="0.5"/><rect x="4.2" y="4" width="1.8" height="2.4" rx="0.2" fill="url(#gm-tan)" stroke="var(--c-tan-rim)" stroke-width="0.5"/><rect x="6.8" y="4" width="1.8" height="2.4" rx="0.2" fill="url(#gm-tan)" stroke="var(--c-tan-rim)" stroke-width="0.5"/><rect x="15.2" y="4" width="1.8" height="2.4" rx="0.2" fill="url(#gm-tan)" stroke="var(--c-tan-rim)" stroke-width="0.5"/><rect x="17.8" y="4" width="1.8" height="2.4" rx="0.2" fill="url(#gm-tan)" stroke="var(--c-tan-rim)" stroke-width="0.5"/><rect x="20.4" y="4" width="1.8" height="2.4" rx="0.2" fill="url(#gm-tan)" stroke="var(--c-tan-rim)" stroke-width="0.5"/><path d="M4.2 9.4V7.6a1 1 0 0 1 2 0v1.8z" fill="url(#gm-teal)" stroke="var(--c-teal-rim)" stroke-width="0.4"/><path d="M17.8 9.4V7.6a1 1 0 0 1 2 0v1.8z" fill="url(#gm-teal)" stroke="var(--c-teal-rim)" stroke-width="0.4"/><path d="M1.6 9.4h7.2M1.6 13.8h7.2M15.2 9.4h7.2M15.2 13.8h7.2" fill="none" stroke="var(--c-teal-rim)" stroke-width="1"/><rect x="8.8" y="10" width="6.4" height="11.4" rx="0.3" fill="url(#gm-clay)" stroke="var(--c-clay-rim)" stroke-width="0.5"/><path d="M10.2 21.4V16.8a1.8 1.8 0 0 1 3.6 0v4.6z" fill="url(#gm-teal)" stroke="var(--c-teal-rim)" stroke-width="0.5"/><path d="M10.2 21.4V16.8a1.8 1.8 0 0 1 3.6 0v4.6z" fill="url(#gm-sheen)"/><path d="M10.8 21.4V17.2a1.2 1.2 0 0 1 2.4 0v4.2z" fill="url(#gm-cocoa)" stroke="none"/><rect x="1" y="21.4" width="22" height="1.6" rx="0.8" fill="url(#gm-stone)" stroke="var(--c-stone-rim)" stroke-width="0.5"/>'],
    ...
    'dessert': ['0 0 24 24', '<circle cx="12" cy="2.9" r="1.3" fill="url(#gm-red)" stroke="var(--c-red-rim)" stroke-width="0.5"/> <path d="M11.7 4.1c0 1.1.6 1.4.6 2.1" stroke="var(--c-leaf)" stroke-width="0.9" fill="none"/> <circle cx="12" cy="6.4" r="3.5" fill="url(#gm-cocoa)" stroke="var(--c-cocoa-rim)" stroke-width="0.5"/> <circle cx="8.6" cy="9.2" r="3.5" fill="url(#gm-rose)" stroke="var(--c-rose-rim)" stroke-width="0.5"/> <circle cx="15.4" cy="9.2" r="3.5" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"/> <path d="M5.9 11.6h12.2L12 22.6z" fill="url(#gm-tan)" stroke="var(--c-tan-rim)" stroke-width="0.5"/> <g stroke="var(--c-cocoa)" stroke-width="0.8" opacity="0.5"> <path d="M7.6 13.6 14.4 13.6M8.9 16 13.1 16M10.2 18.4h3.6"/> </g>'],
    ...
    'ferris': ['0 0 24 24', '<circle cx="12" cy="10.6" r="8.2" fill="none" stroke="var(--c-teal)" stroke-width="1.7"/> <g stroke="var(--c-teal)" stroke-width="1.2"><path d="M12 2.4v16.4M3.8 10.6h16.4M6.2 4.8l11.6 11.6M17.8 4.8 6.2 16.4"/></g> <circle cx="12" cy="10.6" r="2" fill="url(#gm-rust)" stroke="var(--c-rust-rim)" stroke-width="0.5"/> <g fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"><circle cx="12" cy="2.4" r="1.7"/><circle cx="20.2" cy="10.6" r="1.7"/><circle cx="3.8" cy="10.6" r="1.7"/><circle cx="17.8" cy="4.8" r="1.7"/><circle cx="6.2" cy="4.8" r="1.7"/><circle cx="17.8" cy="16.4" r="1.7"/><circle cx="6.2" cy="16.4" r="1.7"/></g> <path d="M8.4 21.6 12 12l3.6 9.6z" fill="url(#gm-cocoa)" stroke="var(--c-cocoa-rim)" stroke-width="0.5"/><path d="M8.4 21.6 12 12l3.6 9.6z" fill="url(#gm-sheen)"/><rect x="4.6" y="21.2" width="14.8" height="1.6" rx="0.8" fill="url(#gm-stone)" stroke="var(--c-stone-rim)" stroke-width="0.5"/>'],
    ...
    'hourglass': ['0 0 24 24', '<rect x="3.6" y="1.4" width="16.8" height="2.6" rx="0.8" fill="url(#gm-cocoa)" stroke="var(--c-cocoa-rim)" stroke-width="0.5"/> <rect x="3.6" y="20" width="16.8" height="2.6" rx="0.8" fill="url(#gm-cocoa)" stroke="var(--c-cocoa-rim)" stroke-width="0.5"/> <rect x="4.6" y="4" width="1.8" height="16" fill="url(#gm-tan)" stroke="var(--c-tan-rim)" stroke-width="0.5"/> <rect x="17.6" y="4" width="1.8" height="16" fill="url(#gm-tan)" stroke="var(--c-tan-rim)" stroke-width="0.5"/> <g fill="url(#gm-cocoa)" stroke="var(--c-cocoa-rim)" stroke-width="0.5" opacity="0.45"> <rect x="4.4" y="7.2" width="2.2" height="1"/><rect x="4.4" y="15.8" width="2.2" height="1"/> <rect x="17.4" y="7.2" width="2.2" height="1"/><rect x="17.4" y="15.8" width="2.2" height="1"/> </g> <path d="M7.6 4.4h8.8v2.8L12.4 12l4 4.8v2.8H7.6v-2.8L11.6 12 7.6 7.2z" fill="url(#gm-sky)" stroke="var(--c-sky-rim)" stroke-width="0.5"/> <path d="M8.9 5.6h6.2v1.4L12 10.4 8.9 7z" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/> <path d="M12 13.6 15.4 18.4H8.6z" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/> <rect x="11.6" y="10.6" width="0.8" height="3.2" fill="url(#gm-amber)" stroke="var(--c-amber-rim)" stroke-width="0.5"/>'],
    ...
    'folded-map': ['0 0 24 24', '<defs><clipPath id="gm-map-cpn1"><path d="M1.6 8.4 8 5.6v13.2l-6.4 2.8z"/></clipPath><clipPath id="gm-map-cpn2"><path d="M8 5.6 15.4 8.4v13.2L8 18.8z"/></clipPath><clipPath id="gm-map-cpn3"><path d="M15.4 8.4 22.4 5.6v13.2l-7 2.8z"/></clipPath></defs><path d="M1.6 8.4 8 5.6v13.2l-6.4 2.8z" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/><path d="M8 5.6 15.4 8.4v13.2L8 18.8z" fill="url(#gm-green)" stroke="var(--c-green-rim)" stroke-width="0.5"/><path d="M15.4 8.4 22.4 5.6v13.2l-7 2.8z" fill="url(#gm-sky)" stroke="var(--c-sky-rim)" stroke-width="0.5"/><g clip-path="url(#gm-map-cpn1)"><path d="M1 9.6c2.6-.6 4.8-.5 7.6.4v4c-2.8-1-5-1.1-7.6-.5z" fill="url(#gm-green)" stroke="var(--c-green-rim)" stroke-width="0.5"/></g><g clip-path="url(#gm-map-cpn2)"><path d="M7.6 8.4c2.8.6 5 1.6 6.8 3l-.3 3.4c-1.8-1.5-4-2.6-6.5-3.2z" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/></g><g clip-path="url(#gm-map-cpn3)"><path d="M15 12.6c2.4-1.2 4.8-1.8 7.6-1.8v3.8c-2.8 0-5.2.6-7.6 1.8z" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"/></g><path d="M13.4 2a4 4 0 0 0-4 4c0 3 4 7.2 4 7.2s4-4.2 4-7.2a4 4 0 0 0-4-4z" fill="url(#gm-red)" stroke="var(--c-red-rim)" stroke-width="0.5"/><circle cx="13.4" cy="6" r="1.6" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6"/>'],
    ...
    'island': ['0 0 24 24', '<ellipse cx="12" cy="20" rx="10.4" ry="2.6" fill="url(#gm-sky)" stroke="var(--c-sky-rim)" stroke-width="0.5"/><path d="M4.6 19c0-2.6 3.3-4.6 7.4-4.6s7.4 2 7.4 4.6z" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/><rect x="11.2" y="6.6" width="1.7" height="9" rx="0.8" fill="url(#gm-cocoa)" stroke="var(--c-cocoa-rim)" stroke-width="0.5"/><path d="M12 3.2c2.8 0 5 1.6 5.6 3.8-1.8-1.2-3.6-1.4-5.6-.6zM12 3.2c-2.8 0-5 1.6-5.6 3.8 1.8-1.2 3.6-1.4 5.6-.6zM12 3.2c1.6 1.6 2.2 3.4 2 5.6-1-1.8-2.2-2.8-4-3.2z" fill="url(#gm-leaf)" stroke="var(--c-leaf-rim)" stroke-width="0.5"/><path d="M12 3.2c2.8 0 5 1.6 5.6 3.8-1.8-1.2-3.6-1.4-5.6-.6zM12 3.2c-2.8 0-5 1.6-5.6 3.8 1.8-1.2 3.6-1.4 5.6-.6zM12 3.2c1.6 1.6 2.2 3.4 2 5.6-1-1.8-2.2-2.8-4-3.2z" fill="url(#gm-sheen)"/><circle cx="12" cy="3.2" r="1.2" fill="url(#gm-green)" stroke="var(--c-green-rim)" stroke-width="0.5"/>'],
    ...
    'tours-tickets': ['0 5.5 24 13', '<path d="M3 7h18a1.6 1.6 0 0 1 1.6 1.6V10a2 2 0 0 0 0 4v1.4A1.6 1.6 0 0 1 21 17H3a1.6 1.6 0 0 1-1.6-1.6V14a2 2 0 0 0 0-4V8.6A1.6 1.6 0 0 1 3 7z" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/> <path d="M15.6 7H21a1.6 1.6 0 0 1 1.6 1.6V10a2 2 0 0 0 0 4v1.4A1.6 1.6 0 0 1 21 17h-5.4z" fill="url(#gm-amber)" stroke="var(--c-amber-rim)" stroke-width="0.5"/> <path d="M15.6 7.8v8.4" stroke="var(--c-cream)" stroke-width="1.1" stroke-dasharray="1.5 1.5"/> <rect x="3.6" y="9.9" width="8.4" height="1.5" rx="0.75" fill="url(#gm-cocoa)" stroke="var(--c-cocoa-rim)" stroke-width="0.5" opacity="0.5"/> <rect x="3.6" y="12.6" width="5.4" height="1.5" rx="0.75" fill="url(#gm-cocoa)" stroke="var(--c-cocoa-rim)" stroke-width="0.5" opacity="0.35"/>'],
    'tower': ['0 0 24 24', '<path d="M12 0.6 15.4 6.4H8.6z" fill="url(#gm-rust)" stroke="var(--c-rust-rim)" stroke-width="0.5"/> <rect x="7.8" y="6.4" width="8.4" height="15.4" fill="url(#gm-cream)" stroke="var(--c-rim-cool)" stroke-width="1" stroke-linejoin="round" /> <rect x="7.2" y="6.2" width="9.6" height="1.4" rx="0.4" fill="url(#gm-clay)" stroke="var(--c-clay-rim)" stroke-width="0.5"/> <circle cx="12" cy="11.4" r="3.2" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6"/> <circle cx="12" cy="11.4" r="3.2" fill="none" stroke="var(--c-cocoa)" stroke-width="1.7"/> <path d="M12 9.2v2.2l1.8 1.1" stroke="var(--c-cocoa)" stroke-width="1.1" stroke-linecap="round" fill="none"/> <g fill="url(#gm-sky)" stroke="var(--c-sky-rim)" stroke-width="0.5"><rect x="9.4" y="16" width="1.8" height="2.8" rx="0.9"/><rect x="12.8" y="16" width="1.8" height="2.8" rx="0.9"/></g> <rect x="6.4" y="21.4" width="11.2" height="1.6" rx="0.8" fill="url(#gm-stone)" stroke="var(--c-stone-rim)" stroke-width="0.5"/>'],
    ...
    'ski': ['0 0 24 24', '<path d="M3.4 20.4c-.9-1 -.6-2.4.7-3.1l12.4-7.2c1.4-.8 2.8-.4 3.5.8.8 1.2.4 2.6-1 3.4L6.6 21.4c-1.3.8-2.4.6-3.2-1z" fill="url(#gm-sky)" stroke="var(--c-sky-rim)" stroke-width="0.5"/><circle cx="13.8" cy="4" r="2.3" fill="url(#gm-tire)" stroke="var(--c-tire-rim)" stroke-width="0.5"/><path d="M11.6 3.4a2.3 2.3 0 0 1 4.5 0z" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/><g fill="none" stroke="var(--c-red)" stroke-width="2.1" stroke-linecap="round" stroke-linejoin="round"><path d="M13.4 6.4 11 10.6M11 10.6l4 2.4M11 10.6 7.6 13M12.4 8l4-1M12.4 8 8.6 7.4"/></g>'],
    ...
    'walk': ['0 0 24 24', '<path d="M4.8 7.6h2.4M3.2 11.8h2.8M4.4 16h2.2" fill="none" stroke="var(--c-sun)" stroke-width="1.8"/> <circle cx="13.2" cy="3.7" r="2.4" fill="url(#gm-tan)" stroke="var(--c-tan-rim)" stroke-width="0.5"/> <path d="M13.2 7.6 11.6 12.8" fill="none" stroke="var(--c-blue)"/> <path d="M12.4 9.2 15.8 11.4" fill="none" stroke="var(--c-blue)"/> <path d="M12.6 8.9 9.4 11.2" fill="none" stroke="var(--c-blue)"/> <path d="M11.6 12.8 13.9 16.2 13.4 20.9" fill="none" stroke="var(--c-rust)"/> <path d="M11.6 12.8 9.4 16.4 7.9 20.4" fill="none" stroke="var(--c-rust)"/>'],
