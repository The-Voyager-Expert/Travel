...
(function () {
  ...
  var GM_SPRITE = {
    ...
    'dessert': ['0 0 24 24', '<circle cx="12" cy="2.9" r="1.3" fill="var(--c-red)"/> <path d="M11.7 4.1c0 1.1.6 1.4.6 2.1" stroke="var(--c-leaf)" stroke-width="0.9" fill="none"/> <circle cx="12" cy="6.4" r="3.5" fill="var(--c-cocoa)"/> <circle cx="8.6" cy="9.2" r="3.5" fill="var(--c-rose)"/> <circle cx="15.4" cy="9.2" r="3.5" fill="url(#gm-cream)" stroke="var(--c-rim-warm)" stroke-width="0.6"/> <path d="M5.9 11.6h12.2L12 22.6z" fill="var(--c-tan)"/> <g stroke="var(--c-cocoa)" stroke-width="0.8" opacity="0.5"> <path d="M7.6 13.6 14.4 13.6M8.9 16 13.1 16M10.2 18.4h3.6"/> </g>'],
