...
(function () {
  ...
  var GM_SPRITE = {
    ...
    'kids': ['0 0 24 24', '<g fill="none" stroke="var(--c-stone)" stroke-width="1.5" stroke-linecap="round"><path d="M14.6 4.4v9M18.6 4.4v9M14.6 4.4a2 2 0 0 1 4 0"/></g><g fill="none" stroke="var(--c-stone)" stroke-width="1.2" stroke-linecap="round"><path d="M14.6 7.4h4M14.6 10.2h4"/></g><g fill="none" stroke="var(--c-blue)" stroke-width="1.7" stroke-linecap="round"><path d="M2 15c1.7 0 1.7 1.5 3.3 1.5S7 15 8.7 15s1.7 1.5 3.3 1.5 1.7-1.5 3.3-1.5 1.7 1.5 3.4 1.5 1.7-1.5 3.3-1.5"/><path d="M2 19c1.7 0 1.7 1.5 3.3 1.5S7 19 8.7 19s1.7 1.5 3.3 1.5 1.7-1.5 3.3-1.5 1.7 1.5 3.4 1.5 1.7-1.5 3.3-1.5"/></g><path d="M2.4 12.4h9.4v1.6H2.4z" fill="url(#gm-sky)" stroke="var(--c-sky-rim)" stroke-width="0.5" opacity="0.6"/><path d="M2.4 12.4h9.4v1.6H2.4z" fill="url(#gm-sheen)"/>'],
    ...
    'coffee': ['0 0 24 24', '<ellipse cx="11.4" cy="19.9" rx="10.2" ry="2.2" fill="var(--c-tire)" opacity="0.13"/><ellipse cx="11.4" cy="19.4" rx="10.2" ry="2.6" fill="url(#gm-clay)" stroke="var(--c-clay-rim)" stroke-width="0.5"/><ellipse cx="11.4" cy="18.9" rx="7.4" ry="1.6" fill="url(#gm-clay)" stroke="var(--c-clay-rim)" stroke-width="0.5"/><ellipse cx="11.4" cy="18.9" rx="7.4" ry="1.6" fill="var(--c-tire)" opacity="0.10"/><path d="M19.6 9.4a3.4 3.4 0 0 1 0 6.8h-1.6v-2.2h1.6a1.2 1.2 0 0 0 0-2.4h-1.6V9.4z" fill="url(#gm-clay)" stroke="var(--c-clay-rim)" stroke-width="0.5"/><path d="M3.4 8.2h15.4v3.4c0 3.9-3.4 6.8-7.7 6.8s-7.7-2.9-7.7-6.8z" fill="url(#gm-clay)" stroke="var(--c-clay-rim)" stroke-width="0.5"/><path d="M4.9 9.1c-.35 2.6-.2 4.6.7 6.3-1.4-1.3-2.1-3-2.2-5.2z" fill="var(--c-paper)" opacity="0.34"/><ellipse cx="11.1" cy="8.2" rx="7.7" ry="2.6" fill="url(#gm-cocoa)" stroke="var(--c-cocoa-rim)" stroke-width="0.5"/><ellipse cx="11.1" cy="8.2" rx="6.3" ry="2.0" fill="url(#gm-tan)" stroke="var(--c-tan-rim)" stroke-width="0.5"/><g fill="none" stroke="var(--c-cream)" stroke-width="0.8" stroke-linecap="round"><path d="M8.2 8.2c0-1 1.3-1.8 2.9-1.8s2.9.8 2.9 1.8-1.3 1.8-2.9 1.8-2.9-.8-2.9-1.8z"/><path d="M11.1 6.4v3.6"/></g><ellipse cx="11.1" cy="19.4" rx="4.4" ry="1.0" fill="url(#gm-clay)" stroke="var(--c-clay-rim)" stroke-width="0.5" opacity="0.5"/>'],
    ...
    'download': ['0 0 24 24', '<rect x="1.6" y="1.6" width="20.8" height="20.8" rx="4.6" fill="url(#gm-navy)" stroke="var(--c-navy-rim)" stroke-width="0.5"/><path d="M10.6 5.4h2.8v3.1h2.3L12 15.2 8.3 8.5h2.3z" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6"/><rect x="6.4" y="17.4" width="11.2" height="2.4" rx="1.2" fill="url(#gm-paper)" stroke="var(--c-rim-cool)" stroke-width="0.6"/>'],
    ...
    'exchange': ['0 0 24 24', '<circle cx="6.8" cy="8.6" r="5.4" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/><circle cx="6.8" cy="8.6" r="3.9" fill="url(#gm-amber)" stroke="var(--c-amber-rim)" stroke-width="0.5"/><text x="6.8" y="10.8" font-family="ui-sans-serif, system-ui, sans-serif" font-size="5.4" font-weight="700" text-anchor="middle" fill="url(#gm-cocoa)" stroke="var(--c-cocoa-rim)" stroke-width="0.35">$</text><circle cx="17.2" cy="15.4" r="5.4" fill="url(#gm-sun)" stroke="var(--c-sun-rim)" stroke-width="0.5"/><circle cx="17.2" cy="15.4" r="3.9" fill="url(#gm-amber)" stroke="var(--c-amber-rim)" stroke-width="0.5"/><text x="17.2" y="17.6" font-family="ui-sans-serif, system-ui, sans-serif" font-size="5.4" font-weight="700" text-anchor="middle" fill="url(#gm-cocoa)" stroke="var(--c-cocoa-rim)" stroke-width="0.35">€</text><path d="M13.6 5.4c3 .6 5.2 2.2 6.6 4.6" fill="none" stroke="var(--c-navy)" stroke-width="1.6" stroke-linecap="round"/><path d="M22 11.4 19 9.2l3.4-1z" fill="url(#gm-navy)" stroke="var(--c-navy-rim)" stroke-width="0.5"/><path d="M10.4 18.6c-3-.6-5.2-2.2-6.6-4.6" fill="none" stroke="var(--c-navy)" stroke-width="1.6" stroke-linecap="round"/><path d="M2 12.6 5 14.8l-3.4 1z" fill="url(#gm-navy)" stroke="var(--c-navy-rim)" stroke-width="0.5"/>'],
