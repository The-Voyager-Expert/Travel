...
CURATED = {
    ...
    "beach": "Abu Dhabi,Amalfi,Aracaju,Aruba,Athens,Azores,Bali,Barbados,Barcelona,Big Island,Bora Bora,Cannes,Capri,Carmel by the Sea,Cascais,Cayman Islands,Cinque Terre,Corfu,Curaçao,Dubai,Dubrovnik,Fortaleza,Hoi An,Hong Kong,Kauai,La Jolla,Lagos,Lisbon,Los Angeles,Madeira,Maldives,Malibu,Manuel Antonio,Marseille,Maui,Melbourne,Miami,Monaco,Montevideo,Mykonos,Natal,Nice,Oahu,Olinda,Phuket,Porto,Puerto Rico,Rio de Janeiro,San Diego,San Francisco,San Sebastián,Santa Barbara,Santa Cruz,Santa Monica,Santorini,Sardinia,Sint Maarten,Sorrento,Split,Sydney,São Luís,The Bahamas,Turks and Caicos,Vancouver,Virgin Islands,Ålesund",
    ...
    "history": "Abu Dhabi,Aix-en-Provence,Amalfi,Amsterdam,Annecy,Aracaju,Athens,Atlanta,Bangkok,Barcelona,Beijing,Bergen,Berlin,Bologna,Bordeaux,Boston,Bruges,Brussels,Budapest,Buenos Aires,Cairo,Cambridge,Cascais,Chiang Mai,Chicago,Cinque Terre,Colmar,Colombo,Columbia,Copenhagen,Corfu,Curaçao,Cusco,Doha,Dublin,Dubrovnik,Edinburgh,Florence,Glasgow,Gothenburg,Hamburg,Helsinki,Hoi An,Istanbul,Kraków,Kyoto,Lagos,Lake Como,Lille,Lima,Lisbon,Ljubljana,London,Lucerne,Luxembourg,Lyon,Machu Picchu,Madrid,Marrakech,Marseille,Milan,Montevideo,Montréal,Munich,Natal,New Orleans,New York,Oahu,Olinda,Oslo,Oxford,Paris,Pasadena,Petra,Philadelphia,Pisa,Porto,Porto Alegre,Prague,Puerto Rico,Québec City,Rio de Janeiro,Rome,Salzburg,San Francisco,Santiago,Santorini,Seoul,Seville,Shanghai,Siena,Singapore,Sintra,Split,Stockholm,Strasbourg,Stuttgart,São Luís,Taipei,Tallinn,Tokyo,Toledo,Turin,Turks and Caicos,Venice,Verona,Victoria,Vienna,Washington DC",
