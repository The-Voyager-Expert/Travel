...
CURATED = {
    ...
    "history": "Abu Dhabi,Aix-en-Provence,San José,Amalfi,Amsterdam,Annecy,Aracaju,Athens,Atlanta,Bangkok,Barcelona,Beijing,Bergen,Berlin,Bologna,Bordeaux,Boston,Bruges,Brussels,Budapest,Buenos Aires,Cairo,Cambridge,Cascais,Chiang Mai,Chicago,Cinque Terre,Colmar,Colombo,Columbia,Copenhagen,Corfu,Curaçao,Curitiba,Cusco,Doha,Dublin,Dubrovnik,Edinburgh,Florence,Glasgow,Gothenburg,Hamburg,Hanoi,Helsinki,Hoi An,Istanbul,João Pessoa,Key West,Kotor,Kraków,Kyoto,Lagos,Lake Como,Lecce,Lille,Lima,Lisbon,Ljubljana,London,Lucerne,Luxembourg,Luang Prabang,Lyon,Machu Picchu,Maceió,Madrid,Marrakech,Marseille,Milan,Montevideo,Montréal,Munich,Muscat,Málaga,Naples,Natal,New Orleans,New York,Oahu,Oaxaca,Olinda,Oslo,Oxford,Paris,Paro,Pasadena,Pensacola,Petra,Philadelphia,Pisa,Porto,Porto Alegre,Prague,Puerto Rico,Québec City,Recife,Rio de Janeiro,Rome,Salvador,Salzburg,San Francisco,Santiago,Santorini,Sardinia,Seoul,Seville,Shanghai,Sicily,Siena,Singapore,Sintra,Split,Stockholm,Strasbourg,Stuttgart,São Luís,São Paulo,Taipei,Tallinn,Tbilisi,Tokyo,Toledo,Turin,Turks and Caicos,Valletta,Venice,Verona,Victoria,Vienna,Washington DC,Osaka",
