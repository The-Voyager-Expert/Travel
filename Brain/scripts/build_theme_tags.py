...
CURATED = {
    ...
    "history": "Cairo,Hamburg,Abu Dhabi,Doha,Aix-en-Provence,Amalfi,Amsterdam,Petra,Annecy,Athens,Atlanta,Bangkok,Chiang Mai,Barcelona,Beijing,Bergen,Colombo,Berlin,Bologna,Bordeaux,Boston,Bruges,Brussels,Budapest,Buenos Aires,Cambridge,Cascais,Chicago,Cinque Terre,Colmar,Columbia,Copenhagen,Corfu,Curaçao,Cusco,Dublin,Dubrovnik,Edinburgh,Florence,Glasgow,Gothenburg,Helsinki,Hoi An,Istanbul,Kraków,Kyoto,Lagos,Lake Como,Lille,Lima,Lisbon,Ljubljana,London,Lucerne,Luxembourg,Lyon,Machu Picchu,Madrid,Marrakech,Marseille,Milan,Montevideo,Montréal,Munich,Natal,New Orleans,New York,Oahu,Olinda,Oslo,Oxford,Paris,Pasadena,Philadelphia,Pisa,Porto,Porto Alegre,Prague,Puerto Rico,Québec City,Rio de Janeiro,Rome,Salzburg,San Francisco,Santiago,Santorini,Seoul,Seville,Shanghai,Siena,Singapore,Sintra,Split,Stockholm,Strasbourg,Stuttgart,Taipei,Tallinn,Tokyo,Toledo,Turin,Turks and Caicos,Venice,Verona,Victoria,Vienna,Washington DC,São Luís",
