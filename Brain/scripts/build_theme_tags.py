...
CURATED = {
    "nature": "Denver,Alaska,Arenal,San José,Chiang Mai,Amalfi,Annecy,Azores,Bali,Bend,Bergen,Big Island,Boulder,Capri,Chongqing,Cinque Terre,Curitiba,Cusco,Florianópolis,Foz do Iguaçu,Geneva,Hong Kong,Kauai,Kyoto,La Jolla,Lake Como,Las Vegas,Ljubljana,Lucerne,Luxembourg,Machu Picchu,Maceió,Madeira,Maldives,Manuel Antonio,Marktoberdorf,Maui,Natal,Napa,Oahu,Orcas Island,Oslo,Palm Desert,Palawan,Petra,Phoenix,Phuket,Portland,Puerto Rico,Queenstown,Reykjavik,Rio de Janeiro,Salzburg,Santa Cruz,Santiago,São Luís,Scottsdale,Seattle,Sintra,Sorrento,Taipei,Tromsø,Vancouver,Victoria,Wellington,Whistler,Zhangjiajie,Zurich,Ålesund",
    "beach": "Abu Dhabi,Amalfi,Aracaju,Aruba,Athens,Azores,Bali,Barbados,Barcelona,Big Island,Bora Bora,Cannes,Capri,Carmel by the Sea,Cascais,Cayman Islands,Cinque Terre,Corfu,Curaçao,Dubai,Dubrovnik,Florianópolis,Fortaleza,Hoi An,Hong Kong,João Pessoa,Kauai,La Jolla,Lagos,Lisbon,Los Angeles,Maceió,Madeira,Maldives,Malibu,Manuel Antonio,Marseille,Maui,Melbourne,Miami,Monaco,Montevideo,Mykonos,Natal,Nice,Oahu,Olinda,Phuket,Porto,Puerto Rico,Recife,Rio de Janeiro,Salvador,San Diego,San Francisco,San Sebastián,Santa Barbara,Santa Cruz,Santa Monica,Santorini,Sardinia,Sint Maarten,Sorrento,Split,Sydney,São Luís,The Bahamas,Turks and Caicos,Vancouver,Virgin Islands,Ålesund",
    "islands": "Aruba,Azores,Bali,Barbados,Big Island,Bora Bora,Capri,Cayman Islands,Corfu,Curaçao,Kauai,Madeira,Maldives,Maui,Mykonos,Oahu,Orcas Island,Palawan,Phuket,Puerto Rico,Santorini,Sint Maarten,Stockholm,The Bahamas,Turks and Caicos,Virgin Islands",
    "snow": "Alaska,Annecy,Bend,Lucerne,Queenstown,Québec City,Reykjavik,Salzburg,Tromsø,Whistler",
    "foodie": "Hamburg,Denver,Aix-en-Provence,Amsterdam,Athens,Atlanta,Austin,Bangkok,Chiang Mai,Barcelona,Colombo,Beijing,Berlin,Bologna,Bordeaux,Boston,Bruges,Brussels,Budapest,Buenos Aires,Cannes,Charlotte,Chicago,Chongqing,Colmar,Copenhagen,Dallas,Dubai,Dublin,Edinburgh,Florence,Geneva,Glasgow,Gothenburg,Helsinki,Hoi An,Hong Kong,Istanbul,Kraków,Kyoto,Las Vegas,Lille,Lima,Lisbon,London,Los Angeles,Lyon,Madrid,Marrakech,Marseille,Melbourne,Miami,Milan,Montréal,Munich,Napa,Nashville,New Orleans,New York,Nice,Orlando,Palo Alto,Paris,Philadelphia,Portland,Porto,Porto Alegre,Prague,Queenstown,Québec City,Reykjavik,Rome,San Diego,San Francisco,San Jose,San Sebastián,Santa Barbara,Santiago,Seattle,Seoul,Seville,Shanghai,Siena,Singapore,Sorrento,Stockholm,Strasbourg,Stuttgart,Sydney,Taipei,Tokyo,Toronto,Turin,Vancouver,Venice,Victoria,Vienna,Wellington,Zurich",
    "history": "Abu Dhabi,Aix-en-Provence,San José,Amalfi,Amsterdam,Annecy,Aracaju,Athens,Atlanta,Bangkok,Barcelona,Beijing,Bergen,Berlin,Bologna,Bordeaux,Boston,Bruges,Brussels,Budapest,Buenos Aires,Cairo,Cambridge,Cascais,Chiang Mai,Chicago,Cinque Terre,Colmar,Colombo,Columbia,Copenhagen,Corfu,Curaçao,Curitiba,Cusco,Doha,Dublin,Dubrovnik,Edinburgh,Florence,Glasgow,Gothenburg,Hamburg,Helsinki,Hoi An,Istanbul,João Pessoa,Kraków,Kyoto,Lagos,Lake Como,Lille,Lima,Lisbon,Ljubljana,London,Lucerne,Luxembourg,Lyon,Machu Picchu,Maceió,Madrid,Marrakech,Marseille,Milan,Montevideo,Montréal,Munich,Natal,New Orleans,New York,Oahu,Olinda,Oslo,Oxford,Paris,Pasadena,Petra,Philadelphia,Pisa,Porto,Porto Alegre,Prague,Puerto Rico,Québec City,Recife,Rio de Janeiro,Rome,Salvador,Salzburg,San Francisco,Santiago,Santorini,Seoul,Seville,Shanghai,Siena,Singapore,Sintra,Split,Stockholm,Strasbourg,Stuttgart,São Luís,Taipei,Tallinn,Tokyo,Toledo,Turin,Turks and Caicos,Venice,Verona,Victoria,Vienna,Washington DC,Osaka",
    ...
    "nightlife": "Hamburg,Denver,Amsterdam,Austin,Bali,Bangkok,Barcelona,Berlin,Budapest,Buenos Aires,Chicago,Dubai,Hong Kong,Istanbul,Las Vegas,Lisbon,London,Los Angeles,Madrid,Melbourne,Miami,Montréal,Munich,Mykonos,Nashville,New Orleans,New York,Paris,Phuket,Prague,Rio de Janeiro,San Francisco,Seoul,Shanghai,Singapore,Split,Sydney,Taipei,Tokyo,Osaka",
