...
COUNTRIES = [
 ...
 ("Bhutan","Asia","Bhutanese Ngultrum","Nu","BTN","BTN","Pegged 1:1 to the Indian Rupee; INR also accepted.", ["Paro"]),
 ...
 ("Mexico","North America","Mexican Peso","$","MXN","MXN","", ["Cancún","Los Cabos","Oaxaca","Puerto Vallarta"]),
 ...
 ("Brazil","South America","Brazilian Real","R$","BRL","BRL","", ["Aracaju","Curitiba","Florianópolis","Fortaleza","Foz do Iguaçu","João Pessoa","Maceió","Natal","Olinda","Porto Alegre","Recife","Rio de Janeiro","Salvador","São Luís","São Paulo"]),
