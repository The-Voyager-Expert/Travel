...
COUNTRIES = [
 ...
 ("Brazil","South America","Brazilian Real","R$","BRL","BRL","", ["Aracaju","Florianópolis","Fortaleza","Foz do Iguaçu","João Pessoa","Maceió","Natal","Porto Alegre","Recife","Rio de Janeiro","Salvador","São Luís"]),
