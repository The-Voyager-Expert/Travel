...
COUNTRIES = [
 ...
 ("Brazil","South America","Brazilian Real","R$","BRL","BRL","", ["Aracaju","Curitiba","Florianópolis","Fortaleza","Foz do Iguaçu","João Pessoa","Maceió","Natal","Olinda","Porto Alegre","Recife","Rio de Janeiro","Salvador","São Luís"]),
